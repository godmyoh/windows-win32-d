...
alias PFN_D3D11ON12_CREATE_DEVICE = HRESULT function(IUnknown param0, uint param1, const(D3D_FEATURE_LEVEL)* param2, uint FeatureLevels, IUnknown* param4, uint NumQueues, uint param6, ID3D11Device* param7, ID3D11DeviceContext* param8, D3D_FEATURE_LEVEL* param9);
...
HRESULT D3D11On12CreateDevice(IUnknown pDevice, uint Flags, const(D3D_FEATURE_LEVEL)* pFeatureLevels, uint FeatureLevels, IUnknown* ppCommandQueues, uint NumQueues, uint NodeMask, ID3D11Device* ppDevice, ID3D11DeviceContext* ppImmediateContext, D3D_FEATURE_LEVEL* pChosenFeatureLevel);
