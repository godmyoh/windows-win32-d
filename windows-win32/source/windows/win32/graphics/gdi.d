...
HBRUSH GetSysColorBrush(SYS_COLOR_INDEX);
...
enum : uint
{
    PAN_FAMILY_ANY          = 0x00000000,
    PAN_FAMILY_NO_FIT       = 0x00000001,
...
alias PAN_SERIF_STYLE = uint;
enum : uint
{
    PAN_SERIF_ANY                = 0x00000000,
    PAN_SERIF_NO_FIT             = 0x00000001,
...
alias PAN_WEIGHT = uint;
enum : uint
{
    PAN_WEIGHT_ANY        = 0x00000000,
    PAN_WEIGHT_NO_FIT     = 0x00000001,
...
alias PAN_STROKE_VARIATION = uint;
enum : uint
{
    PAN_STROKE_ANY          = 0x00000000,
    PAN_STROKE_NO_FIT       = 0x00000001,
...
alias PAN_PROPORTION = uint;
enum : uint
{
    PAN_PROP_ANY            = 0x00000000,
    PAN_PROP_NO_FIT         = 0x00000001,
...
alias PAN_CONTRAST = uint;
enum : uint
{
    PAN_CONTRAST_ANY         = 0x00000000,
    PAN_CONTRAST_NO_FIT      = 0x00000001,
...
alias PAN_ARM_STYLE = uint;
enum : uint
{
    PAN_ARM_ANY                    = 0x00000000,
    PAN_ARM_NO_FIT                 = 0x00000001,
...
alias PAN_LETT_FORM = uint;
enum : uint
{
    PAN_LETT_FORM_ANY           = 0x00000000,
    PAN_LETT_FORM_NO_FIT        = 0x00000001,
...
alias PAN_MIDLINE = uint;
enum : uint
{
    PAN_MIDLINE_ANY              = 0x00000000,
    PAN_MIDLINE_NO_FIT           = 0x00000001,
...
alias PAN_XHEIGHT = uint;
enum : uint
{
    PAN_XHEIGHT_ANY            = 0x00000000,
    PAN_XHEIGHT_NO_FIT         = 0x00000001,
