...
import windows.win32.foundation : BOOL, BSTR, FILETIME, HANDLE, HRESULT, HWND, LUID, POINT, PSTR, PWSTR, RECT, SIZE;
...
//enum MEDIASUBTYPE_P208 = [MISSING];
//enum MEDIASUBTYPE_P210 = [MISSING];
//enum MEDIASUBTYPE_P216 = [MISSING];
//enum MEDIASUBTYPE_P010 = [MISSING];
//enum MEDIASUBTYPE_P016 = [MISSING];
//enum MEDIASUBTYPE_Y210 = [MISSING];
//enum MEDIASUBTYPE_Y216 = [MISSING];
//enum MEDIASUBTYPE_P408 = [MISSING];
...
interface IMFCapturePreviewSink : IMFCaptureSink
{
    ...
    HRESULT UpdateVideo(const(MFVideoNormalizedRect)*, const(RECT)*, const(uint)*);
    HRESULT SetSampleCallback(uint, IMFCaptureEngineOnSampleCallback);
