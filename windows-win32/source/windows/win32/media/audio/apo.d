...
enum PKEY_FX_Association = PROPERTYKEY(GUID(3494774182, 22859, 20406, [168, 13, 1, 175, 94, 237, 125, 29]), 0);
enum PKEY_FX_PreMixEffectClsid = PROPERTYKEY(GUID(3494774182, 22859, 20406, [168, 13, 1, 175, 94, 237, 125, 29]), 1);
enum PKEY_FX_PostMixEffectClsid = PROPERTYKEY(GUID(3494774182, 22859, 20406, [168, 13, 1, 175, 94, 237, 125, 29]), 2);
enum PKEY_FX_UserInterfaceClsid = PROPERTYKEY(GUID(3494774182, 22859, 20406, [168, 13, 1, 175, 94, 237, 125, 29]), 3);
enum PKEY_FX_FriendlyName = PROPERTYKEY(GUID(3494774182, 22859, 20406, [168, 13, 1, 175, 94, 237, 125, 29]), 4);
enum PKEY_FX_StreamEffectClsid = PROPERTYKEY(GUID(3494774182, 22859, 20406, [168, 13, 1, 175, 94, 237, 125, 29]), 5);
enum PKEY_FX_ModeEffectClsid = PROPERTYKEY(GUID(3494774182, 22859, 20406, [168, 13, 1, 175, 94, 237, 125, 29]), 6);
enum PKEY_FX_EndpointEffectClsid = PROPERTYKEY(GUID(3494774182, 22859, 20406, [168, 13, 1, 175, 94, 237, 125, 29]), 7);
enum PKEY_FX_KeywordDetector_StreamEffectClsid = PROPERTYKEY(GUID(3494774182, 22859, 20406, [168, 13, 1, 175, 94, 237, 125, 29]), 8);
enum PKEY_FX_KeywordDetector_ModeEffectClsid = PROPERTYKEY(GUID(3494774182, 22859, 20406, [168, 13, 1, 175, 94, 237, 125, 29]), 9);
enum PKEY_FX_KeywordDetector_EndpointEffectClsid = PROPERTYKEY(GUID(3494774182, 22859, 20406, [168, 13, 1, 175, 94, 237, 125, 29]), 10);
enum PKEY_FX_Offload_StreamEffectClsid = PROPERTYKEY(GUID(3494774182, 22859, 20406, [168, 13, 1, 175, 94, 237, 125, 29]), 11);
enum PKEY_FX_Offload_ModeEffectClsid = PROPERTYKEY(GUID(3494774182, 22859, 20406, [168, 13, 1, 175, 94, 237, 125, 29]), 12);
enum PKEY_CompositeFX_StreamEffectClsid = PROPERTYKEY(GUID(3494774182, 22859, 20406, [168, 13, 1, 175, 94, 237, 125, 29]), 13);
enum PKEY_CompositeFX_ModeEffectClsid = PROPERTYKEY(GUID(3494774182, 22859, 20406, [168, 13, 1, 175, 94, 237, 125, 29]), 14);
enum PKEY_CompositeFX_EndpointEffectClsid = PROPERTYKEY(GUID(3494774182, 22859, 20406, [168, 13, 1, 175, 94, 237, 125, 29]), 15);
enum PKEY_CompositeFX_KeywordDetector_StreamEffectClsid = PROPERTYKEY(GUID(3494774182, 22859, 20406, [168, 13, 1, 175, 94, 237, 125, 29]), 16);
enum PKEY_CompositeFX_KeywordDetector_ModeEffectClsid = PROPERTYKEY(GUID(3494774182, 22859, 20406, [168, 13, 1, 175, 94, 237, 125, 29]), 17);
enum PKEY_CompositeFX_KeywordDetector_EndpointEffectClsid = PROPERTYKEY(GUID(3494774182, 22859, 20406, [168, 13, 1, 175, 94, 237, 125, 29]), 18);
enum PKEY_CompositeFX_Offload_StreamEffectClsid = PROPERTYKEY(GUID(3494774182, 22859, 20406, [168, 13, 1, 175, 94, 237, 125, 29]), 19);
enum PKEY_CompositeFX_Offload_ModeEffectClsid = PROPERTYKEY(GUID(3494774182, 22859, 20406, [168, 13, 1, 175, 94, 237, 125, 29]), 20);
enum PKEY_FX_SupportAppLauncher = PROPERTYKEY(GUID(3494774182, 22859, 20406, [168, 13, 1, 175, 94, 237, 125, 29]), 21);
enum PKEY_FX_SupportedFormats = PROPERTYKEY(GUID(3494774182, 22859, 20406, [168, 13, 1, 175, 94, 237, 125, 29]), 22);
enum PKEY_FX_Enumerator = PROPERTYKEY(GUID(3494774182, 22859, 20406, [168, 13, 1, 175, 94, 237, 125, 29]), 23);
enum PKEY_FX_VersionMajor = PROPERTYKEY(GUID(3494774182, 22859, 20406, [168, 13, 1, 175, 94, 237, 125, 29]), 24);
enum PKEY_FX_VersionMinor = PROPERTYKEY(GUID(3494774182, 22859, 20406, [168, 13, 1, 175, 94, 237, 125, 29]), 25);
enum PKEY_FX_Author = PROPERTYKEY(GUID(3494774182, 22859, 20406, [168, 13, 1, 175, 94, 237, 125, 29]), 26);
enum PKEY_FX_ObjectId = PROPERTYKEY(GUID(3494774182, 22859, 20406, [168, 13, 1, 175, 94, 237, 125, 29]), 27);
enum PKEY_FX_State = PROPERTYKEY(GUID(3494774182, 22859, 20406, [168, 13, 1, 175, 94, 237, 125, 29]), 28);
enum PKEY_FX_EffectPackSchema_Version = PROPERTYKEY(GUID(3494774182, 22859, 20406, [168, 13, 1, 175, 94, 237, 125, 29]), 29);
enum PKEY_FX_ApplyToBluetooth = PROPERTYKEY(GUID(3494774182, 22859, 20406, [168, 13, 1, 175, 94, 237, 125, 29]), 30);
enum PKEY_FX_ApplyToUsb = PROPERTYKEY(GUID(3494774182, 22859, 20406, [168, 13, 1, 175, 94, 237, 125, 29]), 31);
enum PKEY_FX_ApplyToRender = PROPERTYKEY(GUID(3494774182, 22859, 20406, [168, 13, 1, 175, 94, 237, 125, 29]), 32);
enum PKEY_FX_ApplyToCapture = PROPERTYKEY(GUID(3494774182, 22859, 20406, [168, 13, 1, 175, 94, 237, 125, 29]), 33);
enum PKEY_SFX_ProcessingModes_Supported_For_Streaming = PROPERTYKEY(GUID(3550034495, 39362, 17410, [181, 236, 169, 42, 3, 103, 102, 75]), 5);
enum PKEY_MFX_ProcessingModes_Supported_For_Streaming = PROPERTYKEY(GUID(3550034495, 39362, 17410, [181, 236, 169, 42, 3, 103, 102, 75]), 6);
enum PKEY_EFX_ProcessingModes_Supported_For_Streaming = PROPERTYKEY(GUID(3550034495, 39362, 17410, [181, 236, 169, 42, 3, 103, 102, 75]), 7);
enum PKEY_SFX_KeywordDetector_ProcessingModes_Supported_For_Streaming = PROPERTYKEY(GUID(3550034495, 39362, 17410, [181, 236, 169, 42, 3, 103, 102, 75]), 8);
enum PKEY_MFX_KeywordDetector_ProcessingModes_Supported_For_Streaming = PROPERTYKEY(GUID(3550034495, 39362, 17410, [181, 236, 169, 42, 3, 103, 102, 75]), 9);
enum PKEY_EFX_KeywordDetector_ProcessingModes_Supported_For_Streaming = PROPERTYKEY(GUID(3550034495, 39362, 17410, [181, 236, 169, 42, 3, 103, 102, 75]), 10);
enum PKEY_SFX_Offload_ProcessingModes_Supported_For_Streaming = PROPERTYKEY(GUID(3550034495, 39362, 17410, [181, 236, 169, 42, 3, 103, 102, 75]), 11);
enum PKEY_MFX_Offload_ProcessingModes_Supported_For_Streaming = PROPERTYKEY(GUID(3550034495, 39362, 17410, [181, 236, 169, 42, 3, 103, 102, 75]), 12);
enum PKEY_APO_SWFallback_ProcessingModes = PROPERTYKEY(GUID(3550034495, 39362, 17410, [181, 236, 169, 42, 3, 103, 102, 75]), 13);
