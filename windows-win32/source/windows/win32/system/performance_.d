...
import windows.win32.foundation : BOOL, BOOLEAN, BSTR, FILETIME, HANDLE, HRESULT, HWND, LARGE_INTEGER, PSTR, PWSTR, SYSTEMTIME;
...
uint PerfStartProvider(GUID*, PERFLIBREQUEST, PerfProviderHandle*);
uint PerfStartProviderEx(GUID*, PERF_PROVIDER_CONTEXT*, PerfProviderHandle*);
uint PerfStopProvider(PerfProviderHandle);
uint PerfSetCounterSetInfo(HANDLE, PERF_COUNTERSET_INFO*, uint);
PERF_COUNTERSET_INSTANCE* PerfCreateInstance(PerfProviderHandle, const(GUID)*, const(wchar)*, uint);
uint PerfDeleteInstance(PerfProviderHandle, PERF_COUNTERSET_INSTANCE*);
...
uint PerfOpenQueryHandle(const(wchar)*, PerfQueryHandle*);
uint PerfCloseQueryHandle(HANDLE);
uint PerfQueryCounterInfo(PerfQueryHandle, PERF_COUNTER_IDENTIFIER*, uint, uint*);
uint PerfQueryCounterData(PerfQueryHandle, PERF_DATA_HEADER*, uint, uint*);
uint PerfAddCounters(PerfQueryHandle, PERF_COUNTER_IDENTIFIER*, uint);
uint PerfDeleteCounters(PerfQueryHandle, PERF_COUNTER_IDENTIFIER*, uint);
int PdhGetDllVersion(PDH_DLL_VERSION*);
int PdhOpenQueryW(const(wchar)*, ulong, long*);
int PdhOpenQueryA(const(char)*, ulong, long*);
int PdhAddCounterW(long, const(wchar)*, ulong, long*);
int PdhAddCounterA(long, const(char)*, ulong, long*);
int PdhAddEnglishCounterW(long, const(wchar)*, ulong, long*);
int PdhAddEnglishCounterA(long, const(char)*, ulong, long*);
int PdhCollectQueryDataWithTime(long, long*);
int PdhValidatePathExW(long, const(wchar)*);
int PdhValidatePathExA(long, const(char)*);
int PdhRemoveCounter(long);
int PdhCollectQueryData(long);
int PdhCloseQuery(long);
int PdhGetFormattedCounterValue(long, PDH_FMT, uint*, PDH_FMT_COUNTERVALUE*);
int PdhGetFormattedCounterArrayA(long, PDH_FMT, uint*, uint*, PDH_FMT_COUNTERVALUE_ITEM_A*);
int PdhGetFormattedCounterArrayW(long, PDH_FMT, uint*, uint*, PDH_FMT_COUNTERVALUE_ITEM_W*);
int PdhGetRawCounterValue(long, uint*, PDH_RAW_COUNTER*);
int PdhGetRawCounterArrayA(long, uint*, uint*, PDH_RAW_COUNTER_ITEM_A*);
int PdhGetRawCounterArrayW(long, uint*, uint*, PDH_RAW_COUNTER_ITEM_W*);
int PdhCalculateCounterFromRawValue(long, PDH_FMT, PDH_RAW_COUNTER*, PDH_RAW_COUNTER*, PDH_FMT_COUNTERVALUE*);
int PdhComputeCounterStatistics(long, PDH_FMT, uint, uint, PDH_RAW_COUNTER*, PDH_STATISTICS*);
int PdhGetCounterInfoW(long, BOOLEAN, uint*, PDH_COUNTER_INFO_W*);
int PdhGetCounterInfoA(long, BOOLEAN, uint*, PDH_COUNTER_INFO_A*);
int PdhSetCounterScaleFactor(long, int);
int PdhConnectMachineW(const(wchar)*);
int PdhConnectMachineA(const(char)*);
int PdhEnumMachinesW(const(wchar)*, PWSTR, uint*);
int PdhEnumMachinesA(const(char)*, PSTR, uint*);
int PdhEnumObjectsW(const(wchar)*, const(wchar)*, PWSTR, uint*, PERF_DETAIL, BOOL);
int PdhEnumObjectsA(const(char)*, const(char)*, PSTR, uint*, PERF_DETAIL, BOOL);
int PdhEnumObjectItemsW(const(wchar)*, const(wchar)*, const(wchar)*, PWSTR, uint*, PWSTR, uint*, PERF_DETAIL, uint);
int PdhEnumObjectItemsA(const(char)*, const(char)*, const(char)*, PSTR, uint*, PSTR, uint*, PERF_DETAIL, uint);
int PdhMakeCounterPathW(PDH_COUNTER_PATH_ELEMENTS_W*, PWSTR, uint*, PDH_PATH_FLAGS);
int PdhMakeCounterPathA(PDH_COUNTER_PATH_ELEMENTS_A*, PSTR, uint*, PDH_PATH_FLAGS);
int PdhParseCounterPathW(const(wchar)*, PDH_COUNTER_PATH_ELEMENTS_W*, uint*, uint);
int PdhParseCounterPathA(const(char)*, PDH_COUNTER_PATH_ELEMENTS_A*, uint*, uint);
int PdhParseInstanceNameW(const(wchar)*, PWSTR, uint*, PWSTR, uint*, uint*);
int PdhParseInstanceNameA(const(char)*, PSTR, uint*, PSTR, uint*, uint*);
int PdhValidatePathW(const(wchar)*);
int PdhValidatePathA(const(char)*);
int PdhGetDefaultPerfObjectW(const(wchar)*, const(wchar)*, PWSTR, uint*);
int PdhGetDefaultPerfObjectA(const(char)*, const(char)*, PSTR, uint*);
int PdhGetDefaultPerfCounterW(const(wchar)*, const(wchar)*, const(wchar)*, PWSTR, uint*);
int PdhGetDefaultPerfCounterA(const(char)*, const(char)*, const(char)*, PSTR, uint*);
int PdhBrowseCountersW(PDH_BROWSE_DLG_CONFIG_W*);
int PdhBrowseCountersA(PDH_BROWSE_DLG_CONFIG_A*);
int PdhExpandCounterPathW(const(wchar)*, PWSTR, uint*);
int PdhExpandCounterPathA(const(char)*, PSTR, uint*);
int PdhLookupPerfNameByIndexW(const(wchar)*, uint, PWSTR, uint*);
int PdhLookupPerfNameByIndexA(const(char)*, uint, PSTR, uint*);
int PdhLookupPerfIndexByNameW(const(wchar)*, const(wchar)*, uint*);
int PdhLookupPerfIndexByNameA(const(char)*, const(char)*, uint*);
int PdhExpandWildCardPathA(const(char)*, const(char)*, PSTR, uint*, uint);
int PdhExpandWildCardPathW(const(wchar)*, const(wchar)*, PWSTR, uint*, uint);
int PdhOpenLogW(const(wchar)*, PDH_LOG, PDH_LOG_TYPE*, long, uint, const(wchar)*, long*);
int PdhOpenLogA(const(char)*, PDH_LOG, PDH_LOG_TYPE*, long, uint, const(char)*, long*);
int PdhUpdateLogW(long, const(wchar)*);
int PdhUpdateLogA(long, const(char)*);
int PdhUpdateLogFileCatalog(long);
int PdhGetLogFileSize(long, long*);
int PdhCloseLog(long, uint);
int PdhSelectDataSourceW(HWND, PDH_SELECT_DATA_SOURCE_FLAGS, PWSTR, uint*);
int PdhSelectDataSourceA(HWND, PDH_SELECT_DATA_SOURCE_FLAGS, PSTR, uint*);
BOOL PdhIsRealTimeQuery(long);
int PdhSetQueryTimeRange(long, PDH_TIME_INFO*);
int PdhGetDataSourceTimeRangeW(const(wchar)*, uint*, PDH_TIME_INFO*, uint*);
int PdhGetDataSourceTimeRangeA(const(char)*, uint*, PDH_TIME_INFO*, uint*);
int PdhCollectQueryDataEx(long, uint, HANDLE);
int PdhFormatFromRawValue(uint, PDH_FMT, long*, PDH_RAW_COUNTER*, PDH_RAW_COUNTER*, PDH_FMT_COUNTERVALUE*);
int PdhGetCounterTimeBase(long, long*);
int PdhReadRawLogRecord(long, FILETIME, PDH_RAW_LOG_RECORD*, uint*);
int PdhSetDefaultRealTimeDataSource(REAL_TIME_DATA_SOURCE_ID_FLAGS);
int PdhBindInputDataSourceW(long*, const(wchar)*);
int PdhBindInputDataSourceA(long*, const(char)*);
int PdhOpenQueryH(long, ulong, long*);
int PdhEnumMachinesHW(long, PWSTR, uint*);
int PdhEnumMachinesHA(long, PSTR, uint*);
int PdhEnumObjectsHW(long, const(wchar)*, PWSTR, uint*, PERF_DETAIL, BOOL);
int PdhEnumObjectsHA(long, const(char)*, PSTR, uint*, PERF_DETAIL, BOOL);
int PdhEnumObjectItemsHW(long, const(wchar)*, const(wchar)*, PWSTR, uint*, PWSTR, uint*, PERF_DETAIL, uint);
int PdhEnumObjectItemsHA(long, const(char)*, const(char)*, PSTR, uint*, PSTR, uint*, PERF_DETAIL, uint);
int PdhExpandWildCardPathHW(long, const(wchar)*, PWSTR, uint*, uint);
int PdhExpandWildCardPathHA(long, const(char)*, PSTR, uint*, uint);
int PdhGetDataSourceTimeRangeH(long, uint*, PDH_TIME_INFO*, uint*);
int PdhGetDefaultPerfObjectHW(long, const(wchar)*, PWSTR, uint*);
int PdhGetDefaultPerfObjectHA(long, const(char)*, PSTR, uint*);
int PdhGetDefaultPerfCounterHW(long, const(wchar)*, const(wchar)*, PWSTR, uint*);
int PdhGetDefaultPerfCounterHA(long, const(char)*, const(char)*, PSTR, uint*);
int PdhBrowseCountersHW(PDH_BROWSE_DLG_CONFIG_HW*);
int PdhBrowseCountersHA(PDH_BROWSE_DLG_CONFIG_HA*);
int PdhVerifySQLDBW(const(wchar)*);
int PdhVerifySQLDBA(const(char)*);
int PdhCreateSQLTablesW(const(wchar)*);
int PdhCreateSQLTablesA(const(char)*);
int PdhEnumLogSetNamesW(const(wchar)*, PWSTR, uint*);
int PdhEnumLogSetNamesA(const(char)*, PSTR, uint*);
int PdhGetLogSetGUID(long, GUID*, int*);
int PdhSetLogSetRunID(long, int);
...
enum PERF_AGGREGATE_MAX = 0x00000004;
...
enum PDH_CSTATUS_NO_MACHINE = 0xffffffff800007d0;
enum PDH_CSTATUS_NO_INSTANCE = 0xffffffff800007d1;
enum PDH_MORE_DATA = 0xffffffff800007d2;
enum PDH_CSTATUS_ITEM_NOT_VALIDATED = 0xffffffff800007d3;
enum PDH_RETRY = 0xffffffff800007d4;
enum PDH_NO_DATA = 0xffffffff800007d5;
enum PDH_CALC_NEGATIVE_DENOMINATOR = 0xffffffff800007d6;
enum PDH_CALC_NEGATIVE_TIMEBASE = 0xffffffff800007d7;
enum PDH_CALC_NEGATIVE_VALUE = 0xffffffff800007d8;
enum PDH_DIALOG_CANCELLED = 0xffffffff800007d9;
enum PDH_END_OF_LOG_FILE = 0xffffffff800007da;
enum PDH_ASYNC_QUERY_TIMEOUT = 0xffffffff800007db;
enum PDH_CANNOT_SET_DEFAULT_REALTIME_DATASOURCE = 0xffffffff800007dc;
enum PDH_UNABLE_MAP_NAME_FILES = 0xffffffff80000bd5;
enum PDH_PLA_VALIDATION_WARNING = 0xffffffff80000bf3;
enum PDH_CSTATUS_NO_OBJECT = 0xffffffffc0000bb8;
enum PDH_CSTATUS_NO_COUNTER = 0xffffffffc0000bb9;
enum PDH_CSTATUS_INVALID_DATA = 0xffffffffc0000bba;
enum PDH_MEMORY_ALLOCATION_FAILURE = 0xffffffffc0000bbb;
enum PDH_INVALID_HANDLE = 0xffffffffc0000bbc;
enum PDH_INVALID_ARGUMENT = 0xffffffffc0000bbd;
enum PDH_FUNCTION_NOT_FOUND = 0xffffffffc0000bbe;
enum PDH_CSTATUS_NO_COUNTERNAME = 0xffffffffc0000bbf;
enum PDH_CSTATUS_BAD_COUNTERNAME = 0xffffffffc0000bc0;
enum PDH_INVALID_BUFFER = 0xffffffffc0000bc1;
enum PDH_INSUFFICIENT_BUFFER = 0xffffffffc0000bc2;
enum PDH_CANNOT_CONNECT_MACHINE = 0xffffffffc0000bc3;
enum PDH_INVALID_PATH = 0xffffffffc0000bc4;
enum PDH_INVALID_INSTANCE = 0xffffffffc0000bc5;
enum PDH_INVALID_DATA = 0xffffffffc0000bc6;
enum PDH_NO_DIALOG_DATA = 0xffffffffc0000bc7;
enum PDH_CANNOT_READ_NAME_STRINGS = 0xffffffffc0000bc8;
enum PDH_LOG_FILE_CREATE_ERROR = 0xffffffffc0000bc9;
enum PDH_LOG_FILE_OPEN_ERROR = 0xffffffffc0000bca;
enum PDH_LOG_TYPE_NOT_FOUND = 0xffffffffc0000bcb;
enum PDH_NO_MORE_DATA = 0xffffffffc0000bcc;
enum PDH_ENTRY_NOT_IN_LOG_FILE = 0xffffffffc0000bcd;
enum PDH_DATA_SOURCE_IS_LOG_FILE = 0xffffffffc0000bce;
enum PDH_DATA_SOURCE_IS_REAL_TIME = 0xffffffffc0000bcf;
enum PDH_UNABLE_READ_LOG_HEADER = 0xffffffffc0000bd0;
enum PDH_FILE_NOT_FOUND = 0xffffffffc0000bd1;
enum PDH_FILE_ALREADY_EXISTS = 0xffffffffc0000bd2;
enum PDH_NOT_IMPLEMENTED = 0xffffffffc0000bd3;
enum PDH_STRING_NOT_FOUND = 0xffffffffc0000bd4;
enum PDH_UNKNOWN_LOG_FORMAT = 0xffffffffc0000bd6;
enum PDH_UNKNOWN_LOGSVC_COMMAND = 0xffffffffc0000bd7;
enum PDH_LOGSVC_QUERY_NOT_FOUND = 0xffffffffc0000bd8;
enum PDH_LOGSVC_NOT_OPENED = 0xffffffffc0000bd9;
enum PDH_WBEM_ERROR = 0xffffffffc0000bda;
enum PDH_ACCESS_DENIED = 0xffffffffc0000bdb;
enum PDH_LOG_FILE_TOO_SMALL = 0xffffffffc0000bdc;
enum PDH_INVALID_DATASOURCE = 0xffffffffc0000bdd;
enum PDH_INVALID_SQLDB = 0xffffffffc0000bde;
enum PDH_NO_COUNTERS = 0xffffffffc0000bdf;
enum PDH_SQL_ALLOC_FAILED = 0xffffffffc0000be0;
enum PDH_SQL_ALLOCCON_FAILED = 0xffffffffc0000be1;
enum PDH_SQL_EXEC_DIRECT_FAILED = 0xffffffffc0000be2;
enum PDH_SQL_FETCH_FAILED = 0xffffffffc0000be3;
enum PDH_SQL_ROWCOUNT_FAILED = 0xffffffffc0000be4;
enum PDH_SQL_MORE_RESULTS_FAILED = 0xffffffffc0000be5;
enum PDH_SQL_CONNECT_FAILED = 0xffffffffc0000be6;
enum PDH_SQL_BIND_FAILED = 0xffffffffc0000be7;
enum PDH_CANNOT_CONNECT_WMI_SERVER = 0xffffffffc0000be8;
enum PDH_PLA_COLLECTION_ALREADY_RUNNING = 0xffffffffc0000be9;
enum PDH_PLA_ERROR_SCHEDULE_OVERLAP = 0xffffffffc0000bea;
enum PDH_PLA_COLLECTION_NOT_FOUND = 0xffffffffc0000beb;
enum PDH_PLA_ERROR_SCHEDULE_ELAPSED = 0xffffffffc0000bec;
enum PDH_PLA_ERROR_NOSTART = 0xffffffffc0000bed;
enum PDH_PLA_ERROR_ALREADY_EXISTS = 0xffffffffc0000bee;
enum PDH_PLA_ERROR_TYPE_MISMATCH = 0xffffffffc0000bef;
enum PDH_PLA_ERROR_FILEPATH = 0xffffffffc0000bf0;
enum PDH_PLA_SERVICE_ERROR = 0xffffffffc0000bf1;
enum PDH_PLA_VALIDATION_ERROR = 0xffffffffc0000bf2;
enum PDH_PLA_ERROR_NAME_TOO_LONG = 0xffffffffc0000bf4;
enum PDH_INVALID_SQL_LOG_FORMAT = 0xffffffffc0000bf5;
enum PDH_COUNTER_ALREADY_IN_QUERY = 0xffffffffc0000bf6;
enum PDH_BINARY_LOG_CORRUPT = 0xffffffffc0000bf7;
enum PDH_LOG_SAMPLE_TOO_SMALL = 0xffffffffc0000bf8;
enum PDH_OS_LATER_VERSION = 0xffffffffc0000bf9;
enum PDH_OS_EARLIER_VERSION = 0xffffffffc0000bfa;
enum PDH_INCORRECT_APPEND_TIME = 0xffffffffc0000bfb;
enum PDH_UNMATCHED_APPEND_COUNTER = 0xffffffffc0000bfc;
enum PDH_SQL_ALTER_DETAIL_FAILED = 0xffffffffc0000bfd;
enum PDH_QUERY_PERF_DATA_TIMEOUT = 0xffffffffc0000bfe;
...
interface IDataCollectorSet : IDispatch
{
    ...
    HRESULT get_Segment(short*);
    HRESULT put_Segment(short);
    ...
    HRESULT get_TaskRunAsSelf(short*);
    HRESULT put_TaskRunAsSelf(short);
    ...
    HRESULT get_SchedulesEnabled(short*);
    HRESULT put_SchedulesEnabled(short);
    HRESULT get_UserAccount(BSTR*);
    HRESULT get_Xml(BSTR*);
    HRESULT get_Security(BSTR*);
    HRESULT put_Security(BSTR);
    HRESULT get_StopOnCompletion(short*);
    HRESULT put_StopOnCompletion(short);
...
interface IDataManager : IDispatch
{
    ...
    HRESULT get_CheckBeforeRunning(short*);
    HRESULT put_CheckBeforeRunning(short);
...
interface IDataCollector : IDispatch
{
    ...
    HRESULT get_LatestOutputLocation(BSTR*);
    HRESULT put_LatestOutputLocation(BSTR);
    HRESULT get_LogAppend(short*);
    HRESULT put_LogAppend(short);
    HRESULT get_LogCircular(short*);
    HRESULT put_LogCircular(short);
    HRESULT get_LogOverwrite(short*);
    HRESULT put_LogOverwrite(short);
    HRESULT get_Name(BSTR*);
    ...
    HRESULT get_Xml(BSTR*);
    HRESULT SetXml(BSTR, IValueMap*);
    HRESULT CreateOutputLocation(short, BSTR*);
}
...
interface ITraceDataCollector : IDataCollector
{
    ...
    HRESULT get_IsKernelTrace(short*);
    ...
    HRESULT get_PreallocateFile(short*);
    HRESULT put_PreallocateFile(short);
    HRESULT get_ProcessMode(short*);
    HRESULT put_ProcessMode(short);
...
interface IConfigurationDataCollector : IDataCollector
{
    ...
    HRESULT get_QueryNetworkAdapters(short*);
    HRESULT put_QueryNetworkAdapters(short);
...
interface IAlertDataCollector : IDataCollector
{
    ...
    HRESULT get_EventLog(short*);
    HRESULT put_EventLog(short);
    HRESULT get_SampleInterval(uint*);
    HRESULT put_SampleInterval(uint);
    HRESULT get_Task(BSTR*);
    HRESULT put_Task(BSTR);
...
{
    HRESULT get_LogApiNamesOnly(short*);
    HRESULT put_LogApiNamesOnly(short);
    HRESULT get_LogApisRecursively(short*);
    HRESULT put_LogApisRecursively(short);
...
interface ITraceDataProvider : IDispatch
{
    ...
    HRESULT get_FilterEnabled(short*);
    HRESULT put_FilterEnabled(short);
...
interface ISystemMonitor : IUnknown
{
    ...
    HRESULT put_ShowVerticalGrid(short);
    HRESULT get_ShowVerticalGrid(short*);
    HRESULT put_ShowHorizontalGrid(short);
    HRESULT get_ShowHorizontalGrid(short*);
    HRESULT put_ShowLegend(short);
    HRESULT get_ShowLegend(short*);
    HRESULT put_ShowScaleLabels(short);
    HRESULT get_ShowScaleLabels(short*);
    HRESULT put_ShowValueBar(short);
    HRESULT get_ShowValueBar(short*);
    ...
    HRESULT put_ManualUpdate(short);
    HRESULT get_ManualUpdate(short*);
    ...
    HRESULT get_Highlight(short*);
    HRESULT put_Highlight(short);
    HRESULT get_ShowToolbar(short*);
    HRESULT put_ShowToolbar(short);
    HRESULT Paste();
    HRESULT Copy();
    HRESULT Reset();
    ...
    HRESULT put_MonitorDuplicateInstances(short);
    HRESULT get_MonitorDuplicateInstances(short*);
...
{
    HRESULT put_EnableDigitGrouping(short);
    HRESULT get_EnableDigitGrouping(short*);
    HRESULT put_EnableToolTips(short);
    HRESULT get_EnableToolTips(short*);
    HRESULT put_ShowTimeAxisLabels(short);
    HRESULT get_ShowTimeAxisLabels(short*);
    HRESULT put_ChartScroll(short);
    HRESULT get_ChartScroll(short*);
    HRESULT put_DataPointCount(int);
    HRESULT get_DataPointCount(int*);
    HRESULT ScaleToFit(short);
    ...
    HRESULT BatchingLock(short, SysmonBatchReason);
