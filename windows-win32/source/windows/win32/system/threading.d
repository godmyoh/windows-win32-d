...
HANDLE OpenMutexW(uint, BOOL, const(wchar)*);
...
HANDLE OpenEventA(uint, BOOL, const(char)*);
HANDLE OpenEventW(uint, BOOL, const(wchar)*);
HANDLE OpenSemaphoreW(uint, BOOL, const(wchar)*);
HANDLE OpenWaitableTimerW(uint, BOOL, const(wchar)*);
...
enum MUTEX_MODIFY_STATE = 0x00000001;
