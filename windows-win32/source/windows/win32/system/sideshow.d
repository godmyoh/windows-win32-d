...
enum SIDESHOW_CAPABILITY_DEVICE_ID = PROPERTYKEY(GUID(2327611560, 34171, 19159, [163, 90, 181, 148, 47, 73, 43, 153]), 1);
enum SIDESHOW_CAPABILITY_SCREEN_TYPE = PROPERTYKEY(GUID(2327611560, 34171, 19159, [163, 90, 181, 148, 47, 73, 43, 153]), 2);
enum SIDESHOW_CAPABILITY_SCREEN_WIDTH = PROPERTYKEY(GUID(2327611560, 34171, 19159, [163, 90, 181, 148, 47, 73, 43, 153]), 3);
enum SIDESHOW_CAPABILITY_SCREEN_HEIGHT = PROPERTYKEY(GUID(2327611560, 34171, 19159, [163, 90, 181, 148, 47, 73, 43, 153]), 4);
enum SIDESHOW_CAPABILITY_COLOR_DEPTH = PROPERTYKEY(GUID(2327611560, 34171, 19159, [163, 90, 181, 148, 47, 73, 43, 153]), 5);
enum SIDESHOW_CAPABILITY_COLOR_TYPE = PROPERTYKEY(GUID(2327611560, 34171, 19159, [163, 90, 181, 148, 47, 73, 43, 153]), 6);
enum SIDESHOW_CAPABILITY_DATA_CACHE = PROPERTYKEY(GUID(2327611560, 34171, 19159, [163, 90, 181, 148, 47, 73, 43, 153]), 7);
enum SIDESHOW_CAPABILITY_SUPPORTED_LANGUAGES = PROPERTYKEY(GUID(2327611560, 34171, 19159, [163, 90, 181, 148, 47, 73, 43, 153]), 8);
enum SIDESHOW_CAPABILITY_CURRENT_LANGUAGE = PROPERTYKEY(GUID(2327611560, 34171, 19159, [163, 90, 181, 148, 47, 73, 43, 153]), 9);
enum SIDESHOW_CAPABILITY_SUPPORTED_THEMES = PROPERTYKEY(GUID(2327611560, 34171, 19159, [163, 90, 181, 148, 47, 73, 43, 153]), 10);
enum SIDESHOW_CAPABILITY_SUPPORTED_IMAGE_FORMATS = PROPERTYKEY(GUID(2327611560, 34171, 19159, [163, 90, 181, 148, 47, 73, 43, 153]), 14);
enum SIDESHOW_CAPABILITY_CLIENT_AREA_WIDTH = PROPERTYKEY(GUID(2327611560, 34171, 19159, [163, 90, 181, 148, 47, 73, 43, 153]), 15);
enum SIDESHOW_CAPABILITY_CLIENT_AREA_HEIGHT = PROPERTYKEY(GUID(2327611560, 34171, 19159, [163, 90, 181, 148, 47, 73, 43, 153]), 16);
