...
enum : ulong
{
    SFGAO_CANCOPY         = 0x0000000000000001,
    SFGAO_CANMOVE         = 0x0000000000000002,
    SFGAO_CANLINK         = 0x0000000000000004,
    SFGAO_STORAGE         = 0x0000000000000008,
    SFGAO_CANRENAME       = 0x0000000000000010,
    SFGAO_CANDELETE       = 0x0000000000000020,
    SFGAO_HASPROPSHEET    = 0x0000000000000040,
    SFGAO_DROPTARGET      = 0x0000000000000100,
    SFGAO_CAPABILITYMASK  = 0x0000000000000177,
    SFGAO_PLACEHOLDER     = 0x0000000000000800,
    SFGAO_SYSTEM          = 0x0000000000001000,
    SFGAO_ENCRYPTED       = 0x0000000000002000,
    SFGAO_ISSLOW          = 0x0000000000004000,
    SFGAO_GHOSTED         = 0x0000000000008000,
    SFGAO_LINK            = 0x0000000000010000,
    SFGAO_SHARE           = 0x0000000000020000,
    SFGAO_READONLY        = 0x0000000000040000,
    SFGAO_HIDDEN          = 0x0000000000080000,
    SFGAO_DISPLAYATTRMASK = 0x00000000000fc000,
    SFGAO_FILESYSANCESTOR = 0x0000000010000000,
    SFGAO_FOLDER          = 0x0000000020000000,
    SFGAO_FILESYSTEM      = 0x0000000040000000,
    SFGAO_HASSUBFOLDER    = 0x0000000080000000,
    SFGAO_CONTENTSMASK    = 0x0000000080000000,
    SFGAO_VALIDATE        = 0x0000000001000000,
    SFGAO_REMOVABLE       = 0x0000000002000000,
    SFGAO_COMPRESSED      = 0x0000000004000000,
    SFGAO_BROWSABLE       = 0x0000000008000000,
    SFGAO_NONENUMERATED   = 0x0000000000100000,
    SFGAO_NEWCONTENT      = 0x0000000000200000,
    SFGAO_CANMONIKER      = 0x0000000000400000,
    SFGAO_HASSTORAGE      = 0x0000000000400000,
    SFGAO_STREAM          = 0x0000000000400000,
    SFGAO_STORAGEANCESTOR = 0x0000000000800000,
    SFGAO_STORAGECAPMASK  = 0x0000000070c50008,
    SFGAO_PKEYSFGAOMASK   = 0x0000000081044000,
}
