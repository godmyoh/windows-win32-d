...
import windows.win32.foundation : BSTR, HRESULT, HWND;
import windows.win32.graphics.gdi : HBITMAP, HDC, HPALETTE;
import windows.win32.system.com_ : CO_MARSHALING_CONTEXT_ATTRIBUTES, IStream, IUnknown, SAFEARRAY, STGMEDIUM, VARIANT;
...
uint HGLOBAL_UserSize(uint*, uint, long*);
ubyte* HGLOBAL_UserMarshal(uint*, ubyte*, long*);
ubyte* HGLOBAL_UserUnmarshal(uint*, ubyte*, long*);
void HGLOBAL_UserFree(uint*, long*);
...
uint HGLOBAL_UserSize64(uint*, uint, long*);
ubyte* HGLOBAL_UserMarshal64(uint*, ubyte*, long*);
ubyte* HGLOBAL_UserUnmarshal64(uint*, ubyte*, long*);
void HGLOBAL_UserFree64(uint*, long*);
