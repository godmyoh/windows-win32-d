...
BOOL SetConsoleTextAttribute(HANDLE, ushort);
...
enum FOREGROUND_BLUE = 0x00000001;
enum FOREGROUND_GREEN = 0x00000002;
enum FOREGROUND_RED = 0x00000004;
enum FOREGROUND_INTENSITY = 0x00000008;
enum BACKGROUND_BLUE = 0x00000010;
enum BACKGROUND_GREEN = 0x00000020;
enum BACKGROUND_RED = 0x00000040;
enum BACKGROUND_INTENSITY = 0x00000080;
enum COMMON_LVB_LEADING_BYTE = 0x00000100;
enum COMMON_LVB_TRAILING_BYTE = 0x00000200;
enum COMMON_LVB_GRID_HORIZONTAL = 0x00000400;
enum COMMON_LVB_GRID_LVERTICAL = 0x00000800;
enum COMMON_LVB_GRID_RVERTICAL = 0x00001000;
enum COMMON_LVB_REVERSE_VIDEO = 0x00004000;
enum COMMON_LVB_UNDERSCORE = 0x00008000;
enum COMMON_LVB_SBCSDBCS = 0x00000300;
