...
import windows.win32.storage.structuredstorage : JET_API_PTR, JET_HANDLE, JET_TABLEID;
...
int JetGetInstanceMiscInfo(JET_INSTANCE instance, void* pvResult, uint cbMax, uint InfoLevel);
...
int JetSetSystemParameterA(JET_INSTANCE* pinstance, JET_SESID sesid, uint paramid, JET_API_PTR lParam, byte* szParam);
int JetSetSystemParameterW(JET_INSTANCE* pinstance, JET_SESID sesid, uint paramid, JET_API_PTR lParam, ushort* szParam);
int JetGetSystemParameterA(JET_INSTANCE instance, JET_SESID sesid, uint paramid, JET_API_PTR* plParam, byte* szParam, uint cbMax);
int JetGetSystemParameterW(JET_INSTANCE instance, JET_SESID sesid, uint paramid, JET_API_PTR* plParam, ushort* szParam, uint cbMax);
...
int JetCreateDatabase2W(JET_SESID sesid, ushort* szFilename, const(uint) cpgDatabaseSizeMax, uint* pdbid, uint grbit);
...
int JetGetObjectInfoA(JET_SESID sesid, uint dbid, uint objtyp, byte* szContainerName, byte* szObjectName, void* pvResult, uint cbMax, uint InfoLevel);
int JetGetObjectInfoW(JET_SESID sesid, uint dbid, uint objtyp, ushort* szContainerName, ushort* szObjectName, void* pvResult, uint cbMax, uint InfoLevel);
int JetGetTableInfoA(JET_SESID sesid, JET_TABLEID tableid, void* pvResult, uint cbMax, uint InfoLevel);
int JetGetTableInfoW(JET_SESID sesid, JET_TABLEID tableid, void* pvResult, uint cbMax, uint InfoLevel);
int JetCreateTableA(JET_SESID sesid, uint dbid, byte* szTableName, uint lPages, uint lDensity, JET_TABLEID* ptableid);
int JetCreateTableW(JET_SESID sesid, uint dbid, ushort* szTableName, uint lPages, uint lDensity, JET_TABLEID* ptableid);
...
int JetGetTableColumnInfoA(JET_SESID sesid, JET_TABLEID tableid, byte* szColumnName, void* pvResult, uint cbMax, uint InfoLevel);
int JetGetTableColumnInfoW(JET_SESID sesid, JET_TABLEID tableid, ushort* szColumnName, void* pvResult, uint cbMax, uint InfoLevel);
int JetGetColumnInfoA(JET_SESID sesid, uint dbid, byte* szTableName, byte* pColumnNameOrId, void* pvResult, uint cbMax, uint InfoLevel);
int JetGetColumnInfoW(JET_SESID sesid, uint dbid, ushort* szTableName, ushort* pwColumnNameOrId, void* pvResult, uint cbMax, uint InfoLevel);
int JetAddColumnA(JET_SESID sesid, JET_TABLEID tableid, byte* szColumnName, const(JET_COLUMNDEF)* pcolumndef, const(void)* pvDefault, uint cbDefault, uint* pcolumnid);
int JetAddColumnW(JET_SESID sesid, JET_TABLEID tableid, ushort* szColumnName, const(JET_COLUMNDEF)* pcolumndef, const(void)* pvDefault, uint cbDefault, uint* pcolumnid);
...
int JetSetColumnDefaultValueA(JET_SESID sesid, uint dbid, byte* szTableName, byte* szColumnName, const(void)* pvData, const(uint) cbData, const(uint) grbit);
int JetSetColumnDefaultValueW(JET_SESID sesid, uint dbid, ushort* szTableName, ushort* szColumnName, const(void)* pvData, const(uint) cbData, const(uint) grbit);
int JetGetTableIndexInfoA(JET_SESID sesid, JET_TABLEID tableid, byte* szIndexName, void* pvResult, uint cbResult, uint InfoLevel);
int JetGetTableIndexInfoW(JET_SESID sesid, JET_TABLEID tableid, ushort* szIndexName, void* pvResult, uint cbResult, uint InfoLevel);
int JetGetIndexInfoA(JET_SESID sesid, uint dbid, byte* szTableName, byte* szIndexName, void* pvResult, uint cbResult, uint InfoLevel);
int JetGetIndexInfoW(JET_SESID sesid, uint dbid, ushort* szTableName, ushort* szIndexName, void* pvResult, uint cbResult, uint InfoLevel);
int JetCreateIndexA(JET_SESID sesid, JET_TABLEID tableid, byte* szIndexName, uint grbit, const(char)* szKey, uint cbKey, uint lDensity);
int JetCreateIndexW(JET_SESID sesid, JET_TABLEID tableid, ushort* szIndexName, uint grbit, const(wchar)* szKey, uint cbKey, uint lDensity);
...
int JetGetDatabaseInfoA(JET_SESID sesid, uint dbid, void* pvResult, uint cbMax, uint InfoLevel);
int JetGetDatabaseInfoW(JET_SESID sesid, uint dbid, void* pvResult, uint cbMax, uint InfoLevel);
...
int JetOpenTableA(JET_SESID sesid, uint dbid, byte* szTableName, const(void)* pvParameters, uint cbParameters, uint grbit, JET_TABLEID* ptableid);
int JetOpenTableW(JET_SESID sesid, uint dbid, ushort* szTableName, const(void)* pvParameters, uint cbParameters, uint grbit, JET_TABLEID* ptableid);
...
int JetUpdate(JET_SESID sesid, JET_TABLEID tableid, void* pvBookmark, uint cbBookmark, uint* pcbActual);
int JetUpdate2(JET_SESID sesid, JET_TABLEID tableid, void* pvBookmark, uint cbBookmark, uint* pcbActual, const(uint) grbit);
int JetEscrowUpdate(JET_SESID sesid, JET_TABLEID tableid, uint columnid, void* pv, uint cbMax, void* pvOld, uint cbOldMax, uint* pcbOldActual, uint grbit);
int JetRetrieveColumn(JET_SESID sesid, JET_TABLEID tableid, uint columnid, void* pvData, uint cbData, uint* pcbActual, uint grbit, JET_RETINFO* pretinfo);
int JetRetrieveColumns(JET_SESID sesid, JET_TABLEID tableid, JET_RETRIEVECOLUMN* pretrievecolumn, uint cretrievecolumn);
int JetEnumerateColumns(JET_SESID sesid, JET_TABLEID tableid, uint cEnumColumnId, JET_ENUMCOLUMNID* rgEnumColumnId, uint* pcEnumColumn, JET_ENUMCOLUMN** prgEnumColumn, JET_PFNREALLOC pfnRealloc, void* pvReallocContext, uint cbDataMost, uint grbit);
...
int JetSetColumn(JET_SESID sesid, JET_TABLEID tableid, uint columnid, const(void)* pvData, uint cbData, uint grbit, JET_SETINFO* psetinfo);
...
int JetGetRecordPosition(JET_SESID sesid, JET_TABLEID tableid, JET_RECPOS* precpos, uint cbRecpos);
int JetGotoPosition(JET_SESID sesid, JET_TABLEID tableid, JET_RECPOS* precpos);
int JetGetCursorInfo(JET_SESID sesid, JET_TABLEID tableid, void* pvResult, uint cbMax, uint InfoLevel);
int JetDupCursor(JET_SESID sesid, JET_TABLEID tableid, JET_TABLEID* ptableid, uint grbit);
int JetGetCurrentIndexA(JET_SESID sesid, JET_TABLEID tableid, byte* szIndexName, uint cbIndexName);
int JetGetCurrentIndexW(JET_SESID sesid, JET_TABLEID tableid, ushort* szIndexName, uint cbIndexName);
...
int JetSetCurrentIndex4A(JET_SESID sesid, JET_TABLEID tableid, byte* szIndexName, JET_INDEXID* pindexid, uint grbit, uint itagSequence);
int JetSetCurrentIndex4W(JET_SESID sesid, JET_TABLEID tableid, ushort* szIndexName, JET_INDEXID* pindexid, uint grbit, uint itagSequence);
int JetMove(JET_SESID sesid, JET_TABLEID tableid, int cRow, uint grbit);
int JetSetCursorFilter(JET_SESID sesid, JET_TABLEID tableid, JET_INDEX_COLUMN* rgColumnFilters, uint cColumnFilters, uint grbit);
int JetGetLock(JET_SESID sesid, JET_TABLEID tableid, uint grbit);
int JetMakeKey(JET_SESID sesid, JET_TABLEID tableid, const(void)* pvData, uint cbData, uint grbit);
int JetSeek(JET_SESID sesid, JET_TABLEID tableid, uint grbit);
int JetPrereadKeys(JET_SESID sesid, JET_TABLEID tableid, const(void)** rgpvKeys, const(uint)* rgcbKeys, int ckeys, int* pckeysPreread, uint grbit);
int JetPrereadIndexRanges(JET_SESID sesid, JET_TABLEID tableid, const(JET_INDEX_RANGE)* rgIndexRanges, const(uint) cIndexRanges, uint* pcRangesPreread, const(uint)* rgcolumnidPreread, const(uint) ccolumnidPreread, uint grbit);
int JetGetBookmark(JET_SESID sesid, JET_TABLEID tableid, void* pvBookmark, uint cbMax, uint* pcbActual);
int JetGetSecondaryIndexBookmark(JET_SESID sesid, JET_TABLEID tableid, void* pvSecondaryKey, uint cbSecondaryKeyMax, uint* pcbSecondaryKeyActual, void* pvPrimaryBookmark, uint cbPrimaryBookmarkMax, uint* pcbPrimaryBookmarkActual, const(uint) grbit);
int JetCompactA(JET_SESID sesid, byte* szDatabaseSrc, byte* szDatabaseDest, JET_PFNSTATUS pfnStatus, JET_CONVERT_A* pconvert, uint grbit);
int JetCompactW(JET_SESID sesid, ushort* szDatabaseSrc, ushort* szDatabaseDest, JET_PFNSTATUS pfnStatus, JET_CONVERT_W* pconvert, uint grbit);
...
int JetDefragment2A(JET_SESID sesid, uint dbid, byte* szTableName, uint* pcPasses, uint* pcSeconds, JET_CALLBACK callback, uint grbit);
int JetDefragment2W(JET_SESID sesid, uint dbid, ushort* szTableName, uint* pcPasses, uint* pcSeconds, JET_CALLBACK callback, uint grbit);
int JetDefragment3A(JET_SESID sesid, byte* szDatabaseName, byte* szTableName, uint* pcPasses, uint* pcSeconds, JET_CALLBACK callback, void* pvContext, uint grbit);
int JetDefragment3W(JET_SESID sesid, ushort* szDatabaseName, ushort* szTableName, uint* pcPasses, uint* pcSeconds, JET_CALLBACK callback, void* pvContext, uint grbit);
...
int JetGotoBookmark(JET_SESID sesid, JET_TABLEID tableid, void* pvBookmark, uint cbBookmark);
int JetGotoSecondaryIndexBookmark(JET_SESID sesid, JET_TABLEID tableid, void* pvSecondaryKey, uint cbSecondaryKey, void* pvPrimaryBookmark, uint cbPrimaryBookmark, const(uint) grbit);
int JetIntersectIndexes(JET_SESID sesid, JET_INDEXRANGE* rgindexrange, uint cindexrange, JET_RECORDLIST* precordlist, uint grbit);
int JetComputeStats(JET_SESID sesid, JET_TABLEID tableid);
int JetOpenTempTable(JET_SESID sesid, const(JET_COLUMNDEF)* prgcolumndef, uint ccolumn, uint grbit, JET_TABLEID* ptableid, uint* prgcolumnid);
int JetOpenTempTable2(JET_SESID sesid, const(JET_COLUMNDEF)* prgcolumndef, uint ccolumn, uint lcid, uint grbit, JET_TABLEID* ptableid, uint* prgcolumnid);
int JetOpenTempTable3(JET_SESID sesid, const(JET_COLUMNDEF)* prgcolumndef, uint ccolumn, JET_UNICODEINDEX* pidxunicode, uint grbit, JET_TABLEID* ptableid, uint* prgcolumnid);
...
int JetRetrieveKey(JET_SESID sesid, JET_TABLEID tableid, void* pvKey, uint cbMax, uint* pcbActual, uint grbit);
...
int JetGetAttachInfoInstanceA(JET_INSTANCE instance, byte* szzDatabases, uint cbMax, uint* pcbActual);
int JetGetAttachInfoInstanceW(JET_INSTANCE instance, ushort* szzDatabases, uint cbMax, uint* pcbActual);
...
int JetOpenFileInstanceA(JET_INSTANCE instance, byte* szFileName, JET_HANDLE* phfFile, uint* pulFileSizeLow, uint* pulFileSizeHigh);
int JetOpenFileInstanceW(JET_INSTANCE instance, ushort* szFileName, JET_HANDLE* phfFile, uint* pulFileSizeLow, uint* pulFileSizeHigh);
int JetReadFile(JET_HANDLE hfFile, void* pv, uint cb, uint* pcbActual);
int JetReadFileInstance(JET_INSTANCE instance, JET_HANDLE hfFile, void* pv, uint cb, uint* pcbActual);
...
int JetGetLogInfoInstanceA(JET_INSTANCE instance, byte* szzLogs, uint cbMax, uint* pcbActual);
int JetGetLogInfoInstanceW(JET_INSTANCE instance, ushort* wszzLogs, uint cbMax, uint* pcbActual);
int JetGetLogInfoInstance2A(JET_INSTANCE instance, byte* szzLogs, uint cbMax, uint* pcbActual, JET_LOGINFO_A* pLogInfo);
int JetGetLogInfoInstance2W(JET_INSTANCE instance, ushort* wszzLogs, uint cbMax, uint* pcbActual, JET_LOGINFO_W* pLogInfo);
int JetGetTruncateLogInfoInstanceA(JET_INSTANCE instance, byte* szzLogs, uint cbMax, uint* pcbActual);
int JetGetTruncateLogInfoInstanceW(JET_INSTANCE instance, ushort* wszzLogs, uint cbMax, uint* pcbActual);
int JetTruncateLog();
...
int JetExternalRestoreA(byte* szCheckpointFilePath, byte* szLogPath, JET_RSTMAP_A* rgrstmap, int crstfilemap, byte* szBackupLogPath, int genLow, int genHigh, JET_PFNSTATUS pfn);
int JetExternalRestoreW(ushort* szCheckpointFilePath, ushort* szLogPath, JET_RSTMAP_W* rgrstmap, int crstfilemap, ushort* szBackupLogPath, int genLow, int genHigh, JET_PFNSTATUS pfn);
int JetExternalRestore2A(byte* szCheckpointFilePath, byte* szLogPath, JET_RSTMAP_A* rgrstmap, int crstfilemap, byte* szBackupLogPath, JET_LOGINFO_A* pLogInfo, byte* szTargetInstanceName, byte* szTargetInstanceLogPath, byte* szTargetInstanceCheckpointPath, JET_PFNSTATUS pfn);
int JetExternalRestore2W(ushort* szCheckpointFilePath, ushort* szLogPath, JET_RSTMAP_W* rgrstmap, int crstfilemap, ushort* szBackupLogPath, JET_LOGINFO_W* pLogInfo, ushort* szTargetInstanceName, ushort* szTargetInstanceLogPath, ushort* szTargetInstanceCheckpointPath, JET_PFNSTATUS pfn);
int JetRegisterCallback(JET_SESID sesid, JET_TABLEID tableid, uint cbtyp, JET_CALLBACK pCallback, void* pvContext, JET_HANDLE* phCallbackId);
...
int JetOSSnapshotFreezeA(const(JET_OSSNAPID) snapId, uint* pcInstanceInfo, JET_INSTANCE_INFO_A** paInstanceInfo, const(uint) grbit);
int JetOSSnapshotFreezeW(const(JET_OSSNAPID) snapId, uint* pcInstanceInfo, JET_INSTANCE_INFO_W** paInstanceInfo, const(uint) grbit);
...
int JetOSSnapshotGetFreezeInfoA(const(JET_OSSNAPID) snapId, uint* pcInstanceInfo, JET_INSTANCE_INFO_A** paInstanceInfo, const(uint) grbit);
int JetOSSnapshotGetFreezeInfoW(const(JET_OSSNAPID) snapId, uint* pcInstanceInfo, JET_INSTANCE_INFO_W** paInstanceInfo, const(uint) grbit);
...
int JetSetSessionParameter(JET_SESID sesid, uint sesparamid, void* pvParam, uint cbParam);
...
alias JET_INSTANCE = ulong;
alias JET_SESID = ulong;
...
alias JET_CALLBACK = int function(JET_SESID sesid, uint dbid, JET_TABLEID tableid, uint cbtyp, void* pvArg1, void* pvArg2, void* pvContext, JET_API_PTR ulUnused);
struct JET_SNPROG
{
    uint cbStruct;
    uint cunitDone;
