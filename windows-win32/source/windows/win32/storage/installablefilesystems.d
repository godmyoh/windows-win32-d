...
HRESULT FilterAttach(const(wchar)* lpFilterName, const(wchar)* lpVolumeName, const(wchar)* lpInstanceName, uint dwCreatedInstanceNameLength, PWSTR lpCreatedInstanceName);
HRESULT FilterAttachAtAltitude(const(wchar)* lpFilterName, const(wchar)* lpVolumeName, const(wchar)* lpAltitude, const(wchar)* lpInstanceName, uint dwCreatedInstanceNameLength, PWSTR lpCreatedInstanceName);
HRESULT FilterDetach(const(wchar)* lpFilterName, const(wchar)* lpVolumeName, const(wchar)* lpInstanceName);
HRESULT FilterFindFirst(FILTER_INFORMATION_CLASS dwInformationClass, void* lpBuffer, uint dwBufferSize, uint* lpBytesReturned, HANDLE* lpFilterFind);
HRESULT FilterFindNext(HANDLE hFilterFind, FILTER_INFORMATION_CLASS dwInformationClass, void* lpBuffer, uint dwBufferSize, uint* lpBytesReturned);
HRESULT FilterFindClose(HANDLE hFilterFind);
HRESULT FilterVolumeFindFirst(FILTER_VOLUME_INFORMATION_CLASS dwInformationClass, void* lpBuffer, uint dwBufferSize, uint* lpBytesReturned, HANDLE* lpVolumeFind);
HRESULT FilterVolumeFindNext(HANDLE hVolumeFind, FILTER_VOLUME_INFORMATION_CLASS dwInformationClass, void* lpBuffer, uint dwBufferSize, uint* lpBytesReturned);
HRESULT FilterVolumeFindClose(HANDLE hVolumeFind);
HRESULT FilterInstanceFindFirst(const(wchar)* lpFilterName, INSTANCE_INFORMATION_CLASS dwInformationClass, void* lpBuffer, uint dwBufferSize, uint* lpBytesReturned, HANDLE* lpFilterInstanceFind);
HRESULT FilterInstanceFindNext(HANDLE hFilterInstanceFind, INSTANCE_INFORMATION_CLASS dwInformationClass, void* lpBuffer, uint dwBufferSize, uint* lpBytesReturned);
HRESULT FilterInstanceFindClose(HANDLE hFilterInstanceFind);
HRESULT FilterVolumeInstanceFindFirst(const(wchar)* lpVolumeName, INSTANCE_INFORMATION_CLASS dwInformationClass, void* lpBuffer, uint dwBufferSize, uint* lpBytesReturned, HANDLE* lpVolumeInstanceFind);
HRESULT FilterVolumeInstanceFindNext(HANDLE hVolumeInstanceFind, INSTANCE_INFORMATION_CLASS dwInformationClass, void* lpBuffer, uint dwBufferSize, uint* lpBytesReturned);
HRESULT FilterVolumeInstanceFindClose(HANDLE hVolumeInstanceFind);
HRESULT FilterGetInformation(HFILTER hFilter, FILTER_INFORMATION_CLASS dwInformationClass, void* lpBuffer, uint dwBufferSize, uint* lpBytesReturned);
HRESULT FilterInstanceGetInformation(HFILTER_INSTANCE hInstance, INSTANCE_INFORMATION_CLASS dwInformationClass, void* lpBuffer, uint dwBufferSize, uint* lpBytesReturned);
HRESULT FilterConnectCommunicationPort(const(wchar)* lpPortName, uint dwOptions, const(void)* lpContext, ushort wSizeOfContext, SECURITY_ATTRIBUTES* lpSecurityAttributes, HANDLE* hPort);
HRESULT FilterSendMessage(HANDLE hPort, void* lpInBuffer, uint dwInBufferSize, void* lpOutBuffer, uint dwOutBufferSize, uint* lpBytesReturned);
HRESULT FilterGetMessage(HANDLE hPort, FILTER_MESSAGE_HEADER* lpMessageBuffer, uint dwMessageBufferSize, OVERLAPPED* lpOverlapped);
HRESULT FilterReplyMessage(HANDLE hPort, FILTER_REPLY_HEADER* lpReplyBuffer, uint dwReplyBufferSize);
HRESULT FilterGetDosName(const(wchar)* lpVolumeName, PWSTR lpDosName, uint dwDosNameBufferSize);
