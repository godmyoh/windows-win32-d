...
uint GetIScsiTargetInformationW(PWSTR TargetName, PWSTR DiscoveryMechanism, TARGET_INFORMATION_CLASS InfoClass, uint* BufferSize, void* Buffer);
uint GetIScsiTargetInformationA(PSTR TargetName, PSTR DiscoveryMechanism, TARGET_INFORMATION_CLASS InfoClass, uint* BufferSize, void* Buffer);
uint AddIScsiConnectionW(ISCSI_UNIQUE_SESSION_ID* UniqueSessionId, void* Reserved, uint InitiatorPortNumber, ISCSI_TARGET_PORTALW* TargetPortal, ulong SecurityFlags, ISCSI_LOGIN_OPTIONS* LoginOptions, uint KeySize, PSTR Key, ISCSI_UNIQUE_SESSION_ID* ConnectionId);
uint AddIScsiConnectionA(ISCSI_UNIQUE_SESSION_ID* UniqueSessionId, void* Reserved, uint InitiatorPortNumber, ISCSI_TARGET_PORTALA* TargetPortal, ulong SecurityFlags, ISCSI_LOGIN_OPTIONS* LoginOptions, uint KeySize, PSTR Key, ISCSI_UNIQUE_SESSION_ID* ConnectionId);
uint RemoveIScsiConnection(ISCSI_UNIQUE_SESSION_ID* UniqueSessionId, ISCSI_UNIQUE_SESSION_ID* ConnectionId);
uint ReportIScsiTargetsW(BOOLEAN ForceUpdate, uint* BufferSize, PWSTR Buffer);
uint ReportIScsiTargetsA(BOOLEAN ForceUpdate, uint* BufferSize, PSTR Buffer);
uint AddIScsiStaticTargetW(PWSTR TargetName, PWSTR TargetAlias, uint TargetFlags, BOOLEAN Persist, ISCSI_TARGET_MAPPINGW* Mappings, ISCSI_LOGIN_OPTIONS* LoginOptions, ISCSI_TARGET_PORTAL_GROUPW* PortalGroup);
uint AddIScsiStaticTargetA(PSTR TargetName, PSTR TargetAlias, uint TargetFlags, BOOLEAN Persist, ISCSI_TARGET_MAPPINGA* Mappings, ISCSI_LOGIN_OPTIONS* LoginOptions, ISCSI_TARGET_PORTAL_GROUPA* PortalGroup);
uint RemoveIScsiStaticTargetW(PWSTR TargetName);
uint RemoveIScsiStaticTargetA(PSTR TargetName);
uint AddIScsiSendTargetPortalW(PWSTR InitiatorInstance, uint InitiatorPortNumber, ISCSI_LOGIN_OPTIONS* LoginOptions, ulong SecurityFlags, ISCSI_TARGET_PORTALW* Portal);
uint AddIScsiSendTargetPortalA(PSTR InitiatorInstance, uint InitiatorPortNumber, ISCSI_LOGIN_OPTIONS* LoginOptions, ulong SecurityFlags, ISCSI_TARGET_PORTALA* Portal);
...
uint LoginIScsiTargetW(PWSTR TargetName, BOOLEAN IsInformationalSession, PWSTR InitiatorInstance, uint InitiatorPortNumber, ISCSI_TARGET_PORTALW* TargetPortal, ulong SecurityFlags, ISCSI_TARGET_MAPPINGW* Mappings, ISCSI_LOGIN_OPTIONS* LoginOptions, uint KeySize, PSTR Key, BOOLEAN IsPersistent, ISCSI_UNIQUE_SESSION_ID* UniqueSessionId, ISCSI_UNIQUE_SESSION_ID* UniqueConnectionId);
uint LoginIScsiTargetA(PSTR TargetName, BOOLEAN IsInformationalSession, PSTR InitiatorInstance, uint InitiatorPortNumber, ISCSI_TARGET_PORTALA* TargetPortal, ulong SecurityFlags, ISCSI_TARGET_MAPPINGA* Mappings, ISCSI_LOGIN_OPTIONS* LoginOptions, uint KeySize, PSTR Key, BOOLEAN IsPersistent, ISCSI_UNIQUE_SESSION_ID* UniqueSessionId, ISCSI_UNIQUE_SESSION_ID* UniqueConnectionId);
...
uint RemoveIScsiPersistentTargetW(PWSTR InitiatorInstance, uint InitiatorPortNumber, PWSTR TargetName, ISCSI_TARGET_PORTALW* Portal);
uint RemoveIScsiPersistentTargetA(PSTR InitiatorInstance, uint InitiatorPortNumber, PSTR TargetName, ISCSI_TARGET_PORTALA* Portal);
...
uint SetIScsiTunnelModeOuterAddressW(PWSTR InitiatorName, uint InitiatorPortNumber, PWSTR DestinationAddress, PWSTR OuterModeAddress, BOOLEAN Persist);
uint SetIScsiTunnelModeOuterAddressA(PSTR InitiatorName, uint InitiatorPortNumber, PSTR DestinationAddress, PSTR OuterModeAddress, BOOLEAN Persist);
uint SetIScsiIKEInfoW(PWSTR InitiatorName, uint InitiatorPortNumber, IKE_AUTHENTICATION_INFORMATION* AuthInfo, BOOLEAN Persist);
uint SetIScsiIKEInfoA(PSTR InitiatorName, uint InitiatorPortNumber, IKE_AUTHENTICATION_INFORMATION* AuthInfo, BOOLEAN Persist);
uint GetIScsiIKEInfoW(PWSTR InitiatorName, uint InitiatorPortNumber, uint* Reserved, IKE_AUTHENTICATION_INFORMATION* AuthInfo);
uint GetIScsiIKEInfoA(PSTR InitiatorName, uint InitiatorPortNumber, uint* Reserved, IKE_AUTHENTICATION_INFORMATION* AuthInfo);
...
uint ReportIScsiTargetPortalsW(PWSTR InitiatorName, PWSTR TargetName, ushort* TargetPortalTag, uint* ElementCount, ISCSI_TARGET_PORTALW* Portals);
uint ReportIScsiTargetPortalsA(PSTR InitiatorName, PSTR TargetName, ushort* TargetPortalTag, uint* ElementCount, ISCSI_TARGET_PORTALA* Portals);
