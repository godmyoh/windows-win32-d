...
import windows.win32.foundation : BOOL, HANDLE, HRESULT, PSTR, PWSTR, WIN32_ERROR;
...
WIN32_ERROR GetCurrentPackageId(uint* bufferLength, ubyte* buffer);
...
WIN32_ERROR GetPackageId(HANDLE hProcess, uint* bufferLength, ubyte* buffer);
...
WIN32_ERROR GetPackagePath(const(PACKAGE_ID)* packageId, const(uint) reserved, uint* pathLength, PWSTR path);
WIN32_ERROR GetPackagePathByFullName(const(wchar)* packageFullName, uint* pathLength, PWSTR path);
WIN32_ERROR GetStagedPackagePathByFullName(const(wchar)* packageFullName, uint* pathLength, PWSTR path);
WIN32_ERROR GetPackagePathByFullName2(const(wchar)* packageFullName, PackagePathType packagePathType, uint* pathLength, PWSTR path);
WIN32_ERROR GetStagedPackagePathByFullName2(const(wchar)* packageFullName, PackagePathType packagePathType, uint* pathLength, PWSTR path);
WIN32_ERROR GetCurrentPackageInfo2(const(uint) flags, PackagePathType packagePathType, uint* bufferLength, ubyte* buffer, uint* count);
...
WIN32_ERROR GetApplicationUserModelId(HANDLE hProcess, uint* applicationUserModelIdLength, PWSTR applicationUserModelId);
WIN32_ERROR GetApplicationUserModelIdFromToken(HANDLE token, uint* applicationUserModelIdLength, PWSTR applicationUserModelId);
WIN32_ERROR VerifyPackageFullName(const(wchar)* packageFullName);
WIN32_ERROR VerifyPackageFamilyName(const(wchar)* packageFamilyName);
WIN32_ERROR VerifyPackageId(const(PACKAGE_ID)* packageId);
WIN32_ERROR VerifyApplicationUserModelId(const(wchar)* applicationUserModelId);
WIN32_ERROR VerifyPackageRelativeApplicationId(const(wchar)* packageRelativeApplicationId);
WIN32_ERROR PackageIdFromFullName(const(wchar)* packageFullName, const(uint) flags, uint* bufferLength, ubyte* buffer);
WIN32_ERROR PackageFullNameFromId(const(PACKAGE_ID)* packageId, uint* packageFullNameLength, PWSTR packageFullName);
WIN32_ERROR PackageFamilyNameFromId(const(PACKAGE_ID)* packageId, uint* packageFamilyNameLength, PWSTR packageFamilyName);
WIN32_ERROR PackageFamilyNameFromFullName(const(wchar)* packageFullName, uint* packageFamilyNameLength, PWSTR packageFamilyName);
WIN32_ERROR PackageNameAndPublisherIdFromFamilyName(const(wchar)* packageFamilyName, uint* packageNameLength, PWSTR packageName, uint* packagePublisherIdLength, PWSTR packagePublisherId);
WIN32_ERROR FormatApplicationUserModelId(const(wchar)* packageFamilyName, const(wchar)* packageRelativeApplicationId, uint* applicationUserModelIdLength, PWSTR applicationUserModelId);
WIN32_ERROR ParseApplicationUserModelId(const(wchar)* applicationUserModelId, uint* packageFamilyNameLength, PWSTR packageFamilyName, uint* packageRelativeApplicationIdLength, PWSTR packageRelativeApplicationId);
WIN32_ERROR GetPackagesByPackageFamily(const(wchar)* packageFamilyName, uint* count, PWSTR* packageFullNames, uint* bufferLength, PWSTR buffer);
WIN32_ERROR FindPackagesByPackageFamily(const(wchar)* packageFamilyName, uint packageFilters, uint* count, PWSTR* packageFullNames, uint* bufferLength, PWSTR buffer, uint* packageProperties);
WIN32_ERROR GetStagedPackageOrigin(const(wchar)* packageFullName, PackageOrigin* origin);
WIN32_ERROR GetCurrentPackageInfo(const(uint) flags, uint* bufferLength, ubyte* buffer, uint* count);
WIN32_ERROR OpenPackageInfoByFullName(const(wchar)* packageFullName, const(uint) reserved, _PACKAGE_INFO_REFERENCE** packageInfoReference);
WIN32_ERROR OpenPackageInfoByFullNameForUser(PSID userSid, const(wchar)* packageFullName, const(uint) reserved, _PACKAGE_INFO_REFERENCE** packageInfoReference);
WIN32_ERROR ClosePackageInfo(_PACKAGE_INFO_REFERENCE* packageInfoReference);
WIN32_ERROR GetPackageInfo(_PACKAGE_INFO_REFERENCE* packageInfoReference, const(uint) flags, uint* bufferLength, ubyte* buffer, uint* count);
WIN32_ERROR GetPackageApplicationIds(_PACKAGE_INFO_REFERENCE* packageInfoReference, uint* bufferLength, ubyte* buffer, uint* count);
WIN32_ERROR GetPackageInfo2(_PACKAGE_INFO_REFERENCE* packageInfoReference, const(uint) flags, PackagePathType packagePathType, uint* bufferLength, ubyte* buffer, uint* count);
HRESULT CheckIsMSIXPackage(const(wchar)* packageFullName, BOOL* isMSIXPackage);
HRESULT TryCreatePackageDependency(PSID user, const(wchar)* packageFamilyName, PACKAGE_VERSION minVersion, PackageDependencyProcessorArchitectures packageDependencyProcessorArchitectures, PackageDependencyLifetimeKind lifetimeKind, const(wchar)* lifetimeArtifact, CreatePackageDependencyOptions options, PWSTR* packageDependencyId);
HRESULT DeletePackageDependency(const(wchar)* packageDependencyId);
HRESULT AddPackageDependency(const(wchar)* packageDependencyId, int rank, AddPackageDependencyOptions options, PACKAGEDEPENDENCY_CONTEXT* packageDependencyContext, PWSTR* packageFullName);
HRESULT RemovePackageDependency(PACKAGEDEPENDENCY_CONTEXT packageDependencyContext);
HRESULT GetResolvedPackageFullNameForPackageDependency(const(wchar)* packageDependencyId, PWSTR* packageFullName);
...
WIN32_ERROR AppPolicyGetMediaFoundationCodecLoading(HANDLE processToken, AppPolicyMediaFoundationCodecLoading* policy);
...
HRESULT CreatePackageVirtualizationContext(const(wchar)* packageFamilyName, PACKAGE_VIRTUALIZATION_CONTEXT_HANDLE* context);
HRESULT ActivatePackageVirtualizationContext(PACKAGE_VIRTUALIZATION_CONTEXT_HANDLE context, ulong* cookie);
void ReleasePackageVirtualizationContext(PACKAGE_VIRTUALIZATION_CONTEXT_HANDLE context);
void DeactivatePackageVirtualizationContext(ulong cookie);
HRESULT DuplicatePackageVirtualizationContext(PACKAGE_VIRTUALIZATION_CONTEXT_HANDLE sourceContext, PACKAGE_VIRTUALIZATION_CONTEXT_HANDLE* destContext);
PACKAGE_VIRTUALIZATION_CONTEXT_HANDLE GetCurrentPackageVirtualizationContext();
HRESULT GetProcessesInVirtualizationContext(const(wchar)* packageFamilyName, uint* count, HANDLE** processes);
HRESULT GetCurrentPackageInfo3(uint flags, PackageInfo3Type packageInfoType, uint* bufferLength, void* buffer, uint* count);
enum PACKAGE_FULL_NAME_MIN_LENGTH = 0x0000001e;
enum PACKAGE_FULL_NAME_MAX_LENGTH = 0x0000007f;
enum PACKAGE_FAMILY_NAME_MIN_LENGTH = 0x00000011;
enum PACKAGE_FAMILY_NAME_MAX_LENGTH = 0x00000040;
enum PACKAGE_GRAPH_MAX_SIZE = 0x00000281;
enum APPLICATION_USER_MODEL_ID_MIN_LENGTH = 0x00000014;
enum APPLICATION_USER_MODEL_ID_MAX_LENGTH = 0x00000082;
...
enum PACKAGE_ARCHITECTURE_MIN_LENGTH = 0x00000003;
enum PACKAGE_ARCHITECTURE_MAX_LENGTH = 0x00000007;
enum PACKAGE_VERSION_MIN_LENGTH = 0x00000007;
enum PACKAGE_VERSION_MAX_LENGTH = 0x00000017;
enum PACKAGE_NAME_MIN_LENGTH = 0x00000003;
enum PACKAGE_NAME_MAX_LENGTH = 0x00000032;
enum PACKAGE_PUBLISHER_MIN_LENGTH = 0x00000003;
enum PACKAGE_PUBLISHER_MAX_LENGTH = 0x00002000;
enum PACKAGE_PUBLISHERID_MIN_LENGTH = 0x0000000d;
enum PACKAGE_PUBLISHERID_MAX_LENGTH = 0x0000000d;
enum PACKAGE_RESOURCEID_MIN_LENGTH = 0x00000000;
enum PACKAGE_RESOURCEID_MAX_LENGTH = 0x0000001e;
enum PACKAGE_MIN_DEPENDENCIES = 0x00000000;
enum PACKAGE_MAX_DEPENDENCIES = 0x00000080;
enum PACKAGE_FAMILY_MIN_RESOURCE_PACKAGES = 0x00000000;
enum PACKAGE_FAMILY_MAX_RESOURCE_PACKAGES = 0x00000200;
enum PACKAGE_GRAPH_MIN_SIZE = 0x00000001;
enum PACKAGE_APPLICATIONS_MIN_COUNT = 0x00000000;
enum PACKAGE_APPLICATIONS_MAX_COUNT = 0x00000064;
enum PACKAGE_RELATIVE_APPLICATION_ID_MIN_LENGTH = 0x00000002;
enum PACKAGE_RELATIVE_APPLICATION_ID_MAX_LENGTH = 0x00000041;
alias PACKAGE_VIRTUALIZATION_CONTEXT_HANDLE = void*;
alias PACKAGEDEPENDENCY_CONTEXT = void*;
struct PACKAGE_ID
{
    align (4):
    uint reserved;
...
{
    HRESULT CreatePackageReader2(IStream inputStream, const(wchar)* expectedDigest, IAppxPackageReader* packageReader);
    HRESULT CreateManifestReader2(IStream inputStream, const(wchar)* expectedDigest, IAppxManifestReader* manifestReader);
    HRESULT CreateAppInstallerReader(IStream inputStream, const(wchar)* expectedDigest, IAppxAppInstallerReader* appInstallerReader);
}
...
interface IAppxManifestPackageId : IUnknown
{
    ...
    HRESULT ComparePublisher(const(wchar)* other, BOOL* isSame);
...
{
    HRESULT GetBoolValue(const(wchar)* name, BOOL* value);
    HRESULT GetStringValue(const(wchar)* name, PWSTR* value);
}
...
{
    HRESULT CreateBundleReader2(IStream inputStream, const(wchar)* expectedDigest, IAppxBundleReader* bundleReader);
}
...
{
    HRESULT CreateEncryptedPackageReader2(IStream inputStream, const(APPX_KEY_INFO)* keyInfo, const(wchar)* expectedDigest, IAppxPackageReader* packageReader);
    HRESULT CreateEncryptedBundleReader2(IStream inputStream, const(APPX_KEY_INFO)* keyInfo, const(wchar)* expectedDigest, IAppxBundleReader* bundleReader);
}
...
{
    HRESULT AddPayloadFilesEncrypted(uint fileCount, APPX_PACKAGE_WRITER_PAYLOAD_STREAM* payloadFiles, ulong memoryLimit);
}
