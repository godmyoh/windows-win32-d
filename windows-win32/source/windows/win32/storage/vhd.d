...
WIN32_ERROR OpenVirtualDisk(VIRTUAL_STORAGE_TYPE* VirtualStorageType, const(wchar)* Path, VIRTUAL_DISK_ACCESS_MASK VirtualDiskAccessMask, OPEN_VIRTUAL_DISK_FLAG Flags, OPEN_VIRTUAL_DISK_PARAMETERS* Parameters, HANDLE* Handle);
WIN32_ERROR CreateVirtualDisk(VIRTUAL_STORAGE_TYPE* VirtualStorageType, const(wchar)* Path, VIRTUAL_DISK_ACCESS_MASK VirtualDiskAccessMask, PSECURITY_DESCRIPTOR SecurityDescriptor, CREATE_VIRTUAL_DISK_FLAG Flags, uint ProviderSpecificFlags, CREATE_VIRTUAL_DISK_PARAMETERS* Parameters, OVERLAPPED* Overlapped, HANDLE* Handle);
WIN32_ERROR AttachVirtualDisk(HANDLE VirtualDiskHandle, PSECURITY_DESCRIPTOR SecurityDescriptor, ATTACH_VIRTUAL_DISK_FLAG Flags, uint ProviderSpecificFlags, ATTACH_VIRTUAL_DISK_PARAMETERS* Parameters, OVERLAPPED* Overlapped);
WIN32_ERROR DetachVirtualDisk(HANDLE VirtualDiskHandle, DETACH_VIRTUAL_DISK_FLAG Flags, uint ProviderSpecificFlags);
WIN32_ERROR GetVirtualDiskPhysicalPath(HANDLE VirtualDiskHandle, uint* DiskPathSizeInBytes, PWSTR DiskPath);
WIN32_ERROR GetAllAttachedVirtualDiskPhysicalPaths(uint* PathsBufferSizeInBytes, PWSTR PathsBuffer);
WIN32_ERROR GetStorageDependencyInformation(HANDLE ObjectHandle, GET_STORAGE_DEPENDENCY_FLAG Flags, uint StorageDependencyInfoSize, STORAGE_DEPENDENCY_INFO* StorageDependencyInfo, uint* SizeUsed);
WIN32_ERROR GetVirtualDiskInformation(HANDLE VirtualDiskHandle, uint* VirtualDiskInfoSize, GET_VIRTUAL_DISK_INFO* VirtualDiskInfo, uint* SizeUsed);
WIN32_ERROR SetVirtualDiskInformation(HANDLE VirtualDiskHandle, SET_VIRTUAL_DISK_INFO* VirtualDiskInfo);
WIN32_ERROR EnumerateVirtualDiskMetadata(HANDLE VirtualDiskHandle, uint* NumberOfItems, GUID* Items);
WIN32_ERROR GetVirtualDiskMetadata(HANDLE VirtualDiskHandle, const(GUID)* Item, uint* MetaDataSize, void* MetaData);
WIN32_ERROR SetVirtualDiskMetadata(HANDLE VirtualDiskHandle, const(GUID)* Item, uint MetaDataSize, const(void)* MetaData);
WIN32_ERROR DeleteVirtualDiskMetadata(HANDLE VirtualDiskHandle, const(GUID)* Item);
WIN32_ERROR GetVirtualDiskOperationProgress(HANDLE VirtualDiskHandle, OVERLAPPED* Overlapped, VIRTUAL_DISK_PROGRESS* Progress);
WIN32_ERROR CompactVirtualDisk(HANDLE VirtualDiskHandle, COMPACT_VIRTUAL_DISK_FLAG Flags, COMPACT_VIRTUAL_DISK_PARAMETERS* Parameters, OVERLAPPED* Overlapped);
WIN32_ERROR MergeVirtualDisk(HANDLE VirtualDiskHandle, MERGE_VIRTUAL_DISK_FLAG Flags, MERGE_VIRTUAL_DISK_PARAMETERS* Parameters, OVERLAPPED* Overlapped);
WIN32_ERROR ExpandVirtualDisk(HANDLE VirtualDiskHandle, EXPAND_VIRTUAL_DISK_FLAG Flags, EXPAND_VIRTUAL_DISK_PARAMETERS* Parameters, OVERLAPPED* Overlapped);
WIN32_ERROR ResizeVirtualDisk(HANDLE VirtualDiskHandle, RESIZE_VIRTUAL_DISK_FLAG Flags, RESIZE_VIRTUAL_DISK_PARAMETERS* Parameters, OVERLAPPED* Overlapped);
WIN32_ERROR MirrorVirtualDisk(HANDLE VirtualDiskHandle, MIRROR_VIRTUAL_DISK_FLAG Flags, MIRROR_VIRTUAL_DISK_PARAMETERS* Parameters, OVERLAPPED* Overlapped);
WIN32_ERROR BreakMirrorVirtualDisk(HANDLE VirtualDiskHandle);
WIN32_ERROR AddVirtualDiskParent(HANDLE VirtualDiskHandle, const(wchar)* ParentPath);
WIN32_ERROR QueryChangesVirtualDisk(HANDLE VirtualDiskHandle, const(wchar)* ChangeTrackingId, ulong ByteOffset, ulong ByteLength, QUERY_CHANGES_VIRTUAL_DISK_FLAG Flags, QUERY_CHANGES_VIRTUAL_DISK_RANGE* Ranges, uint* RangeCount, ulong* ProcessedLength);
WIN32_ERROR TakeSnapshotVhdSet(HANDLE VirtualDiskHandle, const(TAKE_SNAPSHOT_VHDSET_PARAMETERS)* Parameters, TAKE_SNAPSHOT_VHDSET_FLAG Flags);
WIN32_ERROR DeleteSnapshotVhdSet(HANDLE VirtualDiskHandle, const(DELETE_SNAPSHOT_VHDSET_PARAMETERS)* Parameters, DELETE_SNAPSHOT_VHDSET_FLAG Flags);
WIN32_ERROR ModifyVhdSet(HANDLE VirtualDiskHandle, const(MODIFY_VHDSET_PARAMETERS)* Parameters, MODIFY_VHDSET_FLAG Flags);
WIN32_ERROR ApplySnapshotVhdSet(HANDLE VirtualDiskHandle, const(APPLY_SNAPSHOT_VHDSET_PARAMETERS)* Parameters, APPLY_SNAPSHOT_VHDSET_FLAG Flags);
WIN32_ERROR RawSCSIVirtualDisk(HANDLE VirtualDiskHandle, const(RAW_SCSI_VIRTUAL_DISK_PARAMETERS)* Parameters, RAW_SCSI_VIRTUAL_DISK_FLAG Flags, RAW_SCSI_VIRTUAL_DISK_RESPONSE* Response);
WIN32_ERROR ForkVirtualDisk(HANDLE VirtualDiskHandle, FORK_VIRTUAL_DISK_FLAG Flags, const(FORK_VIRTUAL_DISK_PARAMETERS)* Parameters, OVERLAPPED* Overlapped);
WIN32_ERROR CompleteForkVirtualDisk(HANDLE VirtualDiskHandle);
