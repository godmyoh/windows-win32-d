...
alias _tag_FW_DYNAMIC_KEYWORD_ORIGIN_TYPE = int;
enum : int
{
...
{
    _tag_FW_DYNAMIC_KEYWORD_ADDRESS0 dynamicKeywordAddress;
    _tag_FW_DYNAMIC_KEYWORD_ADDRESS_DATA0* next;
    ushort schemaVersion;
    _tag_FW_DYNAMIC_KEYWORD_ORIGIN_TYPE originType;
}
alias _tag_FW_DYNAMIC_KEYWORD_ADDRESS_FLAGS = int;
enum : int
{
    FW_DYNAMIC_KEYWORD_ADDRESS_FLAGS_AUTO_RESOLVE = 0x00000001,
}

alias _tag_FW_DYNAMIC_KEYWORD_ADDRESS_ENUM_FLAGS = int;
enum : int
{
...
alias PFN_FWADDDYNAMICKEYWORDADDRESS0 = uint function(const(_tag_FW_DYNAMIC_KEYWORD_ADDRESS0)*);
alias PFN_FWDELETEDYNAMICKEYWORDADDRESS0 = uint function(GUID);
alias PFN_FWENUMDYNAMICKEYWORDADDRESSESBYTYPE0 = uint function(uint, _tag_FW_DYNAMIC_KEYWORD_ADDRESS_DATA0**);
alias PFN_FWENUMDYNAMICKEYWORDADDRESSBYID0 = uint function(GUID, _tag_FW_DYNAMIC_KEYWORD_ADDRESS_DATA0**);
alias PFN_FWFREEDYNAMICKEYWORDADDRESSDATA0 = uint function(_tag_FW_DYNAMIC_KEYWORD_ADDRESS_DATA0*);
