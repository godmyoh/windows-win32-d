...
enum WCN_E_PEER_NOT_FOUND = 0xffffffff80043c01;
enum WCN_E_AUTHENTICATION_FAILED = 0xffffffff80043c02;
enum WCN_E_CONNECTION_REJECTED = 0xffffffff80043c03;
enum WCN_E_SESSION_TIMEDOUT = 0xffffffff80043c04;
enum WCN_E_PROTOCOL_ERROR = 0xffffffff80043c05;
enum WCN_QUERY_CONSTRAINT_USE_SOFTAP = "WCN.Discovery.SoftAP";
enum WCN_VALUE_DT_CATEGORY_COMPUTER = 0x00000001;
enum WCN_VALUE_DT_CATEGORY_INPUT_DEVICE = 0x00000002;
enum WCN_VALUE_DT_CATEGORY_PRINTER = 0x00000003;
enum WCN_VALUE_DT_CATEGORY_CAMERA = 0x00000004;
enum WCN_VALUE_DT_CATEGORY_STORAGE = 0x00000005;
enum WCN_VALUE_DT_CATEGORY_NETWORK_INFRASTRUCTURE = 0x00000006;
enum WCN_VALUE_DT_CATEGORY_DISPLAY = 0x00000007;
enum WCN_VALUE_DT_CATEGORY_MULTIMEDIA_DEVICE = 0x00000008;
enum WCN_VALUE_DT_CATEGORY_GAMING_DEVICE = 0x00000009;
enum WCN_VALUE_DT_CATEGORY_TELEPHONE = 0x0000000a;
enum WCN_VALUE_DT_CATEGORY_AUDIO_DEVICE = 0x0000000b;
enum WCN_VALUE_DT_CATEGORY_OTHER = 0x000000ff;
enum WCN_VALUE_DT_SUBTYPE_WIFI_OUI = 0x0050f204;
enum WCN_VALUE_DT_SUBTYPE_COMPUTER__PC = 0x00000001;
enum WCN_VALUE_DT_SUBTYPE_COMPUTER__SERVER = 0x00000002;
enum WCN_VALUE_DT_SUBTYPE_COMPUTER__MEDIACENTER = 0x00000003;
enum WCN_VALUE_DT_SUBTYPE_COMPUTER__ULTRAMOBILEPC = 0x00000004;
enum WCN_VALUE_DT_SUBTYPE_COMPUTER__NOTEBOOK = 0x00000005;
enum WCN_VALUE_DT_SUBTYPE_COMPUTER__DESKTOP = 0x00000006;
enum WCN_VALUE_DT_SUBTYPE_COMPUTER__MID = 0x00000007;
enum WCN_VALUE_DT_SUBTYPE_COMPUTER__NETBOOK = 0x00000008;
enum WCN_VALUE_DT_SUBTYPE_INPUT_DEVICE__KEYBOARD = 0x00000001;
enum WCN_VALUE_DT_SUBTYPE_INPUT_DEVICE__MOUSE = 0x00000002;
enum WCN_VALUE_DT_SUBTYPE_INPUT_DEVICE__JOYSTICK = 0x00000003;
enum WCN_VALUE_DT_SUBTYPE_INPUT_DEVICE__TRACKBALL = 0x00000004;
enum WCN_VALUE_DT_SUBTYPE_INPUT_DEVICE__GAMECONTROLLER = 0x00000005;
enum WCN_VALUE_DT_SUBTYPE_INPUT_DEVICE__REMOTE = 0x00000006;
enum WCN_VALUE_DT_SUBTYPE_INPUT_DEVICE__TOUCHSCREEN = 0x00000007;
enum WCN_VALUE_DT_SUBTYPE_INPUT_DEVICE__BIOMETRICREADER = 0x00000008;
enum WCN_VALUE_DT_SUBTYPE_INPUT_DEVICE__BARCODEREADER = 0x00000009;
enum WCN_VALUE_DT_SUBTYPE_PRINTER__PRINTER = 0x00000001;
enum WCN_VALUE_DT_SUBTYPE_PRINTER__SCANNER = 0x00000002;
enum WCN_VALUE_DT_SUBTYPE_PRINTER__FAX = 0x00000003;
enum WCN_VALUE_DT_SUBTYPE_PRINTER__COPIER = 0x00000004;
enum WCN_VALUE_DT_SUBTYPE_PRINTER__ALLINONE = 0x00000005;
enum WCN_VALUE_DT_SUBTYPE_CAMERA__STILL_CAMERA = 0x00000001;
enum WCN_VALUE_DT_SUBTYPE_CAMERA__VIDEO_CAMERA = 0x00000002;
enum WCN_VALUE_DT_SUBTYPE_CAMERA__WEB_CAMERA = 0x00000003;
enum WCN_VALUE_DT_SUBTYPE_CAMERA__SECURITY_CAMERA = 0x00000004;
enum WCN_VALUE_DT_SUBTYPE_STORAGE__NAS = 0x00000001;
enum WCN_VALUE_DT_SUBTYPE_NETWORK_INFRASTRUCUTURE__AP = 0x00000001;
enum WCN_VALUE_DT_SUBTYPE_NETWORK_INFRASTRUCUTURE__ROUTER = 0x00000002;
enum WCN_VALUE_DT_SUBTYPE_NETWORK_INFRASTRUCUTURE__SWITCH = 0x00000003;
enum WCN_VALUE_DT_SUBTYPE_NETWORK_INFRASTRUCUTURE__GATEWAY = 0x00000004;
enum WCN_VALUE_DT_SUBTYPE_NETWORK_INFRASTRUCUTURE__BRIDGE = 0x00000005;
enum WCN_VALUE_DT_SUBTYPE_DISPLAY__TELEVISION = 0x00000001;
enum WCN_VALUE_DT_SUBTYPE_DISPLAY__PICTURE_FRAME = 0x00000002;
enum WCN_VALUE_DT_SUBTYPE_DISPLAY__PROJECTOR = 0x00000003;
enum WCN_VALUE_DT_SUBTYPE_DISPLAY__MONITOR = 0x00000004;
enum WCN_VALUE_DT_SUBTYPE_MULTIMEDIA_DEVICE__DAR = 0x00000001;
enum WCN_VALUE_DT_SUBTYPE_MULTIMEDIA_DEVICE__PVR = 0x00000002;
enum WCN_VALUE_DT_SUBTYPE_MULTIMEDIA_DEVICE__MCX = 0x00000003;
enum WCN_VALUE_DT_SUBTYPE_MULTIMEDIA_DEVICE__SETTOPBOX = 0x00000004;
enum WCN_VALUE_DT_SUBTYPE_MULTIMEDIA_DEVICE__MEDIA_SERVER_ADAPT_EXT = 0x00000005;
enum WCN_VALUE_DT_SUBTYPE_MULTIMEDIA_DEVICE__PVP = 0x00000006;
enum WCN_VALUE_DT_SUBTYPE_GAMING_DEVICE__XBOX = 0x00000001;
enum WCN_VALUE_DT_SUBTYPE_GAMING_DEVICE__XBOX360 = 0x00000002;
enum WCN_VALUE_DT_SUBTYPE_GAMING_DEVICE__PLAYSTATION = 0x00000003;
enum WCN_VALUE_DT_SUBTYPE_GAMING_DEVICE__CONSOLE_ADAPT = 0x00000004;
enum WCN_VALUE_DT_SUBTYPE_GAMING_DEVICE__PORTABLE = 0x00000005;
enum WCN_VALUE_DT_SUBTYPE_TELEPHONE__WINDOWS_MOBILE = 0x00000001;
enum WCN_VALUE_DT_SUBTYPE_TELEPHONE__PHONE_SINGLEMODE = 0x00000002;
enum WCN_VALUE_DT_SUBTYPE_TELEPHONE__PHONE_DUALMODE = 0x00000003;
enum WCN_VALUE_DT_SUBTYPE_TELEPHONE__SMARTPHONE_SINGLEMODE = 0x00000004;
enum WCN_VALUE_DT_SUBTYPE_TELEPHONE__SMARTPHONE_DUALMODE = 0x00000005;
enum WCN_VALUE_DT_SUBTYPE_AUDIO_DEVICE__TUNER_RECEIVER = 0x00000001;
enum WCN_VALUE_DT_SUBTYPE_AUDIO_DEVICE__SPEAKERS = 0x00000002;
enum WCN_VALUE_DT_SUBTYPE_AUDIO_DEVICE__PMP = 0x00000003;
enum WCN_VALUE_DT_SUBTYPE_AUDIO_DEVICE__HEADSET = 0x00000004;
enum WCN_VALUE_DT_SUBTYPE_AUDIO_DEVICE__HEADPHONES = 0x00000005;
enum WCN_VALUE_DT_SUBTYPE_AUDIO_DEVICE__MICROPHONE = 0x00000006;
enum WCN_VALUE_DT_SUBTYPE_AUDIO_DEVICE__HOMETHEATER = 0x00000007;
enum WCN_API_MAX_BUFFER_SIZE = 0x00000830;
enum WCN_MICROSOFT_VENDOR_ID = 0x00000137;
enum WCN_NO_SUBTYPE = 0xfffffffe;
enum WCN_FLAG_DISCOVERY_VE = 0x00000001;
