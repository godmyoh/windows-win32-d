...
WIN32_ERROR WNetAddConnectionA(const(char)*, const(char)*, const(char)*);
WIN32_ERROR WNetAddConnectionW(const(wchar)*, const(wchar)*, const(wchar)*);
WIN32_ERROR WNetAddConnection2A(NETRESOURCEA*, const(char)*, const(char)*, uint);
WIN32_ERROR WNetAddConnection2W(NETRESOURCEW*, const(wchar)*, const(wchar)*, uint);
WIN32_ERROR WNetAddConnection3A(HWND, NETRESOURCEA*, const(char)*, const(char)*, uint);
WIN32_ERROR WNetAddConnection3W(HWND, NETRESOURCEW*, const(wchar)*, const(wchar)*, uint);
WIN32_ERROR WNetAddConnection4A(HWND, NETRESOURCEA*, void*, uint, uint, ubyte*, uint);
WIN32_ERROR WNetAddConnection4W(HWND, NETRESOURCEW*, void*, uint, uint, ubyte*, uint);
WIN32_ERROR WNetCancelConnectionA(const(char)*, BOOL);
WIN32_ERROR WNetCancelConnectionW(const(wchar)*, BOOL);
WIN32_ERROR WNetCancelConnection2A(const(char)*, uint, BOOL);
WIN32_ERROR WNetCancelConnection2W(const(wchar)*, uint, BOOL);
WIN32_ERROR WNetGetConnectionA(const(char)*, PSTR, uint*);
WIN32_ERROR WNetGetConnectionW(const(wchar)*, PWSTR, uint*);
WIN32_ERROR WNetUseConnectionA(HWND, NETRESOURCEA*, const(char)*, const(char)*, NET_USE_CONNECT_FLAGS, PSTR, uint*, uint*);
WIN32_ERROR WNetUseConnectionW(HWND, NETRESOURCEW*, const(wchar)*, const(wchar)*, NET_USE_CONNECT_FLAGS, PWSTR, uint*, uint*);
WIN32_ERROR WNetUseConnection4A(HWND, NETRESOURCEA*, void*, uint, uint, ubyte*, uint, PSTR, uint*, uint*);
WIN32_ERROR WNetUseConnection4W(HWND, NETRESOURCEW*, void*, uint, uint, ubyte*, uint, PWSTR, uint*, uint*);
WIN32_ERROR WNetConnectionDialog(HWND, uint);
WIN32_ERROR WNetDisconnectDialog(HWND, uint);
WIN32_ERROR WNetConnectionDialog1A(CONNECTDLGSTRUCTA*);
WIN32_ERROR WNetConnectionDialog1W(CONNECTDLGSTRUCTW*);
WIN32_ERROR WNetDisconnectDialog1A(DISCDLGSTRUCTA*);
WIN32_ERROR WNetDisconnectDialog1W(DISCDLGSTRUCTW*);
WIN32_ERROR WNetOpenEnumA(NET_RESOURCE_SCOPE, NET_RESOURCE_TYPE, WNET_OPEN_ENUM_USAGE, NETRESOURCEA*, HANDLE*);
WIN32_ERROR WNetOpenEnumW(NET_RESOURCE_SCOPE, NET_RESOURCE_TYPE, WNET_OPEN_ENUM_USAGE, NETRESOURCEW*, HANDLE*);
WIN32_ERROR WNetEnumResourceA(HANDLE, uint*, void*, uint*);
WIN32_ERROR WNetEnumResourceW(HANDLE, uint*, void*, uint*);
WIN32_ERROR WNetCloseEnum(HANDLE);
WIN32_ERROR WNetGetResourceParentA(NETRESOURCEA*, void*, uint*);
WIN32_ERROR WNetGetResourceParentW(NETRESOURCEW*, void*, uint*);
WIN32_ERROR WNetGetResourceInformationA(NETRESOURCEA*, void*, uint*, PSTR*);
WIN32_ERROR WNetGetResourceInformationW(NETRESOURCEW*, void*, uint*, PWSTR*);
WIN32_ERROR WNetGetUniversalNameA(const(char)*, UNC_INFO_LEVEL, void*, uint*);
WIN32_ERROR WNetGetUniversalNameW(const(wchar)*, UNC_INFO_LEVEL, void*, uint*);
WIN32_ERROR WNetGetUserA(const(char)*, PSTR, uint*);
WIN32_ERROR WNetGetUserW(const(wchar)*, PWSTR, uint*);
WIN32_ERROR WNetGetProviderNameA(uint, PSTR, uint*);
WIN32_ERROR WNetGetProviderNameW(uint, PWSTR, uint*);
WIN32_ERROR WNetGetNetworkInformationA(const(char)*, NETINFOSTRUCT*);
WIN32_ERROR WNetGetNetworkInformationW(const(wchar)*, NETINFOSTRUCT*);
WIN32_ERROR WNetGetLastErrorA(uint*, PSTR, uint, PSTR, uint);
WIN32_ERROR WNetGetLastErrorW(uint*, PWSTR, uint, PWSTR, uint);
