...
uint RasGetEntryDialParamsA(const(char)*, RASDIALPARAMSA*, int*);
uint RasGetEntryDialParamsW(const(wchar)*, RASDIALPARAMSW*, int*);
...
uint RasGetAutodialEnableA(uint, int*);
uint RasGetAutodialEnableW(uint, int*);
