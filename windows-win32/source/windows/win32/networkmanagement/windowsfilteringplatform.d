...
import windows.win32.foundation : BOOL, FILETIME, HANDLE, PSTR, PWSTR;
import windows.win32.security : ACL, PSECURITY_DESCRIPTOR, PSID, SID, SID_AND_ATTRIBUTES;
...
uint FwpmEngineOpen0(const(wchar)* serverName, uint authnService, SEC_WINNT_AUTH_IDENTITY_W* authIdentity, const(FWPM_SESSION0)* session, HANDLE* engineHandle);
...
uint FwpmEngineGetSecurityInfo0(HANDLE engineHandle, uint securityInfo, PSID* sidOwner, PSID* sidGroup, ACL** dacl, ACL** sacl, PSECURITY_DESCRIPTOR* securityDescriptor);
...
uint FwpmProviderAdd0(HANDLE engineHandle, const(FWPM_PROVIDER0)* provider, PSECURITY_DESCRIPTOR sd);
...
uint FwpmProviderGetSecurityInfoByKey0(HANDLE engineHandle, const(GUID)* key, uint securityInfo, PSID* sidOwner, PSID* sidGroup, ACL** dacl, ACL** sacl, PSECURITY_DESCRIPTOR* securityDescriptor);
...
uint FwpmProviderContextAdd0(HANDLE engineHandle, const(FWPM_PROVIDER_CONTEXT0)* providerContext, PSECURITY_DESCRIPTOR sd, ulong* id);
uint FwpmProviderContextAdd1(HANDLE engineHandle, const(FWPM_PROVIDER_CONTEXT1)* providerContext, PSECURITY_DESCRIPTOR sd, ulong* id);
uint FwpmProviderContextAdd2(HANDLE engineHandle, const(FWPM_PROVIDER_CONTEXT2)* providerContext, PSECURITY_DESCRIPTOR sd, ulong* id);
uint FwpmProviderContextAdd3(HANDLE engineHandle, const(FWPM_PROVIDER_CONTEXT3)* providerContext, PSECURITY_DESCRIPTOR sd, ulong* id);
...
uint FwpmProviderContextGetById3(HANDLE engineHandle, ulong id, FWPM_PROVIDER_CONTEXT3** providerContext);
...
uint FwpmProviderContextGetByKey3(HANDLE engineHandle, const(GUID)* key, FWPM_PROVIDER_CONTEXT3** providerContext);
...
uint FwpmProviderContextEnum3(HANDLE engineHandle, HANDLE enumHandle, uint numEntriesRequested, FWPM_PROVIDER_CONTEXT3*** entries, uint* numEntriesReturned);
uint FwpmProviderContextDestroyEnumHandle0(HANDLE engineHandle, HANDLE enumHandle);
uint FwpmProviderContextGetSecurityInfoByKey0(HANDLE engineHandle, const(GUID)* key, uint securityInfo, PSID* sidOwner, PSID* sidGroup, ACL** dacl, ACL** sacl, PSECURITY_DESCRIPTOR* securityDescriptor);
...
uint FwpmSubLayerAdd0(HANDLE engineHandle, const(FWPM_SUBLAYER0)* subLayer, PSECURITY_DESCRIPTOR sd);
...
uint FwpmSubLayerGetSecurityInfoByKey0(HANDLE engineHandle, const(GUID)* key, uint securityInfo, PSID* sidOwner, PSID* sidGroup, ACL** dacl, ACL** sacl, PSECURITY_DESCRIPTOR* securityDescriptor);
...
uint FwpmLayerGetSecurityInfoByKey0(HANDLE engineHandle, const(GUID)* key, uint securityInfo, PSID* sidOwner, PSID* sidGroup, ACL** dacl, ACL** sacl, PSECURITY_DESCRIPTOR* securityDescriptor);
...
uint FwpmCalloutAdd0(HANDLE engineHandle, const(FWPM_CALLOUT0)* callout, PSECURITY_DESCRIPTOR sd, uint* id);
...
uint FwpmCalloutGetSecurityInfoByKey0(HANDLE engineHandle, const(GUID)* key, uint securityInfo, PSID* sidOwner, PSID* sidGroup, ACL** dacl, ACL** sacl, PSECURITY_DESCRIPTOR* securityDescriptor);
...
uint FwpmFilterAdd0(HANDLE engineHandle, const(FWPM_FILTER0)* filter, PSECURITY_DESCRIPTOR sd, ulong* id);
...
uint FwpmFilterGetSecurityInfoByKey0(HANDLE engineHandle, const(GUID)* key, uint securityInfo, PSID* sidOwner, PSID* sidGroup, ACL** dacl, ACL** sacl, PSECURITY_DESCRIPTOR* securityDescriptor);
...
uint FwpmIPsecTunnelAdd0(HANDLE engineHandle, uint flags, const(FWPM_PROVIDER_CONTEXT0)* mainModePolicy, const(FWPM_PROVIDER_CONTEXT0)* tunnelPolicy, uint numFilterConditions, const(FWPM_FILTER_CONDITION0)* filterConditions, PSECURITY_DESCRIPTOR sd);
uint FwpmIPsecTunnelAdd1(HANDLE engineHandle, uint flags, const(FWPM_PROVIDER_CONTEXT1)* mainModePolicy, const(FWPM_PROVIDER_CONTEXT1)* tunnelPolicy, uint numFilterConditions, const(FWPM_FILTER_CONDITION0)* filterConditions, const(GUID)* keyModKey, PSECURITY_DESCRIPTOR sd);
uint FwpmIPsecTunnelAdd2(HANDLE engineHandle, uint flags, const(FWPM_PROVIDER_CONTEXT2)* mainModePolicy, const(FWPM_PROVIDER_CONTEXT2)* tunnelPolicy, uint numFilterConditions, const(FWPM_FILTER_CONDITION0)* filterConditions, const(GUID)* keyModKey, PSECURITY_DESCRIPTOR sd);
uint FwpmIPsecTunnelAdd3(HANDLE engineHandle, uint flags, const(FWPM_PROVIDER_CONTEXT3)* mainModePolicy, const(FWPM_PROVIDER_CONTEXT3)* tunnelPolicy, uint numFilterConditions, const(FWPM_FILTER_CONDITION0)* filterConditions, const(GUID)* keyModKey, PSECURITY_DESCRIPTOR sd);
...
uint IPsecSaDbGetSecurityInfo0(HANDLE engineHandle, uint securityInfo, PSID* sidOwner, PSID* sidGroup, ACL** dacl, ACL** sacl, PSECURITY_DESCRIPTOR* securityDescriptor);
...
uint IPsecDospGetSecurityInfo0(HANDLE engineHandle, uint securityInfo, PSID* sidOwner, PSID* sidGroup, ACL** dacl, ACL** sacl, PSECURITY_DESCRIPTOR* securityDescriptor);
...
uint IPsecKeyManagerGetSecurityInfoByKey0(HANDLE engineHandle, const(void)* reserved, uint securityInfo, PSID* sidOwner, PSID* sidGroup, ACL** dacl, ACL** sacl, PSECURITY_DESCRIPTOR* securityDescriptor);
...
uint IkeextSaDbGetSecurityInfo0(HANDLE engineHandle, uint securityInfo, PSID* sidOwner, PSID* sidGroup, ACL** dacl, ACL** sacl, PSECURITY_DESCRIPTOR* securityDescriptor);
...
uint FwpmNetEventEnum4(HANDLE engineHandle, HANDLE enumHandle, uint numEntriesRequested, FWPM_NET_EVENT4*** entries, uint* numEntriesReturned);
uint FwpmNetEventEnum5(HANDLE engineHandle, HANDLE enumHandle, uint numEntriesRequested, FWPM_NET_EVENT5*** entries, uint* numEntriesReturned);
uint FwpmNetEventDestroyEnumHandle0(HANDLE engineHandle, HANDLE enumHandle);
uint FwpmNetEventsGetSecurityInfo0(HANDLE engineHandle, uint securityInfo, PSID* sidOwner, PSID* sidGroup, ACL** dacl, ACL** sacl, PSECURITY_DESCRIPTOR* securityDescriptor);
...
uint FwpmDynamicKeywordSubscribe0(uint flags, FWPM_DYNAMIC_KEYWORD_CALLBACK0 callback, void* context, HANDLE* subscriptionHandle);
...
uint FwpmConnectionGetSecurityInfo0(HANDLE engineHandle, uint securityInfo, PSID* sidOwner, PSID* sidGroup, ACL** dacl, ACL** sacl, PSECURITY_DESCRIPTOR* securityDescriptor);
...
uint FwpmvSwitchEventsGetSecurityInfo0(HANDLE engineHandle, uint securityInfo, PSID* sidOwner, PSID* sidGroup, ACL** dacl, ACL** sacl, PSECURITY_DESCRIPTOR* securityDescriptor);
...
alias FWPM_PROVIDER_CONTEXT_CHANGE_CALLBACK0 = void function(void* context, const(FWPM_PROVIDER_CONTEXT_CHANGE0)* change);
...
alias IPSEC_KEY_MANAGER_KEY_DICTATION_CHECK0 = void function(const(IKEEXT_TRAFFIC0)* ikeTraffic, BOOL* willDictateKey, uint* weight);
alias IPSEC_KEY_MANAGER_DICTATE_KEY0 = uint function(IPSEC_SA_DETAILS1* inboundSaDetails, IPSEC_SA_DETAILS1* outboundSaDetails, BOOL* keyingModuleGenKey);
alias IPSEC_KEY_MANAGER_NOTIFY_KEY0 = void function(const(IPSEC_SA_DETAILS1)* inboundSa, const(IPSEC_SA_DETAILS1)* outboundSa);
...
alias FWPM_CONNECTION_CALLBACK0 = void function(void* context, FWPM_CONNECTION_EVENT_TYPE eventType, const(FWPM_CONNECTION0)* connection);
