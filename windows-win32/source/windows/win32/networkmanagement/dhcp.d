...
uint Dhcpv6RequestParams(BOOL forceNewInform, void* reserved, PWSTR adapterName, DHCPV6CAPI_CLASSID* classId, DHCPV6CAPI_PARAMS_ARRAY recdParams, ubyte* buffer, uint* pSize);
uint Dhcpv6RequestPrefix(PWSTR adapterName, DHCPV6CAPI_CLASSID* pclassId, DHCPV6PrefixLeaseInformation* prefixleaseInfo, uint* pdwTimeToWait);
uint Dhcpv6RenewPrefix(PWSTR adapterName, DHCPV6CAPI_CLASSID* pclassId, DHCPV6PrefixLeaseInformation* prefixleaseInfo, uint* pdwTimeToWait, uint bValidatePrefix);
...
uint DhcpRequestParams(uint Flags, void* Reserved, PWSTR AdapterName, DHCPCAPI_CLASSID* ClassId, DHCPCAPI_PARAMS_ARRAY SendParams, DHCPCAPI_PARAMS_ARRAY RecdParams, ubyte* Buffer, uint* pSize, PWSTR RequestIdStr);
uint DhcpUndoRequestParams(uint Flags, void* Reserved, PWSTR AdapterName, PWSTR RequestIdStr);
uint DhcpRegisterParamChange(uint Flags, void* Reserved, PWSTR AdapterName, DHCPCAPI_CLASSID* ClassId, DHCPCAPI_PARAMS_ARRAY Params, void* Handle);
...
uint DhcpSetSuperScopeV4(const(wchar)* ServerIpAddress, const(uint) SubnetAddress, const(wchar)* SuperScopeName, const(BOOL) ChangeExisting);
uint DhcpDeleteSuperScopeV4(const(wchar)* ServerIpAddress, const(wchar)* SuperScopeName);
...
uint DhcpCreateOptionV5(PWSTR ServerIpAddress, uint Flags, uint OptionId, PWSTR ClassName, PWSTR VendorName, DHCP_OPTION* OptionInfo);
uint DhcpSetOptionInfoV5(PWSTR ServerIpAddress, uint Flags, uint OptionID, PWSTR ClassName, PWSTR VendorName, DHCP_OPTION* OptionInfo);
uint DhcpGetOptionInfoV5(PWSTR ServerIpAddress, uint Flags, uint OptionID, PWSTR ClassName, PWSTR VendorName, DHCP_OPTION** OptionInfo);
uint DhcpEnumOptionsV5(PWSTR ServerIpAddress, uint Flags, PWSTR ClassName, PWSTR VendorName, uint* ResumeHandle, uint PreferredMaximum, DHCP_OPTION_ARRAY** Options, uint* OptionsRead, uint* OptionsTotal);
uint DhcpRemoveOptionV5(PWSTR ServerIpAddress, uint Flags, uint OptionID, PWSTR ClassName, PWSTR VendorName);
uint DhcpSetOptionValueV5(PWSTR ServerIpAddress, uint Flags, uint OptionId, PWSTR ClassName, PWSTR VendorName, DHCP_OPTION_SCOPE_INFO* ScopeInfo, DHCP_OPTION_DATA* OptionValue);
uint DhcpSetOptionValuesV5(PWSTR ServerIpAddress, uint Flags, PWSTR ClassName, PWSTR VendorName, DHCP_OPTION_SCOPE_INFO* ScopeInfo, DHCP_OPTION_VALUE_ARRAY* OptionValues);
uint DhcpGetOptionValueV5(PWSTR ServerIpAddress, uint Flags, uint OptionID, PWSTR ClassName, PWSTR VendorName, DHCP_OPTION_SCOPE_INFO* ScopeInfo, DHCP_OPTION_VALUE** OptionValue);
uint DhcpGetOptionValueV6(PWSTR ServerIpAddress, uint Flags, uint OptionID, PWSTR ClassName, PWSTR VendorName, DHCP_OPTION_SCOPE_INFO6* ScopeInfo, DHCP_OPTION_VALUE** OptionValue);
uint DhcpEnumOptionValuesV5(PWSTR ServerIpAddress, uint Flags, PWSTR ClassName, PWSTR VendorName, DHCP_OPTION_SCOPE_INFO* ScopeInfo, uint* ResumeHandle, uint PreferredMaximum, DHCP_OPTION_VALUE_ARRAY** OptionValues, uint* OptionsRead, uint* OptionsTotal);
uint DhcpRemoveOptionValueV5(PWSTR ServerIpAddress, uint Flags, uint OptionID, PWSTR ClassName, PWSTR VendorName, DHCP_OPTION_SCOPE_INFO* ScopeInfo);
...
uint DhcpGetClassInfo(PWSTR ServerIpAddress, uint ReservedMustBeZero, DHCP_CLASS_INFO* PartialClassInfo, DHCP_CLASS_INFO** FilledClassInfo);
uint DhcpEnumClasses(PWSTR ServerIpAddress, uint ReservedMustBeZero, uint* ResumeHandle, uint PreferredMaximum, DHCP_CLASS_INFO_ARRAY** ClassInfoArray, uint* nRead, uint* nTotal);
...
uint DhcpGetAllOptionValues(PWSTR ServerIpAddress, uint Flags, DHCP_OPTION_SCOPE_INFO* ScopeInfo, DHCP_ALL_OPTION_VALUES** Values);
uint DhcpGetAllOptionValuesV6(PWSTR ServerIpAddress, uint Flags, DHCP_OPTION_SCOPE_INFO6* ScopeInfo, DHCP_ALL_OPTION_VALUES** Values);
...
uint DhcpCreateOptionV6(PWSTR ServerIpAddress, uint Flags, uint OptionId, PWSTR ClassName, PWSTR VendorName, DHCP_OPTION* OptionInfo);
uint DhcpRemoveOptionV6(PWSTR ServerIpAddress, uint Flags, uint OptionID, PWSTR ClassName, PWSTR VendorName);
uint DhcpEnumOptionsV6(PWSTR ServerIpAddress, uint Flags, PWSTR ClassName, PWSTR VendorName, uint* ResumeHandle, uint PreferredMaximum, DHCP_OPTION_ARRAY** Options, uint* OptionsRead, uint* OptionsTotal);
uint DhcpRemoveOptionValueV6(PWSTR ServerIpAddress, uint Flags, uint OptionID, PWSTR ClassName, PWSTR VendorName, DHCP_OPTION_SCOPE_INFO6* ScopeInfo);
uint DhcpGetOptionInfoV6(PWSTR ServerIpAddress, uint Flags, uint OptionID, PWSTR ClassName, PWSTR VendorName, DHCP_OPTION** OptionInfo);
uint DhcpSetOptionInfoV6(PWSTR ServerIpAddress, uint Flags, uint OptionID, PWSTR ClassName, PWSTR VendorName, DHCP_OPTION* OptionInfo);
uint DhcpSetOptionValueV6(PWSTR ServerIpAddress, uint Flags, uint OptionId, PWSTR ClassName, PWSTR VendorName, DHCP_OPTION_SCOPE_INFO6* ScopeInfo, DHCP_OPTION_DATA* OptionValue);
...
uint DhcpEnumOptionValuesV6(const(wchar)* ServerIpAddress, uint Flags, PWSTR ClassName, PWSTR VendorName, DHCP_OPTION_SCOPE_INFO6* ScopeInfo, uint* ResumeHandle, uint PreferredMaximum, DHCP_OPTION_VALUE_ARRAY** OptionValues, uint* OptionsRead, uint* OptionsTotal);
uint DhcpDsInit();
void DhcpDsCleanup();
...
uint DhcpServerQueryAttributes(PWSTR ServerIpAddr, uint dwReserved, uint dwAttribCount, uint* pDhcpAttribs, DHCP_ATTRIB_ARRAY** pDhcpAttribArr);
uint DhcpServerRedoAuthorization(PWSTR ServerIpAddr, uint dwReserved);
uint DhcpAuditLogSetParams(PWSTR ServerIpAddress, uint Flags, PWSTR AuditLogDir, uint DiskCheckInterval, uint MaxLogFilesSize, uint MinSpaceOnDisk);
uint DhcpAuditLogGetParams(PWSTR ServerIpAddress, uint Flags, PWSTR* AuditLogDir, uint* DiskCheckInterval, uint* MaxLogFilesSize, uint* MinSpaceOnDisk);
uint DhcpServerQueryDnsRegCredentials(PWSTR ServerIpAddress, uint UnameSize, PWSTR Uname, uint DomainSize, PWSTR Domain);
...
uint DhcpAddSubnetElementV6(PWSTR ServerIpAddress, DHCP_IPV6_ADDRESS SubnetAddress, DHCP_SUBNET_ELEMENT_DATA_V6* AddElementInfo);
uint DhcpRemoveSubnetElementV6(PWSTR ServerIpAddress, DHCP_IPV6_ADDRESS SubnetAddress, DHCP_SUBNET_ELEMENT_DATA_V6* RemoveElementInfo, DHCP_FORCE_FLAG ForceFlag);
uint DhcpEnumSubnetElementsV6(PWSTR ServerIpAddress, DHCP_IPV6_ADDRESS SubnetAddress, DHCP_SUBNET_ELEMENT_TYPE_V6 EnumElementType, uint* ResumeHandle, uint PreferredMaximum, DHCP_SUBNET_ELEMENT_INFO_ARRAY_V6** EnumElementInfo, uint* ElementsRead, uint* ElementsTotal);
...
uint DhcpEnumClassesV6(PWSTR ServerIpAddress, uint ReservedMustBeZero, uint* ResumeHandle, uint PreferredMaximum, DHCP_CLASS_INFO_ARRAY_V6** ClassInfoArray, uint* nRead, uint* nTotal);
...
uint DhcpV4GetOptionValue(PWSTR ServerIpAddress, uint Flags, uint OptionID, PWSTR PolicyName, PWSTR VendorName, DHCP_OPTION_SCOPE_INFO* ScopeInfo, DHCP_OPTION_VALUE** OptionValue);
uint DhcpV4SetOptionValue(PWSTR ServerIpAddress, uint Flags, uint OptionId, PWSTR PolicyName, PWSTR VendorName, DHCP_OPTION_SCOPE_INFO* ScopeInfo, DHCP_OPTION_DATA* OptionValue);
uint DhcpV4SetOptionValues(PWSTR ServerIpAddress, uint Flags, PWSTR PolicyName, PWSTR VendorName, DHCP_OPTION_SCOPE_INFO* ScopeInfo, DHCP_OPTION_VALUE_ARRAY* OptionValues);
uint DhcpV4RemoveOptionValue(PWSTR ServerIpAddress, uint Flags, uint OptionID, PWSTR PolicyName, PWSTR VendorName, DHCP_OPTION_SCOPE_INFO* ScopeInfo);
uint DhcpV4GetAllOptionValues(PWSTR ServerIpAddress, uint Flags, DHCP_OPTION_SCOPE_INFO* ScopeInfo, DHCP_ALL_OPTION_VALUES_PB** Values);
...
uint DhcpV4FailoverGetRelationship(PWSTR ServerIpAddress, PWSTR pRelationshipName, DHCP_FAILOVER_RELATIONSHIP** pRelationship);
uint DhcpV4FailoverEnumRelationship(PWSTR ServerIpAddress, uint* ResumeHandle, uint PreferredMaximum, DHCP_FAILOVER_RELATIONSHIP_ARRAY** pRelationship, uint* RelationshipRead, uint* RelationshipTotal);
...
uint DhcpV4FailoverGetScopeRelationship(PWSTR ServerIpAddress, uint ScopeId, DHCP_FAILOVER_RELATIONSHIP** pRelationship);
uint DhcpV4FailoverGetScopeStatistics(PWSTR ServerIpAddress, uint ScopeId, DHCP_FAILOVER_STATISTICS** pStats);
uint DhcpV4FailoverGetClientInfo(PWSTR ServerIpAddress, const(DHCP_SEARCH_INFO)* SearchInfo, DHCPV4_FAILOVER_CLIENT_INFO** ClientInfo);
...
uint DhcpHlprCreateV4Policy(PWSTR PolicyName, BOOL fGlobalPolicy, uint Subnet, uint ProcessingOrder, DHCP_POL_LOGIC_OPER RootOperator, PWSTR Description, BOOL Enabled, DHCP_POLICY** Policy);
uint DhcpHlprCreateV4PolicyEx(PWSTR PolicyName, BOOL fGlobalPolicy, uint Subnet, uint ProcessingOrder, DHCP_POL_LOGIC_OPER RootOperator, PWSTR Description, BOOL Enabled, DHCP_POLICY_EX** Policy);
uint DhcpHlprAddV4PolicyExpr(DHCP_POLICY* Policy, uint ParentExpr, DHCP_POL_LOGIC_OPER Operator, uint* ExprIndex);
uint DhcpHlprAddV4PolicyCondition(DHCP_POLICY* Policy, uint ParentExpr, DHCP_POL_ATTR_TYPE Type, uint OptionID, uint SubOptionID, PWSTR VendorName, DHCP_POL_COMPARATOR Operator, ubyte* Value, uint ValueLength, uint* ConditionIndex);
...
uint DhcpV4GetPolicy(PWSTR ServerIpAddress, BOOL fGlobalPolicy, uint SubnetAddress, PWSTR PolicyName, DHCP_POLICY** Policy);
uint DhcpV4SetPolicy(PWSTR ServerIpAddress, uint FieldsModified, BOOL fGlobalPolicy, uint SubnetAddress, PWSTR PolicyName, DHCP_POLICY* Policy);
uint DhcpV4DeletePolicy(PWSTR ServerIpAddress, BOOL fGlobalPolicy, uint SubnetAddress, PWSTR PolicyName);
uint DhcpV4EnumPolicies(PWSTR ServerIpAddress, uint* ResumeHandle, uint PreferredMaximum, BOOL fGlobalPolicy, uint SubnetAddress, DHCP_POLICY_ARRAY** EnumInfo, uint* ElementsRead, uint* ElementsTotal);
...
uint DhcpV6SetStatelessStoreParams(PWSTR ServerIpAddress, BOOL fServerLevel, DHCP_IPV6_ADDRESS SubnetAddress, uint FieldModified, DHCPV6_STATELESS_PARAMS* Params);
uint DhcpV6GetStatelessStoreParams(PWSTR ServerIpAddress, BOOL fServerLevel, DHCP_IPV6_ADDRESS SubnetAddress, DHCPV6_STATELESS_PARAMS** Params);
...
uint DhcpV4GetFreeIPAddress(PWSTR ServerIpAddress, uint ScopeId, uint StartIP, uint EndIP, uint NumFreeAddrReq, DHCP_IP_ARRAY** IPAddrList);
uint DhcpV6GetFreeIPAddress(PWSTR ServerIpAddress, DHCP_IPV6_ADDRESS ScopeId, DHCP_IPV6_ADDRESS StartIP, DHCP_IPV6_ADDRESS EndIP, uint NumFreeAddrReq, DHCPV6_IP_ARRAY** IPAddrList);
...
uint DhcpV4GetPolicyEx(PWSTR ServerIpAddress, BOOL GlobalPolicy, uint SubnetAddress, PWSTR PolicyName, DHCP_POLICY_EX** Policy);
uint DhcpV4SetPolicyEx(PWSTR ServerIpAddress, uint FieldsModified, BOOL GlobalPolicy, uint SubnetAddress, PWSTR PolicyName, DHCP_POLICY_EX* Policy);
uint DhcpV4EnumPoliciesEx(PWSTR ServerIpAddress, uint* ResumeHandle, uint PreferredMaximum, BOOL GlobalPolicy, uint SubnetAddress, DHCP_POLICY_EX_ARRAY** EnumInfo, uint* ElementsRead, uint* ElementsTotal);
...
alias LPDHCP_NEWPKT = uint function(ubyte** Packet, uint* PacketSize, uint IpAddress, void* Reserved, void** PktContext, BOOL* ProcessIt);
alias LPDHCP_DROP_SEND = uint function(ubyte** Packet, uint* PacketSize, uint ControlCode, uint IpAddress, void* Reserved, void* PktContext);
alias LPDHCP_PROB = uint function(ubyte* Packet, uint PacketSize, uint ControlCode, uint IpAddress, uint AltAddress, void* Reserved, void* PktContext);
alias LPDHCP_GIVE_ADDRESS = uint function(ubyte* Packet, uint PacketSize, uint ControlCode, uint IpAddress, uint AltAddress, uint AddrType, uint LeaseTime, void* Reserved, void* PktContext);
alias LPDHCP_HANDLE_OPTIONS = uint function(ubyte* Packet, uint PacketSize, void* Reserved, void* PktContext, DHCP_SERVER_OPTIONS* ServerOptions);
alias LPDHCP_DELETE_CLIENT = uint function(uint IpAddress, ubyte* HwAddress, uint HwAddressLength, uint Reserved, uint ClientType);
