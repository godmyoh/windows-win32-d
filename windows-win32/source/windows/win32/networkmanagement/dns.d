...
import windows.win32.foundation : BOOL, CHAR, HANDLE, PSTR, PWSTR;
...
int DnsQuery_A(const(char)*, ushort, uint, void*, DNS_RECORDA**, void**);
int DnsQuery_UTF8(const(char)*, ushort, uint, void*, DNS_RECORDA**, void**);
int DnsQuery_W(const(wchar)*, ushort, uint, void*, DNS_RECORDA**, void**);
...
enum DNS_TYPE_ZERO = 0x00000000;
enum DNS_TYPE_A = 0x00000001;
enum DNS_TYPE_NS = 0x00000002;
enum DNS_TYPE_MD = 0x00000003;
enum DNS_TYPE_MF = 0x00000004;
enum DNS_TYPE_CNAME = 0x00000005;
enum DNS_TYPE_SOA = 0x00000006;
enum DNS_TYPE_MB = 0x00000007;
enum DNS_TYPE_MG = 0x00000008;
enum DNS_TYPE_MR = 0x00000009;
enum DNS_TYPE_NULL = 0x0000000a;
enum DNS_TYPE_WKS = 0x0000000b;
enum DNS_TYPE_PTR = 0x0000000c;
enum DNS_TYPE_HINFO = 0x0000000d;
enum DNS_TYPE_MINFO = 0x0000000e;
enum DNS_TYPE_MX = 0x0000000f;
enum DNS_TYPE_TEXT = 0x00000010;
enum DNS_TYPE_RP = 0x00000011;
enum DNS_TYPE_AFSDB = 0x00000012;
enum DNS_TYPE_X25 = 0x00000013;
enum DNS_TYPE_ISDN = 0x00000014;
enum DNS_TYPE_RT = 0x00000015;
enum DNS_TYPE_NSAP = 0x00000016;
enum DNS_TYPE_NSAPPTR = 0x00000017;
enum DNS_TYPE_SIG = 0x00000018;
enum DNS_TYPE_KEY = 0x00000019;
enum DNS_TYPE_PX = 0x0000001a;
enum DNS_TYPE_GPOS = 0x0000001b;
enum DNS_TYPE_AAAA = 0x0000001c;
enum DNS_TYPE_LOC = 0x0000001d;
enum DNS_TYPE_NXT = 0x0000001e;
enum DNS_TYPE_EID = 0x0000001f;
enum DNS_TYPE_NIMLOC = 0x00000020;
enum DNS_TYPE_SRV = 0x00000021;
enum DNS_TYPE_ATMA = 0x00000022;
enum DNS_TYPE_NAPTR = 0x00000023;
enum DNS_TYPE_KX = 0x00000024;
enum DNS_TYPE_CERT = 0x00000025;
enum DNS_TYPE_A6 = 0x00000026;
enum DNS_TYPE_DNAME = 0x00000027;
enum DNS_TYPE_SINK = 0x00000028;
enum DNS_TYPE_OPT = 0x00000029;
enum DNS_TYPE_DS = 0x0000002b;
enum DNS_TYPE_RRSIG = 0x0000002e;
enum DNS_TYPE_NSEC = 0x0000002f;
enum DNS_TYPE_DNSKEY = 0x00000030;
enum DNS_TYPE_DHCID = 0x00000031;
enum DNS_TYPE_NSEC3 = 0x00000032;
enum DNS_TYPE_NSEC3PARAM = 0x00000033;
enum DNS_TYPE_TLSA = 0x00000034;
enum DNS_TYPE_UINFO = 0x00000064;
enum DNS_TYPE_UID = 0x00000065;
enum DNS_TYPE_GID = 0x00000066;
enum DNS_TYPE_UNSPEC = 0x00000067;
enum DNS_TYPE_ADDRS = 0x000000f8;
enum DNS_TYPE_TKEY = 0x000000f9;
enum DNS_TYPE_TSIG = 0x000000fa;
enum DNS_TYPE_IXFR = 0x000000fb;
enum DNS_TYPE_AXFR = 0x000000fc;
enum DNS_TYPE_MAILB = 0x000000fd;
enum DNS_TYPE_MAILA = 0x000000fe;
enum DNS_TYPE_ALL = 0x000000ff;
enum DNS_TYPE_ANY = 0x000000ff;
enum DNS_TYPE_WINS = 0x0000ff01;
enum DNS_TYPE_WINSR = 0x0000ff02;
enum DNS_TYPE_NBSTAT = 0x0000ff02;
...
enum DNS_QUERY_STANDARD = 0x00000000;
enum DNS_QUERY_ACCEPT_TRUNCATED_RESPONSE = 0x00000001;
enum DNS_QUERY_USE_TCP_ONLY = 0x00000002;
enum DNS_QUERY_NO_RECURSION = 0x00000004;
enum DNS_QUERY_BYPASS_CACHE = 0x00000008;
enum DNS_QUERY_NO_WIRE_QUERY = 0x00000010;
enum DNS_QUERY_NO_LOCAL_NAME = 0x00000020;
enum DNS_QUERY_NO_HOSTS_FILE = 0x00000040;
enum DNS_QUERY_NO_NETBT = 0x00000080;
enum DNS_QUERY_WIRE_ONLY = 0x00000100;
enum DNS_QUERY_RETURN_MESSAGE = 0x00000200;
enum DNS_QUERY_MULTICAST_ONLY = 0x00000400;
enum DNS_QUERY_NO_MULTICAST = 0x00000800;
enum DNS_QUERY_TREAT_AS_FQDN = 0x00001000;
enum DNS_QUERY_ADDRCONFIG = 0x00002000;
enum DNS_QUERY_DUAL_ADDR = 0x00004000;
enum DNS_QUERY_DONT_RESET_TTL_VALUES = 0x00100000;
enum DNS_QUERY_DISABLE_IDN_ENCODING = 0x00200000;
enum DNS_QUERY_APPEND_MULTILABEL = 0x00800000;
enum DNS_QUERY_DNSSEC_OK = 0x01000000;
enum DNS_QUERY_DNSSEC_CHECKING_DISABLED = 0x02000000;
enum DNS_QUERY_RESERVED = 0xf0000000;
enum DNS_QUERY_CACHE_ONLY = 0x00000010;
enum DNS_QUERY_REQUEST_VERSION1 = 0x00000001;
enum DNS_QUERY_REQUEST_VERSION2 = 0x00000002;
enum DNS_QUERY_RESULTS_VERSION1 = 0x00000001;
enum DNS_QUERY_REQUEST_VERSION3 = 0x00000003;
