...
BOOL SetupSetSourceListA(uint, const(char)**, uint);
BOOL SetupSetSourceListW(uint, const(wchar)**, uint);
...
BOOL SetupQuerySourceListA(uint, const(char)***, uint*);
BOOL SetupQuerySourceListW(uint, const(wchar)***, uint*);
BOOL SetupFreeSourceListA(const(char)***, uint);
BOOL SetupFreeSourceListW(const(wchar)***, uint);
...
BOOL SetupDiCreateDeviceInfoA(HDEVINFO, const(char)*, const(GUID)*, const(char)*, HWND, SETUP_DI_DEVICE_CREATION_FLAGS, SP_DEVINFO_DATA*);
BOOL SetupDiCreateDeviceInfoW(HDEVINFO, const(wchar)*, const(GUID)*, const(wchar)*, HWND, SETUP_DI_DEVICE_CREATION_FLAGS, SP_DEVINFO_DATA*);
...
BOOL SetupDiBuildDriverInfoList(HDEVINFO, SP_DEVINFO_DATA*, SETUP_DI_DRIVER_TYPE);
BOOL SetupDiCancelDriverInfoSearch(HDEVINFO);
BOOL SetupDiEnumDriverInfoA(HDEVINFO, SP_DEVINFO_DATA*, SETUP_DI_DRIVER_TYPE, uint, SP_DRVINFO_DATA_V2_A*);
BOOL SetupDiEnumDriverInfoW(HDEVINFO, SP_DEVINFO_DATA*, SETUP_DI_DRIVER_TYPE, uint, SP_DRVINFO_DATA_V2_W*);
...
BOOL SetupDiDestroyDriverInfoList(HDEVINFO, SP_DEVINFO_DATA*, SETUP_DI_DRIVER_TYPE);
HDEVINFO SetupDiGetClassDevsA(const(GUID)*, const(char)*, HWND, SETUP_DI_GET_CLASS_DEVS_FLAGS);
HDEVINFO SetupDiGetClassDevsW(const(GUID)*, const(wchar)*, HWND, SETUP_DI_GET_CLASS_DEVS_FLAGS);
HDEVINFO SetupDiGetClassDevsExA(const(GUID)*, const(char)*, HWND, SETUP_DI_GET_CLASS_DEVS_FLAGS, HDEVINFO, const(char)*, void*);
HDEVINFO SetupDiGetClassDevsExW(const(GUID)*, const(wchar)*, HWND, SETUP_DI_GET_CLASS_DEVS_FLAGS, HDEVINFO, const(wchar)*, void*);
...
BOOL SetupDiCallClassInstaller(DI_FUNCTION, HDEVINFO, SP_DEVINFO_DATA*);
...
BOOL SetupDiGetDevicePropertyW(HDEVINFO, SP_DEVINFO_DATA*, const(DEVPROPKEY)*, DEVPROPTYPE*, ubyte*, uint, uint*, uint);
BOOL SetupDiSetDevicePropertyW(HDEVINFO, SP_DEVINFO_DATA*, const(DEVPROPKEY)*, DEVPROPTYPE, const(ubyte)*, uint, uint);
BOOL SetupDiGetDeviceInterfacePropertyKeys(HDEVINFO, SP_DEVICE_INTERFACE_DATA*, DEVPROPKEY*, uint, uint*, uint);
BOOL SetupDiGetDeviceInterfacePropertyW(HDEVINFO, SP_DEVICE_INTERFACE_DATA*, const(DEVPROPKEY)*, DEVPROPTYPE*, ubyte*, uint, uint*, uint);
BOOL SetupDiSetDeviceInterfacePropertyW(HDEVINFO, SP_DEVICE_INTERFACE_DATA*, const(DEVPROPKEY)*, DEVPROPTYPE, const(ubyte)*, uint, uint);
...
BOOL SetupDiGetClassPropertyW(const(GUID)*, const(DEVPROPKEY)*, DEVPROPTYPE*, ubyte*, uint, uint*, uint);
BOOL SetupDiGetClassPropertyExW(const(GUID)*, const(DEVPROPKEY)*, DEVPROPTYPE*, ubyte*, uint, uint*, uint, const(wchar)*, void*);
BOOL SetupDiSetClassPropertyW(const(GUID)*, const(DEVPROPKEY)*, DEVPROPTYPE, const(ubyte)*, uint, uint);
BOOL SetupDiSetClassPropertyExW(const(GUID)*, const(DEVPROPKEY)*, DEVPROPTYPE, const(ubyte)*, uint, uint, const(wchar)*, void*);
BOOL SetupDiGetDeviceRegistryPropertyA(HDEVINFO, SP_DEVINFO_DATA*, SETUP_DI_REGISTRY_PROPERTY, uint*, ubyte*, uint, uint*);
BOOL SetupDiGetDeviceRegistryPropertyW(HDEVINFO, SP_DEVINFO_DATA*, SETUP_DI_REGISTRY_PROPERTY, uint*, ubyte*, uint, uint*);
...
BOOL SetupDiSetDeviceRegistryPropertyA(HDEVINFO, SP_DEVINFO_DATA*, SETUP_DI_REGISTRY_PROPERTY, const(ubyte)*, uint);
BOOL SetupDiSetDeviceRegistryPropertyW(HDEVINFO, SP_DEVINFO_DATA*, SETUP_DI_REGISTRY_PROPERTY, const(ubyte)*, uint);
...
CONFIGRET CM_Create_DevNodeA(uint*, PSTR, uint, uint);
CONFIGRET CM_Create_DevNodeW(uint*, PWSTR, uint, uint);
CONFIGRET CM_Create_DevNode_ExA(uint*, PSTR, uint, uint, long);
CONFIGRET CM_Create_DevNode_ExW(uint*, PWSTR, uint, uint, long);
...
CONFIGRET CM_Get_DevNode_PropertyW(uint, const(DEVPROPKEY)*, DEVPROPTYPE*, ubyte*, uint*, uint);
CONFIGRET CM_Get_DevNode_Property_ExW(uint, const(DEVPROPKEY)*, DEVPROPTYPE*, ubyte*, uint*, uint, long);
...
CONFIGRET CM_Get_HW_Prof_Flags_ExW(PWSTR, uint, uint*, uint, long);
...
CONFIGRET CM_Get_Device_Interface_List_ExA(GUID*, PSTR, PSTR, uint, CM_GET_DEVICE_INTERFACE_LIST_FLAGS, long);
CONFIGRET CM_Get_Device_Interface_List_ExW(GUID*, PWSTR, PWSTR, uint, CM_GET_DEVICE_INTERFACE_LIST_FLAGS, long);
...
CONFIGRET CM_Set_DevNode_PropertyW(uint, const(DEVPROPKEY)*, DEVPROPTYPE, const(ubyte)*, uint, uint);
CONFIGRET CM_Set_DevNode_Property_ExW(uint, const(DEVPROPKEY)*, DEVPROPTYPE, const(ubyte)*, uint, uint, long);
...
CONFIGRET CM_Set_Device_Interface_PropertyW(const(wchar)*, const(DEVPROPKEY)*, DEVPROPTYPE, const(ubyte)*, uint, uint);
CONFIGRET CM_Set_Device_Interface_Property_ExW(const(wchar)*, const(DEVPROPKEY)*, DEVPROPTYPE, const(ubyte)*, uint, uint, long);
...
CONFIGRET CM_Set_HW_Prof_FlagsA(PSTR, uint, uint, uint);
CONFIGRET CM_Set_HW_Prof_FlagsW(PWSTR, uint, uint, uint);
CONFIGRET CM_Set_HW_Prof_Flags_ExA(PSTR, uint, uint, uint, long);
CONFIGRET CM_Set_HW_Prof_Flags_ExW(PWSTR, uint, uint, uint, long);
...
CONFIGRET CM_Get_Class_PropertyW(const(GUID)*, const(DEVPROPKEY)*, DEVPROPTYPE*, ubyte*, uint*, uint);
CONFIGRET CM_Get_Class_Property_ExW(const(GUID)*, const(DEVPROPKEY)*, DEVPROPTYPE*, ubyte*, uint*, uint, long);
...
CONFIGRET CM_Set_Class_PropertyW(const(GUID)*, const(DEVPROPKEY)*, DEVPROPTYPE, const(ubyte)*, uint, uint);
CONFIGRET CM_Set_Class_Property_ExW(const(GUID)*, const(DEVPROPKEY)*, DEVPROPTYPE, const(ubyte)*, uint, uint, long);
