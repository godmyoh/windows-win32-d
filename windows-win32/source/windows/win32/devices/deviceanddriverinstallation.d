...
import windows.win32.foundation : BOOL, CHAR, DEVPROPKEY, FILETIME, HANDLE, HINSTANCE, HWND, LPARAM, PSTR, PWSTR, RECT;
...
import windows.win32.system.systeminformation : PROCESSOR_ARCHITECTURE;
...
BOOL SetupGetInfInformationA(const(void)* InfSpec, uint SearchControl, SP_INF_INFORMATION* ReturnBuffer, uint ReturnBufferSize, uint* RequiredSize);
BOOL SetupGetInfInformationW(const(void)* InfSpec, uint SearchControl, SP_INF_INFORMATION* ReturnBuffer, uint ReturnBufferSize, uint* RequiredSize);
BOOL SetupQueryInfFileInformationA(SP_INF_INFORMATION* InfInformation, uint InfIndex, PSTR ReturnBuffer, uint ReturnBufferSize, uint* RequiredSize);
BOOL SetupQueryInfFileInformationW(SP_INF_INFORMATION* InfInformation, uint InfIndex, PWSTR ReturnBuffer, uint ReturnBufferSize, uint* RequiredSize);
...
BOOL SetupQueryInfVersionInformationA(SP_INF_INFORMATION* InfInformation, uint InfIndex, const(char)* Key, PSTR ReturnBuffer, uint ReturnBufferSize, uint* RequiredSize);
BOOL SetupQueryInfVersionInformationW(SP_INF_INFORMATION* InfInformation, uint InfIndex, const(wchar)* Key, PWSTR ReturnBuffer, uint ReturnBufferSize, uint* RequiredSize);
BOOL SetupGetInfDriverStoreLocationA(const(char)* FileName, SP_ALTPLATFORM_INFO_V2* AlternatePlatformInfo, const(char)* LocaleName, PSTR ReturnBuffer, uint ReturnBufferSize, uint* RequiredSize);
BOOL SetupGetInfDriverStoreLocationW(const(wchar)* FileName, SP_ALTPLATFORM_INFO_V2* AlternatePlatformInfo, const(wchar)* LocaleName, PWSTR ReturnBuffer, uint ReturnBufferSize, uint* RequiredSize);
BOOL SetupGetInfPublishedNameA(const(char)* DriverStoreLocation, PSTR ReturnBuffer, uint ReturnBufferSize, uint* RequiredSize);
BOOL SetupGetInfPublishedNameW(const(wchar)* DriverStoreLocation, PWSTR ReturnBuffer, uint ReturnBufferSize, uint* RequiredSize);
BOOL SetupGetInfFileListA(const(char)* DirectoryPath, INF_STYLE InfStyle, PSTR ReturnBuffer, uint ReturnBufferSize, uint* RequiredSize);
BOOL SetupGetInfFileListW(const(wchar)* DirectoryPath, INF_STYLE InfStyle, PWSTR ReturnBuffer, uint ReturnBufferSize, uint* RequiredSize);
void* SetupOpenInfFileW(const(wchar)* FileName, const(wchar)* InfClass, INF_STYLE InfStyle, uint* ErrorLine);
void* SetupOpenInfFileA(const(char)* FileName, const(char)* InfClass, INF_STYLE InfStyle, uint* ErrorLine);
...
BOOL SetupGetLineTextA(INFCONTEXT* Context, void* InfHandle, const(char)* Section, const(char)* Key, PSTR ReturnBuffer, uint ReturnBufferSize, uint* RequiredSize);
BOOL SetupGetLineTextW(INFCONTEXT* Context, void* InfHandle, const(wchar)* Section, const(wchar)* Key, PWSTR ReturnBuffer, uint ReturnBufferSize, uint* RequiredSize);
uint SetupGetFieldCount(INFCONTEXT* Context);
BOOL SetupGetStringFieldA(INFCONTEXT* Context, uint FieldIndex, PSTR ReturnBuffer, uint ReturnBufferSize, uint* RequiredSize);
BOOL SetupGetStringFieldW(INFCONTEXT* Context, uint FieldIndex, PWSTR ReturnBuffer, uint ReturnBufferSize, uint* RequiredSize);
BOOL SetupGetIntField(INFCONTEXT* Context, uint FieldIndex, int* IntegerValue);
BOOL SetupGetMultiSzFieldA(INFCONTEXT* Context, uint FieldIndex, PSTR ReturnBuffer, uint ReturnBufferSize, uint* RequiredSize);
BOOL SetupGetMultiSzFieldW(INFCONTEXT* Context, uint FieldIndex, PWSTR ReturnBuffer, uint ReturnBufferSize, uint* RequiredSize);
BOOL SetupGetBinaryField(INFCONTEXT* Context, uint FieldIndex, ubyte* ReturnBuffer, uint ReturnBufferSize, uint* RequiredSize);
uint SetupGetFileCompressionInfoA(const(char)* SourceFileName, PSTR* ActualSourceFileName, uint* SourceFileSize, uint* TargetFileSize, FILE_COMPRESSION_TYPE* CompressionType);
uint SetupGetFileCompressionInfoW(const(wchar)* SourceFileName, PWSTR* ActualSourceFileName, uint* SourceFileSize, uint* TargetFileSize, FILE_COMPRESSION_TYPE* CompressionType);
BOOL SetupGetFileCompressionInfoExA(const(char)* SourceFileName, PSTR ActualSourceFileNameBuffer, uint ActualSourceFileNameBufferLen, uint* RequiredBufferLen, uint* SourceFileSize, uint* TargetFileSize, FILE_COMPRESSION_TYPE* CompressionType);
BOOL SetupGetFileCompressionInfoExW(const(wchar)* SourceFileName, PWSTR ActualSourceFileNameBuffer, uint ActualSourceFileNameBufferLen, uint* RequiredBufferLen, uint* SourceFileSize, uint* TargetFileSize, FILE_COMPRESSION_TYPE* CompressionType);
uint SetupDecompressOrCopyFileA(const(char)* SourceFileName, const(char)* TargetFileName, FILE_COMPRESSION_TYPE* CompressionType);
uint SetupDecompressOrCopyFileW(const(wchar)* SourceFileName, const(wchar)* TargetFileName, FILE_COMPRESSION_TYPE* CompressionType);
BOOL SetupGetSourceFileLocationA(void* InfHandle, INFCONTEXT* InfContext, const(char)* FileName, uint* SourceId, PSTR ReturnBuffer, uint ReturnBufferSize, uint* RequiredSize);
BOOL SetupGetSourceFileLocationW(void* InfHandle, INFCONTEXT* InfContext, const(wchar)* FileName, uint* SourceId, PWSTR ReturnBuffer, uint ReturnBufferSize, uint* RequiredSize);
...
BOOL SetupGetTargetPathA(void* InfHandle, INFCONTEXT* InfContext, const(char)* Section, PSTR ReturnBuffer, uint ReturnBufferSize, uint* RequiredSize);
BOOL SetupGetTargetPathW(void* InfHandle, INFCONTEXT* InfContext, const(wchar)* Section, PWSTR ReturnBuffer, uint ReturnBufferSize, uint* RequiredSize);
BOOL SetupSetSourceListA(uint Flags, const(char)** SourceList, uint SourceCount);
BOOL SetupSetSourceListW(uint Flags, const(wchar)** SourceList, uint SourceCount);
...
BOOL SetupQuerySourceListA(uint Flags, const(char)*** List, uint* Count);
BOOL SetupQuerySourceListW(uint Flags, const(wchar)*** List, uint* Count);
BOOL SetupFreeSourceListA(const(char)*** List, uint Count);
BOOL SetupFreeSourceListW(const(wchar)*** List, uint Count);
uint SetupPromptForDiskA(HWND hwndParent, const(char)* DialogTitle, const(char)* DiskName, const(char)* PathToSource, const(char)* FileSought, const(char)* TagFile, uint DiskPromptStyle, PSTR PathBuffer, uint PathBufferSize, uint* PathRequiredSize);
uint SetupPromptForDiskW(HWND hwndParent, const(wchar)* DialogTitle, const(wchar)* DiskName, const(wchar)* PathToSource, const(wchar)* FileSought, const(wchar)* TagFile, uint DiskPromptStyle, PWSTR PathBuffer, uint PathBufferSize, uint* PathRequiredSize);
uint SetupCopyErrorA(HWND hwndParent, const(char)* DialogTitle, const(char)* DiskName, const(char)* PathToSource, const(char)* SourceFile, const(char)* TargetPathFile, uint Win32ErrorCode, uint Style, PSTR PathBuffer, uint PathBufferSize, uint* PathRequiredSize);
uint SetupCopyErrorW(HWND hwndParent, const(wchar)* DialogTitle, const(wchar)* DiskName, const(wchar)* PathToSource, const(wchar)* SourceFile, const(wchar)* TargetPathFile, uint Win32ErrorCode, uint Style, PWSTR PathBuffer, uint PathBufferSize, uint* PathRequiredSize);
...
BOOL SetupGetSourceInfoA(void* InfHandle, uint SourceId, uint InfoDesired, PSTR ReturnBuffer, uint ReturnBufferSize, uint* RequiredSize);
BOOL SetupGetSourceInfoW(void* InfHandle, uint SourceId, uint InfoDesired, PWSTR ReturnBuffer, uint ReturnBufferSize, uint* RequiredSize);
BOOL SetupInstallFileA(void* InfHandle, INFCONTEXT* InfContext, const(char)* SourceFile, const(char)* SourcePathRoot, const(char)* DestinationName, SP_COPY_STYLE CopyStyle, PSP_FILE_CALLBACK_A CopyMsgHandler, void* Context);
BOOL SetupInstallFileW(void* InfHandle, INFCONTEXT* InfContext, const(wchar)* SourceFile, const(wchar)* SourcePathRoot, const(wchar)* DestinationName, SP_COPY_STYLE CopyStyle, PSP_FILE_CALLBACK_W CopyMsgHandler, void* Context);
BOOL SetupInstallFileExA(void* InfHandle, INFCONTEXT* InfContext, const(char)* SourceFile, const(char)* SourcePathRoot, const(char)* DestinationName, SP_COPY_STYLE CopyStyle, PSP_FILE_CALLBACK_A CopyMsgHandler, void* Context, BOOL* FileWasInUse);
BOOL SetupInstallFileExW(void* InfHandle, INFCONTEXT* InfContext, const(wchar)* SourceFile, const(wchar)* SourcePathRoot, const(wchar)* DestinationName, SP_COPY_STYLE CopyStyle, PSP_FILE_CALLBACK_W CopyMsgHandler, void* Context, BOOL* FileWasInUse);
...
BOOL SetupScanFileQueueA(void* FileQueue, SETUPSCANFILEQUEUE_FLAGS Flags, HWND Window, PSP_FILE_CALLBACK_A CallbackRoutine, void* CallbackContext, uint* Result);
BOOL SetupScanFileQueueW(void* FileQueue, SETUPSCANFILEQUEUE_FLAGS Flags, HWND Window, PSP_FILE_CALLBACK_W CallbackRoutine, void* CallbackContext, uint* Result);
...
BOOL SetupCopyOEMInfA(const(char)* SourceInfFileName, const(char)* OEMSourceMediaLocation, OEM_SOURCE_MEDIA_TYPE OEMSourceMediaType, SP_COPY_STYLE CopyStyle, PSTR DestinationInfFileName, uint DestinationInfFileNameSize, uint* RequiredSize, PSTR* DestinationInfFileNameComponent);
BOOL SetupCopyOEMInfW(const(wchar)* SourceInfFileName, const(wchar)* OEMSourceMediaLocation, OEM_SOURCE_MEDIA_TYPE OEMSourceMediaType, SP_COPY_STYLE CopyStyle, PWSTR DestinationInfFileName, uint DestinationInfFileNameSize, uint* RequiredSize, PWSTR* DestinationInfFileNameComponent);
...
BOOL SetupQueryDrivesInDiskSpaceListA(void* DiskSpace, PSTR ReturnBuffer, uint ReturnBufferSize, uint* RequiredSize);
BOOL SetupQueryDrivesInDiskSpaceListW(void* DiskSpace, PWSTR ReturnBuffer, uint ReturnBufferSize, uint* RequiredSize);
...
BOOL SetupAddToDiskSpaceListA(void* DiskSpace, const(char)* TargetFilespec, long FileSize, SETUP_FILE_OPERATION Operation, void* Reserved1, uint Reserved2);
BOOL SetupAddToDiskSpaceListW(void* DiskSpace, const(wchar)* TargetFilespec, long FileSize, SETUP_FILE_OPERATION Operation, void* Reserved1, uint Reserved2);
BOOL SetupAddSectionToDiskSpaceListA(void* DiskSpace, void* InfHandle, void* ListInfHandle, const(char)* SectionName, SETUP_FILE_OPERATION Operation, void* Reserved1, uint Reserved2);
BOOL SetupAddSectionToDiskSpaceListW(void* DiskSpace, void* InfHandle, void* ListInfHandle, const(wchar)* SectionName, SETUP_FILE_OPERATION Operation, void* Reserved1, uint Reserved2);
...
BOOL SetupRemoveFromDiskSpaceListA(void* DiskSpace, const(char)* TargetFilespec, SETUP_FILE_OPERATION Operation, void* Reserved1, uint Reserved2);
BOOL SetupRemoveFromDiskSpaceListW(void* DiskSpace, const(wchar)* TargetFilespec, SETUP_FILE_OPERATION Operation, void* Reserved1, uint Reserved2);
BOOL SetupRemoveSectionFromDiskSpaceListA(void* DiskSpace, void* InfHandle, void* ListInfHandle, const(char)* SectionName, SETUP_FILE_OPERATION Operation, void* Reserved1, uint Reserved2);
BOOL SetupRemoveSectionFromDiskSpaceListW(void* DiskSpace, void* InfHandle, void* ListInfHandle, const(wchar)* SectionName, SETUP_FILE_OPERATION Operation, void* Reserved1, uint Reserved2);
...
uint SetupDefaultQueueCallbackA(void* Context, uint Notification, ulong Param1, ulong Param2);
uint SetupDefaultQueueCallbackW(void* Context, uint Notification, ulong Param1, ulong Param2);
BOOL SetupInstallFromInfSectionA(HWND Owner, void* InfHandle, const(char)* SectionName, uint Flags, HKEY RelativeKeyRoot, const(char)* SourceRootPath, uint CopyFlags, PSP_FILE_CALLBACK_A MsgHandler, void* Context, HDEVINFO DeviceInfoSet, SP_DEVINFO_DATA* DeviceInfoData);
BOOL SetupInstallFromInfSectionW(HWND Owner, void* InfHandle, const(wchar)* SectionName, uint Flags, HKEY RelativeKeyRoot, const(wchar)* SourceRootPath, uint CopyFlags, PSP_FILE_CALLBACK_W MsgHandler, void* Context, HDEVINFO DeviceInfoSet, SP_DEVINFO_DATA* DeviceInfoData);
...
BOOL SetupInstallServicesFromInfSectionA(void* InfHandle, const(char)* SectionName, SPSVCINST_FLAGS Flags);
BOOL SetupInstallServicesFromInfSectionW(void* InfHandle, const(wchar)* SectionName, SPSVCINST_FLAGS Flags);
BOOL SetupInstallServicesFromInfSectionExA(void* InfHandle, const(char)* SectionName, SPSVCINST_FLAGS Flags, HDEVINFO DeviceInfoSet, SP_DEVINFO_DATA* DeviceInfoData, void* Reserved1, void* Reserved2);
BOOL SetupInstallServicesFromInfSectionExW(void* InfHandle, const(wchar)* SectionName, SPSVCINST_FLAGS Flags, HDEVINFO DeviceInfoSet, SP_DEVINFO_DATA* DeviceInfoData, void* Reserved1, void* Reserved2);
...
BOOL SetupQueryFileLogA(void* FileLogHandle, const(char)* LogSectionName, const(char)* TargetFilename, SetupFileLogInfo DesiredInfo, PSTR DataOut, uint ReturnBufferSize, uint* RequiredSize);
BOOL SetupQueryFileLogW(void* FileLogHandle, const(wchar)* LogSectionName, const(wchar)* TargetFilename, SetupFileLogInfo DesiredInfo, PWSTR DataOut, uint ReturnBufferSize, uint* RequiredSize);
...
HDEVINFO SetupDiCreateDeviceInfoListExA(const(GUID)* ClassGuid, HWND hwndParent, const(char)* MachineName, void* Reserved);
HDEVINFO SetupDiCreateDeviceInfoListExW(const(GUID)* ClassGuid, HWND hwndParent, const(wchar)* MachineName, void* Reserved);
...
BOOL SetupDiCreateDeviceInfoA(HDEVINFO DeviceInfoSet, const(char)* DeviceName, const(GUID)* ClassGuid, const(char)* DeviceDescription, HWND hwndParent, SETUP_DI_DEVICE_CREATION_FLAGS CreationFlags, SP_DEVINFO_DATA* DeviceInfoData);
BOOL SetupDiCreateDeviceInfoW(HDEVINFO DeviceInfoSet, const(wchar)* DeviceName, const(GUID)* ClassGuid, const(wchar)* DeviceDescription, HWND hwndParent, SETUP_DI_DEVICE_CREATION_FLAGS CreationFlags, SP_DEVINFO_DATA* DeviceInfoData);
BOOL SetupDiOpenDeviceInfoA(HDEVINFO DeviceInfoSet, const(char)* DeviceInstanceId, HWND hwndParent, uint OpenFlags, SP_DEVINFO_DATA* DeviceInfoData);
BOOL SetupDiOpenDeviceInfoW(HDEVINFO DeviceInfoSet, const(wchar)* DeviceInstanceId, HWND hwndParent, uint OpenFlags, SP_DEVINFO_DATA* DeviceInfoData);
BOOL SetupDiGetDeviceInstanceIdA(HDEVINFO DeviceInfoSet, SP_DEVINFO_DATA* DeviceInfoData, PSTR DeviceInstanceId, uint DeviceInstanceIdSize, uint* RequiredSize);
BOOL SetupDiGetDeviceInstanceIdW(HDEVINFO DeviceInfoSet, SP_DEVINFO_DATA* DeviceInfoData, PWSTR DeviceInstanceId, uint DeviceInstanceIdSize, uint* RequiredSize);
...
BOOL SetupDiEnumDeviceInterfaces(HDEVINFO DeviceInfoSet, SP_DEVINFO_DATA* DeviceInfoData, const(GUID)* InterfaceClassGuid, uint MemberIndex, SP_DEVICE_INTERFACE_DATA* DeviceInterfaceData);
BOOL SetupDiCreateDeviceInterfaceA(HDEVINFO DeviceInfoSet, SP_DEVINFO_DATA* DeviceInfoData, const(GUID)* InterfaceClassGuid, const(char)* ReferenceString, uint CreationFlags, SP_DEVICE_INTERFACE_DATA* DeviceInterfaceData);
BOOL SetupDiCreateDeviceInterfaceW(HDEVINFO DeviceInfoSet, SP_DEVINFO_DATA* DeviceInfoData, const(GUID)* InterfaceClassGuid, const(wchar)* ReferenceString, uint CreationFlags, SP_DEVICE_INTERFACE_DATA* DeviceInterfaceData);
BOOL SetupDiOpenDeviceInterfaceA(HDEVINFO DeviceInfoSet, const(char)* DevicePath, uint OpenFlags, SP_DEVICE_INTERFACE_DATA* DeviceInterfaceData);
BOOL SetupDiOpenDeviceInterfaceW(HDEVINFO DeviceInfoSet, const(wchar)* DevicePath, uint OpenFlags, SP_DEVICE_INTERFACE_DATA* DeviceInterfaceData);
BOOL SetupDiGetDeviceInterfaceAlias(HDEVINFO DeviceInfoSet, SP_DEVICE_INTERFACE_DATA* DeviceInterfaceData, const(GUID)* AliasInterfaceClassGuid, SP_DEVICE_INTERFACE_DATA* AliasDeviceInterfaceData);
...
BOOL SetupDiGetDeviceInterfaceDetailA(HDEVINFO DeviceInfoSet, SP_DEVICE_INTERFACE_DATA* DeviceInterfaceData, SP_DEVICE_INTERFACE_DETAIL_DATA_A* DeviceInterfaceDetailData, uint DeviceInterfaceDetailDataSize, uint* RequiredSize, SP_DEVINFO_DATA* DeviceInfoData);
BOOL SetupDiGetDeviceInterfaceDetailW(HDEVINFO DeviceInfoSet, SP_DEVICE_INTERFACE_DATA* DeviceInterfaceData, SP_DEVICE_INTERFACE_DETAIL_DATA_W* DeviceInterfaceDetailData, uint DeviceInterfaceDetailDataSize, uint* RequiredSize, SP_DEVINFO_DATA* DeviceInfoData);
BOOL SetupDiInstallDeviceInterfaces(HDEVINFO DeviceInfoSet, SP_DEVINFO_DATA* DeviceInfoData);
BOOL SetupDiSetDeviceInterfaceDefault(HDEVINFO DeviceInfoSet, SP_DEVICE_INTERFACE_DATA* DeviceInterfaceData, uint Flags, void* Reserved);
BOOL SetupDiRegisterDeviceInfo(HDEVINFO DeviceInfoSet, SP_DEVINFO_DATA* DeviceInfoData, uint Flags, PSP_DETSIG_CMPPROC CompareProc, void* CompareContext, SP_DEVINFO_DATA* DupDeviceInfoData);
BOOL SetupDiBuildDriverInfoList(HDEVINFO DeviceInfoSet, SP_DEVINFO_DATA* DeviceInfoData, SETUP_DI_DRIVER_TYPE DriverType);
BOOL SetupDiCancelDriverInfoSearch(HDEVINFO DeviceInfoSet);
BOOL SetupDiEnumDriverInfoA(HDEVINFO DeviceInfoSet, SP_DEVINFO_DATA* DeviceInfoData, SETUP_DI_DRIVER_TYPE DriverType, uint MemberIndex, SP_DRVINFO_DATA_V2_A* DriverInfoData);
BOOL SetupDiEnumDriverInfoW(HDEVINFO DeviceInfoSet, SP_DEVINFO_DATA* DeviceInfoData, SETUP_DI_DRIVER_TYPE DriverType, uint MemberIndex, SP_DRVINFO_DATA_V2_W* DriverInfoData);
BOOL SetupDiGetSelectedDriverA(HDEVINFO DeviceInfoSet, SP_DEVINFO_DATA* DeviceInfoData, SP_DRVINFO_DATA_V2_A* DriverInfoData);
BOOL SetupDiGetSelectedDriverW(HDEVINFO DeviceInfoSet, SP_DEVINFO_DATA* DeviceInfoData, SP_DRVINFO_DATA_V2_W* DriverInfoData);
BOOL SetupDiSetSelectedDriverA(HDEVINFO DeviceInfoSet, SP_DEVINFO_DATA* DeviceInfoData, SP_DRVINFO_DATA_V2_A* DriverInfoData);
BOOL SetupDiSetSelectedDriverW(HDEVINFO DeviceInfoSet, SP_DEVINFO_DATA* DeviceInfoData, SP_DRVINFO_DATA_V2_W* DriverInfoData);
BOOL SetupDiGetDriverInfoDetailA(HDEVINFO DeviceInfoSet, SP_DEVINFO_DATA* DeviceInfoData, SP_DRVINFO_DATA_V2_A* DriverInfoData, SP_DRVINFO_DETAIL_DATA_A* DriverInfoDetailData, uint DriverInfoDetailDataSize, uint* RequiredSize);
BOOL SetupDiGetDriverInfoDetailW(HDEVINFO DeviceInfoSet, SP_DEVINFO_DATA* DeviceInfoData, SP_DRVINFO_DATA_V2_W* DriverInfoData, SP_DRVINFO_DETAIL_DATA_W* DriverInfoDetailData, uint DriverInfoDetailDataSize, uint* RequiredSize);
BOOL SetupDiDestroyDriverInfoList(HDEVINFO DeviceInfoSet, SP_DEVINFO_DATA* DeviceInfoData, SETUP_DI_DRIVER_TYPE DriverType);
HDEVINFO SetupDiGetClassDevsA(const(GUID)* ClassGuid, const(char)* Enumerator, HWND hwndParent, SETUP_DI_GET_CLASS_DEVS_FLAGS Flags);
HDEVINFO SetupDiGetClassDevsW(const(GUID)* ClassGuid, const(wchar)* Enumerator, HWND hwndParent, SETUP_DI_GET_CLASS_DEVS_FLAGS Flags);
HDEVINFO SetupDiGetClassDevsExA(const(GUID)* ClassGuid, const(char)* Enumerator, HWND hwndParent, SETUP_DI_GET_CLASS_DEVS_FLAGS Flags, HDEVINFO DeviceInfoSet, const(char)* MachineName, void* Reserved);
HDEVINFO SetupDiGetClassDevsExW(const(GUID)* ClassGuid, const(wchar)* Enumerator, HWND hwndParent, SETUP_DI_GET_CLASS_DEVS_FLAGS Flags, HDEVINFO DeviceInfoSet, const(wchar)* MachineName, void* Reserved);
BOOL SetupDiGetINFClassA(const(char)* InfName, GUID* ClassGuid, PSTR ClassName, uint ClassNameSize, uint* RequiredSize);
BOOL SetupDiGetINFClassW(const(wchar)* InfName, GUID* ClassGuid, PWSTR ClassName, uint ClassNameSize, uint* RequiredSize);
BOOL SetupDiBuildClassInfoList(uint Flags, GUID* ClassGuidList, uint ClassGuidListSize, uint* RequiredSize);
BOOL SetupDiBuildClassInfoListExA(uint Flags, GUID* ClassGuidList, uint ClassGuidListSize, uint* RequiredSize, const(char)* MachineName, void* Reserved);
BOOL SetupDiBuildClassInfoListExW(uint Flags, GUID* ClassGuidList, uint ClassGuidListSize, uint* RequiredSize, const(wchar)* MachineName, void* Reserved);
BOOL SetupDiGetClassDescriptionA(const(GUID)* ClassGuid, PSTR ClassDescription, uint ClassDescriptionSize, uint* RequiredSize);
BOOL SetupDiGetClassDescriptionW(const(GUID)* ClassGuid, PWSTR ClassDescription, uint ClassDescriptionSize, uint* RequiredSize);
BOOL SetupDiGetClassDescriptionExA(const(GUID)* ClassGuid, PSTR ClassDescription, uint ClassDescriptionSize, uint* RequiredSize, const(char)* MachineName, void* Reserved);
BOOL SetupDiGetClassDescriptionExW(const(GUID)* ClassGuid, PWSTR ClassDescription, uint ClassDescriptionSize, uint* RequiredSize, const(wchar)* MachineName, void* Reserved);
...
HKEY SetupDiCreateDeviceInterfaceRegKeyA(HDEVINFO DeviceInfoSet, SP_DEVICE_INTERFACE_DATA* DeviceInterfaceData, uint Reserved, uint samDesired, void* InfHandle, const(char)* InfSectionName);
HKEY SetupDiCreateDeviceInterfaceRegKeyW(HDEVINFO DeviceInfoSet, SP_DEVICE_INTERFACE_DATA* DeviceInterfaceData, uint Reserved, uint samDesired, void* InfHandle, const(wchar)* InfSectionName);
HKEY SetupDiOpenDeviceInterfaceRegKey(HDEVINFO DeviceInfoSet, SP_DEVICE_INTERFACE_DATA* DeviceInterfaceData, uint Reserved, uint samDesired);
BOOL SetupDiDeleteDeviceInterfaceRegKey(HDEVINFO DeviceInfoSet, SP_DEVICE_INTERFACE_DATA* DeviceInterfaceData, uint Reserved);
HKEY SetupDiCreateDevRegKeyA(HDEVINFO DeviceInfoSet, SP_DEVINFO_DATA* DeviceInfoData, uint Scope, uint HwProfile, uint KeyType, void* InfHandle, const(char)* InfSectionName);
HKEY SetupDiCreateDevRegKeyW(HDEVINFO DeviceInfoSet, SP_DEVINFO_DATA* DeviceInfoData, uint Scope, uint HwProfile, uint KeyType, void* InfHandle, const(wchar)* InfSectionName);
HKEY SetupDiOpenDevRegKey(HDEVINFO DeviceInfoSet, SP_DEVINFO_DATA* DeviceInfoData, uint Scope, uint HwProfile, uint KeyType, uint samDesired);
BOOL SetupDiDeleteDevRegKey(HDEVINFO DeviceInfoSet, SP_DEVINFO_DATA* DeviceInfoData, uint Scope, uint HwProfile, uint KeyType);
BOOL SetupDiGetHwProfileList(uint* HwProfileList, uint HwProfileListSize, uint* RequiredSize, uint* CurrentlyActiveIndex);
BOOL SetupDiGetHwProfileListExA(uint* HwProfileList, uint HwProfileListSize, uint* RequiredSize, uint* CurrentlyActiveIndex, const(char)* MachineName, void* Reserved);
BOOL SetupDiGetHwProfileListExW(uint* HwProfileList, uint HwProfileListSize, uint* RequiredSize, uint* CurrentlyActiveIndex, const(wchar)* MachineName, void* Reserved);
BOOL SetupDiGetDevicePropertyKeys(HDEVINFO DeviceInfoSet, SP_DEVINFO_DATA* DeviceInfoData, DEVPROPKEY* PropertyKeyArray, uint PropertyKeyCount, uint* RequiredPropertyKeyCount, uint Flags);
BOOL SetupDiGetDevicePropertyW(HDEVINFO DeviceInfoSet, SP_DEVINFO_DATA* DeviceInfoData, const(DEVPROPKEY)* PropertyKey, DEVPROPTYPE* PropertyType, ubyte* PropertyBuffer, uint PropertyBufferSize, uint* RequiredSize, uint Flags);
BOOL SetupDiSetDevicePropertyW(HDEVINFO DeviceInfoSet, SP_DEVINFO_DATA* DeviceInfoData, const(DEVPROPKEY)* PropertyKey, DEVPROPTYPE PropertyType, const(ubyte)* PropertyBuffer, uint PropertyBufferSize, uint Flags);
BOOL SetupDiGetDeviceInterfacePropertyKeys(HDEVINFO DeviceInfoSet, SP_DEVICE_INTERFACE_DATA* DeviceInterfaceData, DEVPROPKEY* PropertyKeyArray, uint PropertyKeyCount, uint* RequiredPropertyKeyCount, uint Flags);
BOOL SetupDiGetDeviceInterfacePropertyW(HDEVINFO DeviceInfoSet, SP_DEVICE_INTERFACE_DATA* DeviceInterfaceData, const(DEVPROPKEY)* PropertyKey, DEVPROPTYPE* PropertyType, ubyte* PropertyBuffer, uint PropertyBufferSize, uint* RequiredSize, uint Flags);
BOOL SetupDiSetDeviceInterfacePropertyW(HDEVINFO DeviceInfoSet, SP_DEVICE_INTERFACE_DATA* DeviceInterfaceData, const(DEVPROPKEY)* PropertyKey, DEVPROPTYPE PropertyType, const(ubyte)* PropertyBuffer, uint PropertyBufferSize, uint Flags);
BOOL SetupDiGetClassPropertyKeys(const(GUID)* ClassGuid, DEVPROPKEY* PropertyKeyArray, uint PropertyKeyCount, uint* RequiredPropertyKeyCount, uint Flags);
BOOL SetupDiGetClassPropertyKeysExW(const(GUID)* ClassGuid, DEVPROPKEY* PropertyKeyArray, uint PropertyKeyCount, uint* RequiredPropertyKeyCount, uint Flags, const(wchar)* MachineName, void* Reserved);
BOOL SetupDiGetClassPropertyW(const(GUID)* ClassGuid, const(DEVPROPKEY)* PropertyKey, DEVPROPTYPE* PropertyType, ubyte* PropertyBuffer, uint PropertyBufferSize, uint* RequiredSize, uint Flags);
BOOL SetupDiGetClassPropertyExW(const(GUID)* ClassGuid, const(DEVPROPKEY)* PropertyKey, DEVPROPTYPE* PropertyType, ubyte* PropertyBuffer, uint PropertyBufferSize, uint* RequiredSize, uint Flags, const(wchar)* MachineName, void* Reserved);
BOOL SetupDiSetClassPropertyW(const(GUID)* ClassGuid, const(DEVPROPKEY)* PropertyKey, DEVPROPTYPE PropertyType, const(ubyte)* PropertyBuffer, uint PropertyBufferSize, uint Flags);
BOOL SetupDiSetClassPropertyExW(const(GUID)* ClassGuid, const(DEVPROPKEY)* PropertyKey, DEVPROPTYPE PropertyType, const(ubyte)* PropertyBuffer, uint PropertyBufferSize, uint Flags, const(wchar)* MachineName, void* Reserved);
BOOL SetupDiGetDeviceRegistryPropertyA(HDEVINFO DeviceInfoSet, SP_DEVINFO_DATA* DeviceInfoData, SETUP_DI_REGISTRY_PROPERTY Property, uint* PropertyRegDataType, ubyte* PropertyBuffer, uint PropertyBufferSize, uint* RequiredSize);
BOOL SetupDiGetDeviceRegistryPropertyW(HDEVINFO DeviceInfoSet, SP_DEVINFO_DATA* DeviceInfoData, SETUP_DI_REGISTRY_PROPERTY Property, uint* PropertyRegDataType, ubyte* PropertyBuffer, uint PropertyBufferSize, uint* RequiredSize);
BOOL SetupDiGetClassRegistryPropertyA(const(GUID)* ClassGuid, uint Property, uint* PropertyRegDataType, ubyte* PropertyBuffer, uint PropertyBufferSize, uint* RequiredSize, const(char)* MachineName, void* Reserved);
BOOL SetupDiGetClassRegistryPropertyW(const(GUID)* ClassGuid, uint Property, uint* PropertyRegDataType, ubyte* PropertyBuffer, uint PropertyBufferSize, uint* RequiredSize, const(wchar)* MachineName, void* Reserved);
BOOL SetupDiSetDeviceRegistryPropertyA(HDEVINFO DeviceInfoSet, SP_DEVINFO_DATA* DeviceInfoData, SETUP_DI_REGISTRY_PROPERTY Property, const(ubyte)* PropertyBuffer, uint PropertyBufferSize);
BOOL SetupDiSetDeviceRegistryPropertyW(HDEVINFO DeviceInfoSet, SP_DEVINFO_DATA* DeviceInfoData, SETUP_DI_REGISTRY_PROPERTY Property, const(ubyte)* PropertyBuffer, uint PropertyBufferSize);
BOOL SetupDiSetClassRegistryPropertyA(const(GUID)* ClassGuid, uint Property, const(ubyte)* PropertyBuffer, uint PropertyBufferSize, const(char)* MachineName, void* Reserved);
BOOL SetupDiSetClassRegistryPropertyW(const(GUID)* ClassGuid, uint Property, const(ubyte)* PropertyBuffer, uint PropertyBufferSize, const(wchar)* MachineName, void* Reserved);
BOOL SetupDiGetDeviceInstallParamsA(HDEVINFO DeviceInfoSet, SP_DEVINFO_DATA* DeviceInfoData, SP_DEVINSTALL_PARAMS_A* DeviceInstallParams);
BOOL SetupDiGetDeviceInstallParamsW(HDEVINFO DeviceInfoSet, SP_DEVINFO_DATA* DeviceInfoData, SP_DEVINSTALL_PARAMS_W* DeviceInstallParams);
BOOL SetupDiGetClassInstallParamsA(HDEVINFO DeviceInfoSet, SP_DEVINFO_DATA* DeviceInfoData, SP_CLASSINSTALL_HEADER* ClassInstallParams, uint ClassInstallParamsSize, uint* RequiredSize);
BOOL SetupDiGetClassInstallParamsW(HDEVINFO DeviceInfoSet, SP_DEVINFO_DATA* DeviceInfoData, SP_CLASSINSTALL_HEADER* ClassInstallParams, uint ClassInstallParamsSize, uint* RequiredSize);
BOOL SetupDiSetDeviceInstallParamsA(HDEVINFO DeviceInfoSet, SP_DEVINFO_DATA* DeviceInfoData, SP_DEVINSTALL_PARAMS_A* DeviceInstallParams);
BOOL SetupDiSetDeviceInstallParamsW(HDEVINFO DeviceInfoSet, SP_DEVINFO_DATA* DeviceInfoData, SP_DEVINSTALL_PARAMS_W* DeviceInstallParams);
BOOL SetupDiSetClassInstallParamsA(HDEVINFO DeviceInfoSet, SP_DEVINFO_DATA* DeviceInfoData, SP_CLASSINSTALL_HEADER* ClassInstallParams, uint ClassInstallParamsSize);
BOOL SetupDiSetClassInstallParamsW(HDEVINFO DeviceInfoSet, SP_DEVINFO_DATA* DeviceInfoData, SP_CLASSINSTALL_HEADER* ClassInstallParams, uint ClassInstallParamsSize);
BOOL SetupDiGetDriverInstallParamsA(HDEVINFO DeviceInfoSet, SP_DEVINFO_DATA* DeviceInfoData, SP_DRVINFO_DATA_V2_A* DriverInfoData, SP_DRVINSTALL_PARAMS* DriverInstallParams);
BOOL SetupDiGetDriverInstallParamsW(HDEVINFO DeviceInfoSet, SP_DEVINFO_DATA* DeviceInfoData, SP_DRVINFO_DATA_V2_W* DriverInfoData, SP_DRVINSTALL_PARAMS* DriverInstallParams);
BOOL SetupDiSetDriverInstallParamsA(HDEVINFO DeviceInfoSet, SP_DEVINFO_DATA* DeviceInfoData, SP_DRVINFO_DATA_V2_A* DriverInfoData, SP_DRVINSTALL_PARAMS* DriverInstallParams);
BOOL SetupDiSetDriverInstallParamsW(HDEVINFO DeviceInfoSet, SP_DEVINFO_DATA* DeviceInfoData, SP_DRVINFO_DATA_V2_W* DriverInfoData, SP_DRVINSTALL_PARAMS* DriverInstallParams);
BOOL SetupDiLoadClassIcon(const(GUID)* ClassGuid, HICON* LargeIcon, int* MiniIconIndex);
BOOL SetupDiLoadDeviceIcon(HDEVINFO DeviceInfoSet, SP_DEVINFO_DATA* DeviceInfoData, uint cxIcon, uint cyIcon, uint Flags, HICON* hIcon);
...
BOOL SetupDiGetClassDevPropertySheetsA(HDEVINFO DeviceInfoSet, SP_DEVINFO_DATA* DeviceInfoData, PROPSHEETHEADERA_V2* PropertySheetHeader, uint PropertySheetHeaderPageListSize, uint* RequiredSize, uint PropertySheetType);
BOOL SetupDiGetClassDevPropertySheetsW(HDEVINFO DeviceInfoSet, SP_DEVINFO_DATA* DeviceInfoData, PROPSHEETHEADERW_V2* PropertySheetHeader, uint PropertySheetHeaderPageListSize, uint* RequiredSize, uint PropertySheetType);
...
BOOL SetupDiClassNameFromGuidExA(const(GUID)* ClassGuid, PSTR ClassName, uint ClassNameSize, uint* RequiredSize, const(char)* MachineName, void* Reserved);
BOOL SetupDiClassNameFromGuidExW(const(GUID)* ClassGuid, PWSTR ClassName, uint ClassNameSize, uint* RequiredSize, const(wchar)* MachineName, void* Reserved);
BOOL SetupDiClassGuidsFromNameA(const(char)* ClassName, GUID* ClassGuidList, uint ClassGuidListSize, uint* RequiredSize);
BOOL SetupDiClassGuidsFromNameW(const(wchar)* ClassName, GUID* ClassGuidList, uint ClassGuidListSize, uint* RequiredSize);
BOOL SetupDiClassGuidsFromNameExA(const(char)* ClassName, GUID* ClassGuidList, uint ClassGuidListSize, uint* RequiredSize, const(char)* MachineName, void* Reserved);
BOOL SetupDiClassGuidsFromNameExW(const(wchar)* ClassName, GUID* ClassGuidList, uint ClassGuidListSize, uint* RequiredSize, const(wchar)* MachineName, void* Reserved);
BOOL SetupDiGetHwProfileFriendlyNameA(uint HwProfile, PSTR FriendlyName, uint FriendlyNameSize, uint* RequiredSize);
BOOL SetupDiGetHwProfileFriendlyNameW(uint HwProfile, PWSTR FriendlyName, uint FriendlyNameSize, uint* RequiredSize);
BOOL SetupDiGetHwProfileFriendlyNameExA(uint HwProfile, PSTR FriendlyName, uint FriendlyNameSize, uint* RequiredSize, const(char)* MachineName, void* Reserved);
BOOL SetupDiGetHwProfileFriendlyNameExW(uint HwProfile, PWSTR FriendlyName, uint FriendlyNameSize, uint* RequiredSize, const(wchar)* MachineName, void* Reserved);
HPROPSHEETPAGE SetupDiGetWizardPage(HDEVINFO DeviceInfoSet, SP_DEVINFO_DATA* DeviceInfoData, SP_INSTALLWIZARD_DATA* InstallWizardData, uint PageType, uint Flags);
...
BOOL SetupDiGetActualModelsSectionA(INFCONTEXT* Context, SP_ALTPLATFORM_INFO_V2* AlternatePlatformInfo, PSTR InfSectionWithExt, uint InfSectionWithExtSize, uint* RequiredSize, void* Reserved);
BOOL SetupDiGetActualModelsSectionW(INFCONTEXT* Context, SP_ALTPLATFORM_INFO_V2* AlternatePlatformInfo, PWSTR InfSectionWithExt, uint InfSectionWithExtSize, uint* RequiredSize, void* Reserved);
BOOL SetupDiGetActualSectionToInstallA(void* InfHandle, const(char)* InfSectionName, PSTR InfSectionWithExt, uint InfSectionWithExtSize, uint* RequiredSize, PSTR* Extension);
BOOL SetupDiGetActualSectionToInstallW(void* InfHandle, const(wchar)* InfSectionName, PWSTR InfSectionWithExt, uint InfSectionWithExtSize, uint* RequiredSize, PWSTR* Extension);
BOOL SetupDiGetActualSectionToInstallExA(void* InfHandle, const(char)* InfSectionName, SP_ALTPLATFORM_INFO_V2* AlternatePlatformInfo, PSTR InfSectionWithExt, uint InfSectionWithExtSize, uint* RequiredSize, PSTR* Extension, void* Reserved);
BOOL SetupDiGetActualSectionToInstallExW(void* InfHandle, const(wchar)* InfSectionName, SP_ALTPLATFORM_INFO_V2* AlternatePlatformInfo, PWSTR InfSectionWithExt, uint InfSectionWithExtSize, uint* RequiredSize, PWSTR* Extension, void* Reserved);
...
BOOL SetupDiGetCustomDevicePropertyA(HDEVINFO DeviceInfoSet, SP_DEVINFO_DATA* DeviceInfoData, const(char)* CustomPropertyName, uint Flags, uint* PropertyRegDataType, ubyte* PropertyBuffer, uint PropertyBufferSize, uint* RequiredSize);
BOOL SetupDiGetCustomDevicePropertyW(HDEVINFO DeviceInfoSet, SP_DEVINFO_DATA* DeviceInfoData, const(wchar)* CustomPropertyName, uint Flags, uint* PropertyRegDataType, ubyte* PropertyBuffer, uint PropertyBufferSize, uint* RequiredSize);
...
CONFIGRET CM_Add_Empty_Log_Conf(ulong* plcLogConf, uint dnDevInst, PRIORITY Priority, uint ulFlags);
CONFIGRET CM_Add_Empty_Log_Conf_Ex(ulong* plcLogConf, uint dnDevInst, PRIORITY Priority, uint ulFlags, long hMachine);
CONFIGRET CM_Add_IDA(uint dnDevInst, PSTR pszID, uint ulFlags);
CONFIGRET CM_Add_IDW(uint dnDevInst, PWSTR pszID, uint ulFlags);
CONFIGRET CM_Add_ID_ExA(uint dnDevInst, PSTR pszID, uint ulFlags, long hMachine);
CONFIGRET CM_Add_ID_ExW(uint dnDevInst, PWSTR pszID, uint ulFlags, long hMachine);
CONFIGRET CM_Add_Range(ulong ullStartValue, ulong ullEndValue, ulong rlh, uint ulFlags);
CONFIGRET CM_Add_Res_Des(ulong* prdResDes, ulong lcLogConf, uint ResourceID, void* ResourceData, uint ResourceLen, uint ulFlags);
CONFIGRET CM_Add_Res_Des_Ex(ulong* prdResDes, ulong lcLogConf, uint ResourceID, void* ResourceData, uint ResourceLen, uint ulFlags, long hMachine);
CONFIGRET CM_Connect_MachineA(const(char)* UNCServerName, long* phMachine);
CONFIGRET CM_Connect_MachineW(const(wchar)* UNCServerName, long* phMachine);
...
CONFIGRET CM_Create_DevNode_ExA(uint* pdnDevInst, PSTR pDeviceID, uint dnParent, uint ulFlags, long hMachine);
CONFIGRET CM_Create_DevNode_ExW(uint* pdnDevInst, PWSTR pDeviceID, uint dnParent, uint ulFlags, long hMachine);
CONFIGRET CM_Create_Range_List(ulong* prlh, uint ulFlags);
CONFIGRET CM_Delete_Class_Key(GUID* ClassGuid, uint ulFlags);
CONFIGRET CM_Delete_Class_Key_Ex(GUID* ClassGuid, uint ulFlags, long hMachine);
CONFIGRET CM_Delete_DevNode_Key(uint dnDevNode, uint ulHardwareProfile, uint ulFlags);
CONFIGRET CM_Delete_DevNode_Key_Ex(uint dnDevNode, uint ulHardwareProfile, uint ulFlags, long hMachine);
CONFIGRET CM_Delete_Range(ulong ullStartValue, ulong ullEndValue, ulong rlh, uint ulFlags);
CONFIGRET CM_Detect_Resource_Conflict(uint dnDevInst, uint ResourceID, void* ResourceData, uint ResourceLen, BOOL* pbConflictDetected, uint ulFlags);
CONFIGRET CM_Detect_Resource_Conflict_Ex(uint dnDevInst, uint ResourceID, void* ResourceData, uint ResourceLen, BOOL* pbConflictDetected, uint ulFlags, long hMachine);
CONFIGRET CM_Disable_DevNode(uint dnDevInst, uint ulFlags);
CONFIGRET CM_Disable_DevNode_Ex(uint dnDevInst, uint ulFlags, long hMachine);
CONFIGRET CM_Disconnect_Machine(long hMachine);
CONFIGRET CM_Dup_Range_List(ulong rlhOld, ulong rlhNew, uint ulFlags);
CONFIGRET CM_Enable_DevNode(uint dnDevInst, uint ulFlags);
CONFIGRET CM_Enable_DevNode_Ex(uint dnDevInst, uint ulFlags, long hMachine);
CONFIGRET CM_Enumerate_Classes(uint ulClassIndex, GUID* ClassGuid, CM_ENUMERATE_FLAGS ulFlags);
CONFIGRET CM_Enumerate_Classes_Ex(uint ulClassIndex, GUID* ClassGuid, CM_ENUMERATE_FLAGS ulFlags, long hMachine);
...
CONFIGRET CM_Enumerate_Enumerators_ExA(uint ulEnumIndex, PSTR Buffer, uint* pulLength, uint ulFlags, long hMachine);
CONFIGRET CM_Enumerate_Enumerators_ExW(uint ulEnumIndex, PWSTR Buffer, uint* pulLength, uint ulFlags, long hMachine);
CONFIGRET CM_Find_Range(ulong* pullStart, ulong ullStart, uint ulLength, ulong ullAlignment, ulong ullEnd, ulong rlh, uint ulFlags);
CONFIGRET CM_First_Range(ulong rlh, ulong* pullStart, ulong* pullEnd, ulong* preElement, uint ulFlags);
CONFIGRET CM_Free_Log_Conf(ulong lcLogConfToBeFreed, uint ulFlags);
CONFIGRET CM_Free_Log_Conf_Ex(ulong lcLogConfToBeFreed, uint ulFlags, long hMachine);
CONFIGRET CM_Free_Log_Conf_Handle(ulong lcLogConf);
CONFIGRET CM_Free_Range_List(ulong rlh, uint ulFlags);
CONFIGRET CM_Free_Res_Des(ulong* prdResDes, ulong rdResDes, uint ulFlags);
CONFIGRET CM_Free_Res_Des_Ex(ulong* prdResDes, ulong rdResDes, uint ulFlags, long hMachine);
CONFIGRET CM_Free_Res_Des_Handle(ulong rdResDes);
CONFIGRET CM_Get_Child(uint* pdnDevInst, uint dnDevInst, uint ulFlags);
CONFIGRET CM_Get_Child_Ex(uint* pdnDevInst, uint dnDevInst, uint ulFlags, long hMachine);
...
CONFIGRET CM_Get_Class_Name_ExA(GUID* ClassGuid, PSTR Buffer, uint* pulLength, uint ulFlags, long hMachine);
CONFIGRET CM_Get_Class_Name_ExW(GUID* ClassGuid, PWSTR Buffer, uint* pulLength, uint ulFlags, long hMachine);
...
CONFIGRET CM_Get_Class_Key_Name_ExA(GUID* ClassGuid, PSTR pszKeyName, uint* pulLength, uint ulFlags, long hMachine);
CONFIGRET CM_Get_Class_Key_Name_ExW(GUID* ClassGuid, PWSTR pszKeyName, uint* pulLength, uint ulFlags, long hMachine);
CONFIGRET CM_Get_Depth(uint* pulDepth, uint dnDevInst, uint ulFlags);
CONFIGRET CM_Get_Depth_Ex(uint* pulDepth, uint dnDevInst, uint ulFlags, long hMachine);
...
CONFIGRET CM_Get_Device_ID_ExA(uint dnDevInst, PSTR Buffer, uint BufferLen, uint ulFlags, long hMachine);
CONFIGRET CM_Get_Device_ID_ExW(uint dnDevInst, PWSTR Buffer, uint BufferLen, uint ulFlags, long hMachine);
CONFIGRET CM_Get_Device_ID_ListA(const(char)* pszFilter, PSTR Buffer, uint BufferLen, uint ulFlags);
CONFIGRET CM_Get_Device_ID_ListW(const(wchar)* pszFilter, PWSTR Buffer, uint BufferLen, uint ulFlags);
CONFIGRET CM_Get_Device_ID_List_ExA(const(char)* pszFilter, PSTR Buffer, uint BufferLen, uint ulFlags, long hMachine);
CONFIGRET CM_Get_Device_ID_List_ExW(const(wchar)* pszFilter, PWSTR Buffer, uint BufferLen, uint ulFlags, long hMachine);
CONFIGRET CM_Get_Device_ID_List_SizeA(uint* pulLen, const(char)* pszFilter, uint ulFlags);
CONFIGRET CM_Get_Device_ID_List_SizeW(uint* pulLen, const(wchar)* pszFilter, uint ulFlags);
CONFIGRET CM_Get_Device_ID_List_Size_ExA(uint* pulLen, const(char)* pszFilter, uint ulFlags, long hMachine);
CONFIGRET CM_Get_Device_ID_List_Size_ExW(uint* pulLen, const(wchar)* pszFilter, uint ulFlags, long hMachine);
CONFIGRET CM_Get_Device_ID_Size(uint* pulLen, uint dnDevInst, uint ulFlags);
CONFIGRET CM_Get_Device_ID_Size_Ex(uint* pulLen, uint dnDevInst, uint ulFlags, long hMachine);
CONFIGRET CM_Get_DevNode_PropertyW(uint dnDevInst, const(DEVPROPKEY)* PropertyKey, DEVPROPTYPE* PropertyType, ubyte* PropertyBuffer, uint* PropertyBufferSize, uint ulFlags);
CONFIGRET CM_Get_DevNode_Property_ExW(uint dnDevInst, const(DEVPROPKEY)* PropertyKey, DEVPROPTYPE* PropertyType, ubyte* PropertyBuffer, uint* PropertyBufferSize, uint ulFlags, long hMachine);
CONFIGRET CM_Get_DevNode_Property_Keys(uint dnDevInst, DEVPROPKEY* PropertyKeyArray, uint* PropertyKeyCount, uint ulFlags);
CONFIGRET CM_Get_DevNode_Property_Keys_Ex(uint dnDevInst, DEVPROPKEY* PropertyKeyArray, uint* PropertyKeyCount, uint ulFlags, long hMachine);
CONFIGRET CM_Get_DevNode_Registry_PropertyA(uint dnDevInst, uint ulProperty, uint* pulRegDataType, void* Buffer, uint* pulLength, uint ulFlags);
CONFIGRET CM_Get_DevNode_Registry_PropertyW(uint dnDevInst, uint ulProperty, uint* pulRegDataType, void* Buffer, uint* pulLength, uint ulFlags);
CONFIGRET CM_Get_DevNode_Registry_Property_ExA(uint dnDevInst, uint ulProperty, uint* pulRegDataType, void* Buffer, uint* pulLength, uint ulFlags, long hMachine);
CONFIGRET CM_Get_DevNode_Registry_Property_ExW(uint dnDevInst, uint ulProperty, uint* pulRegDataType, void* Buffer, uint* pulLength, uint ulFlags, long hMachine);
CONFIGRET CM_Get_DevNode_Custom_PropertyA(uint dnDevInst, const(char)* pszCustomPropertyName, uint* pulRegDataType, void* Buffer, uint* pulLength, uint ulFlags);
CONFIGRET CM_Get_DevNode_Custom_PropertyW(uint dnDevInst, const(wchar)* pszCustomPropertyName, uint* pulRegDataType, void* Buffer, uint* pulLength, uint ulFlags);
CONFIGRET CM_Get_DevNode_Custom_Property_ExA(uint dnDevInst, const(char)* pszCustomPropertyName, uint* pulRegDataType, void* Buffer, uint* pulLength, uint ulFlags, long hMachine);
CONFIGRET CM_Get_DevNode_Custom_Property_ExW(uint dnDevInst, const(wchar)* pszCustomPropertyName, uint* pulRegDataType, void* Buffer, uint* pulLength, uint ulFlags, long hMachine);
CONFIGRET CM_Get_DevNode_Status(CM_DEVNODE_STATUS_FLAGS* pulStatus, CM_PROB* pulProblemNumber, uint dnDevInst, uint ulFlags);
CONFIGRET CM_Get_DevNode_Status_Ex(CM_DEVNODE_STATUS_FLAGS* pulStatus, CM_PROB* pulProblemNumber, uint dnDevInst, uint ulFlags, long hMachine);
CONFIGRET CM_Get_First_Log_Conf(ulong* plcLogConf, uint dnDevInst, CM_LOG_CONF ulFlags);
CONFIGRET CM_Get_First_Log_Conf_Ex(ulong* plcLogConf, uint dnDevInst, CM_LOG_CONF ulFlags, long hMachine);
CONFIGRET CM_Get_Global_State(uint* pulState, uint ulFlags);
CONFIGRET CM_Get_Global_State_Ex(uint* pulState, uint ulFlags, long hMachine);
CONFIGRET CM_Get_Hardware_Profile_InfoA(uint ulIndex, HWPROFILEINFO_A* pHWProfileInfo, uint ulFlags);
CONFIGRET CM_Get_Hardware_Profile_Info_ExA(uint ulIndex, HWPROFILEINFO_A* pHWProfileInfo, uint ulFlags, long hMachine);
CONFIGRET CM_Get_Hardware_Profile_InfoW(uint ulIndex, HWPROFILEINFO_W* pHWProfileInfo, uint ulFlags);
CONFIGRET CM_Get_Hardware_Profile_Info_ExW(uint ulIndex, HWPROFILEINFO_W* pHWProfileInfo, uint ulFlags, long hMachine);
...
CONFIGRET CM_Get_HW_Prof_Flags_ExA(PSTR pDeviceID, uint ulHardwareProfile, uint* pulValue, uint ulFlags, long hMachine);
CONFIGRET CM_Get_HW_Prof_Flags_ExW(PWSTR pDeviceID, uint ulHardwareProfile, uint* pulValue, uint ulFlags, long hMachine);
CONFIGRET CM_Get_Device_Interface_AliasA(const(char)* pszDeviceInterface, GUID* AliasInterfaceGuid, PSTR pszAliasDeviceInterface, uint* pulLength, uint ulFlags);
CONFIGRET CM_Get_Device_Interface_AliasW(const(wchar)* pszDeviceInterface, GUID* AliasInterfaceGuid, PWSTR pszAliasDeviceInterface, uint* pulLength, uint ulFlags);
CONFIGRET CM_Get_Device_Interface_Alias_ExA(const(char)* pszDeviceInterface, GUID* AliasInterfaceGuid, PSTR pszAliasDeviceInterface, uint* pulLength, uint ulFlags, long hMachine);
CONFIGRET CM_Get_Device_Interface_Alias_ExW(const(wchar)* pszDeviceInterface, GUID* AliasInterfaceGuid, PWSTR pszAliasDeviceInterface, uint* pulLength, uint ulFlags, long hMachine);
CONFIGRET CM_Get_Device_Interface_ListA(GUID* InterfaceClassGuid, PSTR pDeviceID, PSTR Buffer, uint BufferLen, CM_GET_DEVICE_INTERFACE_LIST_FLAGS ulFlags);
CONFIGRET CM_Get_Device_Interface_ListW(GUID* InterfaceClassGuid, PWSTR pDeviceID, PWSTR Buffer, uint BufferLen, CM_GET_DEVICE_INTERFACE_LIST_FLAGS ulFlags);
CONFIGRET CM_Get_Device_Interface_List_ExA(GUID* InterfaceClassGuid, PSTR pDeviceID, PSTR Buffer, uint BufferLen, CM_GET_DEVICE_INTERFACE_LIST_FLAGS ulFlags, long hMachine);
CONFIGRET CM_Get_Device_Interface_List_ExW(GUID* InterfaceClassGuid, PWSTR pDeviceID, PWSTR Buffer, uint BufferLen, CM_GET_DEVICE_INTERFACE_LIST_FLAGS ulFlags, long hMachine);
CONFIGRET CM_Get_Device_Interface_List_SizeA(uint* pulLen, GUID* InterfaceClassGuid, PSTR pDeviceID, CM_GET_DEVICE_INTERFACE_LIST_FLAGS ulFlags);
CONFIGRET CM_Get_Device_Interface_List_SizeW(uint* pulLen, GUID* InterfaceClassGuid, PWSTR pDeviceID, CM_GET_DEVICE_INTERFACE_LIST_FLAGS ulFlags);
CONFIGRET CM_Get_Device_Interface_List_Size_ExA(uint* pulLen, GUID* InterfaceClassGuid, PSTR pDeviceID, CM_GET_DEVICE_INTERFACE_LIST_FLAGS ulFlags, long hMachine);
CONFIGRET CM_Get_Device_Interface_List_Size_ExW(uint* pulLen, GUID* InterfaceClassGuid, PWSTR pDeviceID, CM_GET_DEVICE_INTERFACE_LIST_FLAGS ulFlags, long hMachine);
CONFIGRET CM_Get_Device_Interface_PropertyW(const(wchar)* pszDeviceInterface, const(DEVPROPKEY)* PropertyKey, DEVPROPTYPE* PropertyType, ubyte* PropertyBuffer, uint* PropertyBufferSize, uint ulFlags);
CONFIGRET CM_Get_Device_Interface_Property_ExW(const(wchar)* pszDeviceInterface, const(DEVPROPKEY)* PropertyKey, DEVPROPTYPE* PropertyType, ubyte* PropertyBuffer, uint* PropertyBufferSize, uint ulFlags, long hMachine);
CONFIGRET CM_Get_Device_Interface_Property_KeysW(const(wchar)* pszDeviceInterface, DEVPROPKEY* PropertyKeyArray, uint* PropertyKeyCount, uint ulFlags);
CONFIGRET CM_Get_Device_Interface_Property_Keys_ExW(const(wchar)* pszDeviceInterface, DEVPROPKEY* PropertyKeyArray, uint* PropertyKeyCount, uint ulFlags, long hMachine);
CONFIGRET CM_Get_Log_Conf_Priority(ulong lcLogConf, uint* pPriority, uint ulFlags);
CONFIGRET CM_Get_Log_Conf_Priority_Ex(ulong lcLogConf, uint* pPriority, uint ulFlags, long hMachine);
CONFIGRET CM_Get_Next_Log_Conf(ulong* plcLogConf, ulong lcLogConf, uint ulFlags);
CONFIGRET CM_Get_Next_Log_Conf_Ex(ulong* plcLogConf, ulong lcLogConf, uint ulFlags, long hMachine);
CONFIGRET CM_Get_Parent(uint* pdnDevInst, uint dnDevInst, uint ulFlags);
CONFIGRET CM_Get_Parent_Ex(uint* pdnDevInst, uint dnDevInst, uint ulFlags, long hMachine);
CONFIGRET CM_Get_Res_Des_Data(ulong rdResDes, void* Buffer, uint BufferLen, uint ulFlags);
CONFIGRET CM_Get_Res_Des_Data_Ex(ulong rdResDes, void* Buffer, uint BufferLen, uint ulFlags, long hMachine);
CONFIGRET CM_Get_Res_Des_Data_Size(uint* pulSize, ulong rdResDes, uint ulFlags);
CONFIGRET CM_Get_Res_Des_Data_Size_Ex(uint* pulSize, ulong rdResDes, uint ulFlags, long hMachine);
CONFIGRET CM_Get_Sibling(uint* pdnDevInst, uint dnDevInst, uint ulFlags);
CONFIGRET CM_Get_Sibling_Ex(uint* pdnDevInst, uint dnDevInst, uint ulFlags, long hMachine);
ushort CM_Get_Version();
ushort CM_Get_Version_Ex(long hMachine);
BOOL CM_Is_Version_Available(ushort wVersion);
BOOL CM_Is_Version_Available_Ex(ushort wVersion, long hMachine);
CONFIGRET CM_Intersect_Range_List(ulong rlhOld1, ulong rlhOld2, ulong rlhNew, uint ulFlags);
CONFIGRET CM_Invert_Range_List(ulong rlhOld, ulong rlhNew, ulong ullMaxValue, uint ulFlags);
...
CONFIGRET CM_Locate_DevNode_ExA(uint* pdnDevInst, PSTR pDeviceID, uint ulFlags, long hMachine);
CONFIGRET CM_Locate_DevNode_ExW(uint* pdnDevInst, PWSTR pDeviceID, uint ulFlags, long hMachine);
CONFIGRET CM_Merge_Range_List(ulong rlhOld1, ulong rlhOld2, ulong rlhNew, uint ulFlags);
CONFIGRET CM_Modify_Res_Des(ulong* prdResDes, ulong rdResDes, uint ResourceID, void* ResourceData, uint ResourceLen, uint ulFlags);
CONFIGRET CM_Modify_Res_Des_Ex(ulong* prdResDes, ulong rdResDes, uint ResourceID, void* ResourceData, uint ResourceLen, uint ulFlags, long hMachine);
CONFIGRET CM_Move_DevNode(uint dnFromDevInst, uint dnToDevInst, uint ulFlags);
CONFIGRET CM_Move_DevNode_Ex(uint dnFromDevInst, uint dnToDevInst, uint ulFlags, long hMachine);
CONFIGRET CM_Next_Range(ulong* preElement, ulong* pullStart, ulong* pullEnd, uint ulFlags);
CONFIGRET CM_Get_Next_Res_Des(ulong* prdResDes, ulong rdResDes, CM_RESTYPE ForResource, CM_RESTYPE* pResourceID, uint ulFlags);
CONFIGRET CM_Get_Next_Res_Des_Ex(ulong* prdResDes, ulong rdResDes, CM_RESTYPE ForResource, CM_RESTYPE* pResourceID, uint ulFlags, long hMachine);
CONFIGRET CM_Open_Class_KeyA(GUID* ClassGuid, const(char)* pszClassName, uint samDesired, uint Disposition, HKEY* phkClass, uint ulFlags);
CONFIGRET CM_Open_Class_KeyW(GUID* ClassGuid, const(wchar)* pszClassName, uint samDesired, uint Disposition, HKEY* phkClass, uint ulFlags);
CONFIGRET CM_Open_Class_Key_ExA(GUID* ClassGuid, const(char)* pszClassName, uint samDesired, uint Disposition, HKEY* phkClass, uint ulFlags, long hMachine);
CONFIGRET CM_Open_Class_Key_ExW(GUID* ClassGuid, const(wchar)* pszClassName, uint samDesired, uint Disposition, HKEY* phkClass, uint ulFlags, long hMachine);
CONFIGRET CM_Open_DevNode_Key(uint dnDevNode, uint samDesired, uint ulHardwareProfile, uint Disposition, HKEY* phkDevice, uint ulFlags);
CONFIGRET CM_Open_DevNode_Key_Ex(uint dnDevNode, uint samDesired, uint ulHardwareProfile, uint Disposition, HKEY* phkDevice, uint ulFlags, long hMachine);
CONFIGRET CM_Open_Device_Interface_KeyA(const(char)* pszDeviceInterface, uint samDesired, uint Disposition, HKEY* phkDeviceInterface, uint ulFlags);
CONFIGRET CM_Open_Device_Interface_KeyW(const(wchar)* pszDeviceInterface, uint samDesired, uint Disposition, HKEY* phkDeviceInterface, uint ulFlags);
CONFIGRET CM_Open_Device_Interface_Key_ExA(const(char)* pszDeviceInterface, uint samDesired, uint Disposition, HKEY* phkDeviceInterface, uint ulFlags, long hMachine);
CONFIGRET CM_Open_Device_Interface_Key_ExW(const(wchar)* pszDeviceInterface, uint samDesired, uint Disposition, HKEY* phkDeviceInterface, uint ulFlags, long hMachine);
CONFIGRET CM_Delete_Device_Interface_KeyA(const(char)* pszDeviceInterface, uint ulFlags);
CONFIGRET CM_Delete_Device_Interface_KeyW(const(wchar)* pszDeviceInterface, uint ulFlags);
CONFIGRET CM_Delete_Device_Interface_Key_ExA(const(char)* pszDeviceInterface, uint ulFlags, long hMachine);
CONFIGRET CM_Delete_Device_Interface_Key_ExW(const(wchar)* pszDeviceInterface, uint ulFlags, long hMachine);
CONFIGRET CM_Query_Arbitrator_Free_Data(void* pData, uint DataLen, uint dnDevInst, uint ResourceID, uint ulFlags);
CONFIGRET CM_Query_Arbitrator_Free_Data_Ex(void* pData, uint DataLen, uint dnDevInst, uint ResourceID, uint ulFlags, long hMachine);
CONFIGRET CM_Query_Arbitrator_Free_Size(uint* pulSize, uint dnDevInst, uint ResourceID, uint ulFlags);
CONFIGRET CM_Query_Arbitrator_Free_Size_Ex(uint* pulSize, uint dnDevInst, uint ResourceID, uint ulFlags, long hMachine);
CONFIGRET CM_Query_Remove_SubTree(uint dnAncestor, uint ulFlags);
CONFIGRET CM_Query_Remove_SubTree_Ex(uint dnAncestor, uint ulFlags, long hMachine);
CONFIGRET CM_Query_And_Remove_SubTreeA(uint dnAncestor, PNP_VETO_TYPE* pVetoType, PSTR pszVetoName, uint ulNameLength, uint ulFlags);
CONFIGRET CM_Query_And_Remove_SubTreeW(uint dnAncestor, PNP_VETO_TYPE* pVetoType, PWSTR pszVetoName, uint ulNameLength, uint ulFlags);
CONFIGRET CM_Query_And_Remove_SubTree_ExA(uint dnAncestor, PNP_VETO_TYPE* pVetoType, PSTR pszVetoName, uint ulNameLength, uint ulFlags, long hMachine);
CONFIGRET CM_Query_And_Remove_SubTree_ExW(uint dnAncestor, PNP_VETO_TYPE* pVetoType, PWSTR pszVetoName, uint ulNameLength, uint ulFlags, long hMachine);
CONFIGRET CM_Request_Device_EjectA(uint dnDevInst, PNP_VETO_TYPE* pVetoType, PSTR pszVetoName, uint ulNameLength, uint ulFlags);
CONFIGRET CM_Request_Device_Eject_ExA(uint dnDevInst, PNP_VETO_TYPE* pVetoType, PSTR pszVetoName, uint ulNameLength, uint ulFlags, long hMachine);
CONFIGRET CM_Request_Device_EjectW(uint dnDevInst, PNP_VETO_TYPE* pVetoType, PWSTR pszVetoName, uint ulNameLength, uint ulFlags);
CONFIGRET CM_Request_Device_Eject_ExW(uint dnDevInst, PNP_VETO_TYPE* pVetoType, PWSTR pszVetoName, uint ulNameLength, uint ulFlags, long hMachine);
CONFIGRET CM_Reenumerate_DevNode(uint dnDevInst, CM_REENUMERATE_FLAGS ulFlags);
CONFIGRET CM_Reenumerate_DevNode_Ex(uint dnDevInst, uint ulFlags, long hMachine);
CONFIGRET CM_Register_Device_InterfaceA(uint dnDevInst, GUID* InterfaceClassGuid, const(char)* pszReference, PSTR pszDeviceInterface, uint* pulLength, uint ulFlags);
CONFIGRET CM_Register_Device_InterfaceW(uint dnDevInst, GUID* InterfaceClassGuid, const(wchar)* pszReference, PWSTR pszDeviceInterface, uint* pulLength, uint ulFlags);
CONFIGRET CM_Register_Device_Interface_ExA(uint dnDevInst, GUID* InterfaceClassGuid, const(char)* pszReference, PSTR pszDeviceInterface, uint* pulLength, uint ulFlags, long hMachine);
CONFIGRET CM_Register_Device_Interface_ExW(uint dnDevInst, GUID* InterfaceClassGuid, const(wchar)* pszReference, PWSTR pszDeviceInterface, uint* pulLength, uint ulFlags, long hMachine);
CONFIGRET CM_Set_DevNode_Problem_Ex(uint dnDevInst, uint ulProblem, uint ulFlags, long hMachine);
CONFIGRET CM_Set_DevNode_Problem(uint dnDevInst, uint ulProblem, uint ulFlags);
CONFIGRET CM_Unregister_Device_InterfaceA(const(char)* pszDeviceInterface, uint ulFlags);
CONFIGRET CM_Unregister_Device_InterfaceW(const(wchar)* pszDeviceInterface, uint ulFlags);
CONFIGRET CM_Unregister_Device_Interface_ExA(const(char)* pszDeviceInterface, uint ulFlags, long hMachine);
CONFIGRET CM_Unregister_Device_Interface_ExW(const(wchar)* pszDeviceInterface, uint ulFlags, long hMachine);
CONFIGRET CM_Register_Device_Driver(uint dnDevInst, uint ulFlags);
CONFIGRET CM_Register_Device_Driver_Ex(uint dnDevInst, uint ulFlags, long hMachine);
CONFIGRET CM_Remove_SubTree(uint dnAncestor, uint ulFlags);
CONFIGRET CM_Remove_SubTree_Ex(uint dnAncestor, uint ulFlags, long hMachine);
CONFIGRET CM_Set_DevNode_PropertyW(uint dnDevInst, const(DEVPROPKEY)* PropertyKey, DEVPROPTYPE PropertyType, const(ubyte)* PropertyBuffer, uint PropertyBufferSize, uint ulFlags);
CONFIGRET CM_Set_DevNode_Property_ExW(uint dnDevInst, const(DEVPROPKEY)* PropertyKey, DEVPROPTYPE PropertyType, const(ubyte)* PropertyBuffer, uint PropertyBufferSize, uint ulFlags, long hMachine);
CONFIGRET CM_Set_DevNode_Registry_PropertyA(uint dnDevInst, uint ulProperty, void* Buffer, uint ulLength, uint ulFlags);
CONFIGRET CM_Set_DevNode_Registry_PropertyW(uint dnDevInst, uint ulProperty, void* Buffer, uint ulLength, uint ulFlags);
CONFIGRET CM_Set_DevNode_Registry_Property_ExA(uint dnDevInst, uint ulProperty, void* Buffer, uint ulLength, uint ulFlags, long hMachine);
CONFIGRET CM_Set_DevNode_Registry_Property_ExW(uint dnDevInst, uint ulProperty, void* Buffer, uint ulLength, uint ulFlags, long hMachine);
CONFIGRET CM_Set_Device_Interface_PropertyW(const(wchar)* pszDeviceInterface, const(DEVPROPKEY)* PropertyKey, DEVPROPTYPE PropertyType, const(ubyte)* PropertyBuffer, uint PropertyBufferSize, uint ulFlags);
CONFIGRET CM_Set_Device_Interface_Property_ExW(const(wchar)* pszDeviceInterface, const(DEVPROPKEY)* PropertyKey, DEVPROPTYPE PropertyType, const(ubyte)* PropertyBuffer, uint PropertyBufferSize, uint ulFlags, long hMachine);
CONFIGRET CM_Is_Dock_Station_Present(BOOL* pbPresent);
CONFIGRET CM_Is_Dock_Station_Present_Ex(BOOL* pbPresent, long hMachine);
CONFIGRET CM_Request_Eject_PC();
CONFIGRET CM_Request_Eject_PC_Ex(long hMachine);
...
CONFIGRET CM_Set_HW_Prof_Flags_ExA(PSTR pDeviceID, uint ulConfig, uint ulValue, uint ulFlags, long hMachine);
CONFIGRET CM_Set_HW_Prof_Flags_ExW(PWSTR pDeviceID, uint ulConfig, uint ulValue, uint ulFlags, long hMachine);
CONFIGRET CM_Setup_DevNode(uint dnDevInst, uint ulFlags);
CONFIGRET CM_Setup_DevNode_Ex(uint dnDevInst, uint ulFlags, long hMachine);
CONFIGRET CM_Test_Range_Available(ulong ullStartValue, ulong ullEndValue, ulong rlh, uint ulFlags);
CONFIGRET CM_Uninstall_DevNode(uint dnDevInst, uint ulFlags);
CONFIGRET CM_Uninstall_DevNode_Ex(uint dnDevInst, uint ulFlags, long hMachine);
CONFIGRET CM_Run_Detection(uint ulFlags);
CONFIGRET CM_Run_Detection_Ex(uint ulFlags, long hMachine);
CONFIGRET CM_Set_HW_Prof(uint ulHardwareProfile, uint ulFlags);
CONFIGRET CM_Set_HW_Prof_Ex(uint ulHardwareProfile, uint ulFlags, long hMachine);
CONFIGRET CM_Query_Resource_Conflict_List(ulong* pclConflictList, uint dnDevInst, CM_RESTYPE ResourceID, void* ResourceData, uint ResourceLen, uint ulFlags, long hMachine);
CONFIGRET CM_Free_Resource_Conflict_Handle(ulong clConflictList);
CONFIGRET CM_Get_Resource_Conflict_Count(ulong clConflictList, uint* pulCount);
CONFIGRET CM_Get_Resource_Conflict_DetailsA(ulong clConflictList, uint ulIndex, CONFLICT_DETAILS_A* pConflictDetails);
CONFIGRET CM_Get_Resource_Conflict_DetailsW(ulong clConflictList, uint ulIndex, CONFLICT_DETAILS_W* pConflictDetails);
CONFIGRET CM_Get_Class_PropertyW(const(GUID)* ClassGUID, const(DEVPROPKEY)* PropertyKey, DEVPROPTYPE* PropertyType, ubyte* PropertyBuffer, uint* PropertyBufferSize, uint ulFlags);
CONFIGRET CM_Get_Class_Property_ExW(const(GUID)* ClassGUID, const(DEVPROPKEY)* PropertyKey, DEVPROPTYPE* PropertyType, ubyte* PropertyBuffer, uint* PropertyBufferSize, uint ulFlags, long hMachine);
CONFIGRET CM_Get_Class_Property_Keys(const(GUID)* ClassGUID, DEVPROPKEY* PropertyKeyArray, uint* PropertyKeyCount, uint ulFlags);
CONFIGRET CM_Get_Class_Property_Keys_Ex(const(GUID)* ClassGUID, DEVPROPKEY* PropertyKeyArray, uint* PropertyKeyCount, uint ulFlags, long hMachine);
CONFIGRET CM_Set_Class_PropertyW(const(GUID)* ClassGUID, const(DEVPROPKEY)* PropertyKey, DEVPROPTYPE PropertyType, const(ubyte)* PropertyBuffer, uint PropertyBufferSize, uint ulFlags);
CONFIGRET CM_Set_Class_Property_ExW(const(GUID)* ClassGUID, const(DEVPROPKEY)* PropertyKey, DEVPROPTYPE PropertyType, const(ubyte)* PropertyBuffer, uint PropertyBufferSize, uint ulFlags, long hMachine);
CONFIGRET CM_Get_Class_Registry_PropertyA(GUID* ClassGuid, uint ulProperty, uint* pulRegDataType, void* Buffer, uint* pulLength, uint ulFlags, long hMachine);
CONFIGRET CM_Get_Class_Registry_PropertyW(GUID* ClassGuid, uint ulProperty, uint* pulRegDataType, void* Buffer, uint* pulLength, uint ulFlags, long hMachine);
CONFIGRET CM_Set_Class_Registry_PropertyA(GUID* ClassGuid, uint ulProperty, void* Buffer, uint ulLength, uint ulFlags, long hMachine);
CONFIGRET CM_Set_Class_Registry_PropertyW(GUID* ClassGuid, uint ulProperty, void* Buffer, uint ulLength, uint ulFlags, long hMachine);
...
BOOL UpdateDriverForPlugAndPlayDevicesA(HWND hwndParent, const(char)* HardwareId, const(char)* FullInfPath, UPDATEDRIVERFORPLUGANDPLAYDEVICES_FLAGS InstallFlags, BOOL* bRebootRequired);
BOOL UpdateDriverForPlugAndPlayDevicesW(HWND hwndParent, const(wchar)* HardwareId, const(wchar)* FullInfPath, UPDATEDRIVERFORPLUGANDPLAYDEVICES_FLAGS InstallFlags, BOOL* bRebootRequired);
...
BOOL DiInstallDriverW(HWND hwndParent, const(wchar)* InfPath, DIINSTALLDRIVER_FLAGS Flags, BOOL* NeedReboot);
BOOL DiInstallDriverA(HWND hwndParent, const(char)* InfPath, DIINSTALLDRIVER_FLAGS Flags, BOOL* NeedReboot);
BOOL DiUninstallDevice(HWND hwndParent, HDEVINFO DeviceInfoSet, SP_DEVINFO_DATA* DeviceInfoData, uint Flags, BOOL* NeedReboot);
BOOL DiUninstallDriverW(HWND hwndParent, const(wchar)* InfPath, DIUNINSTALLDRIVER_FLAGS Flags, BOOL* NeedReboot);
BOOL DiUninstallDriverA(HWND hwndParent, const(char)* InfPath, DIUNINSTALLDRIVER_FLAGS Flags, BOOL* NeedReboot);
BOOL DiShowUpdateDevice(HWND hwndParent, HDEVINFO DeviceInfoSet, SP_DEVINFO_DATA* DeviceInfoData, uint Flags, BOOL* NeedReboot);
...
BOOL DiShowUpdateDriver(HWND hwndParent, const(wchar)* FilePath, uint Flags, BOOL* NeedReboot);
...
enum GUID_DEVCLASS_GENERIC = GUID(0xff494df1, 0xc4ed, 0x4fac, [0x9b, 0x3f, 0x37, 0x86, 0xf6, 0xe9, 0x1e, 0x7e]);
...
enum GUID_DEVCLASS_PRIMITIVE = GUID(0x242681d1, 0xeed3, 0x41d2, [0xa1, 0xef, 0x14, 0x68, 0xfc, 0x84, 0x31, 0x6]);
...
enum SZ_KEY_FAILUREACTIONS = "FailureActions";
...
enum INFSTR_KEY_RESET_PERIOD = "ResetPeriod";
enum INFSTR_KEY_NON_CRASH_FAILURES = "NonCrashFailures";
enum INFSTR_KEY_FAILURE_ACTION = "Action";
...
+/
alias PSP_FILE_CALLBACK_A = uint function(void* Context, uint Notification, ulong Param1, ulong Param2);
alias PSP_FILE_CALLBACK_W = uint function(void* Context, uint Notification, ulong Param1, ulong Param2);
...
+/
alias PSP_DETSIG_CMPPROC = uint function(HDEVINFO DeviceInfoSet, SP_DEVINFO_DATA* NewDeviceData, SP_DEVINFO_DATA* ExistingDeviceData, void* CompareContext);
...
alias PCM_NOTIFY_CALLBACK = uint function(HCMNOTIFICATION hNotify, void* Context, CM_NOTIFY_ACTION Action, CM_NOTIFY_EVENT_DATA* EventData, uint EventDataSize);
