...
//enum WPD_PROPERTY_NULL = [MISSING];
enum WPD_OBJECT_PROPERTIES_V1 = GUID(0xef6b490d, 0x5cd8, 0x437a, [0xaf, 0xfc, 0xda, 0x8b, 0x60, 0xee, 0x4a, 0x3c]);
//enum WPD_OBJECT_CONTENT_TYPE = [MISSING];
//enum WPD_OBJECT_REFERENCES = [MISSING];
//enum WPD_OBJECT_CONTAINER_FUNCTIONAL_OBJECT_ID = [MISSING];
//enum WPD_OBJECT_GENERATE_THUMBNAIL_FROM_RESOURCE = [MISSING];
//enum WPD_OBJECT_HINT_LOCATION_DISPLAY_NAME = [MISSING];
enum WPD_OBJECT_PROPERTIES_V2 = GUID(0x373cd3d, 0x4a46, 0x40d7, [0xb4, 0xd8, 0x73, 0xe8, 0xda, 0x74, 0xe7, 0x75]);
//enum WPD_OBJECT_SUPPORTED_UNITS = [MISSING];
enum WPD_FUNCTIONAL_OBJECT_PROPERTIES_V1 = GUID(0x8f052d93, 0xabca, 0x4fc5, [0xa5, 0xac, 0xb0, 0x1d, 0xf4, 0xdb, 0xe5, 0x98]);
//enum WPD_FUNCTIONAL_OBJECT_CATEGORY = [MISSING];
enum WPD_STORAGE_OBJECT_PROPERTIES_V1 = GUID(0x1a3057a, 0x74d6, 0x4e80, [0xbe, 0xa7, 0xdc, 0x4c, 0x21, 0x2c, 0xe5, 0xa]);
//enum WPD_STORAGE_TYPE = [MISSING];
//enum WPD_STORAGE_FILE_SYSTEM_TYPE = [MISSING];
//enum WPD_STORAGE_CAPACITY = [MISSING];
//enum WPD_STORAGE_FREE_SPACE_IN_BYTES = [MISSING];
//enum WPD_STORAGE_FREE_SPACE_IN_OBJECTS = [MISSING];
//enum WPD_STORAGE_DESCRIPTION = [MISSING];
//enum WPD_STORAGE_SERIAL_NUMBER = [MISSING];
//enum WPD_STORAGE_MAX_OBJECT_SIZE = [MISSING];
//enum WPD_STORAGE_CAPACITY_IN_OBJECTS = [MISSING];
//enum WPD_STORAGE_ACCESS_CAPABILITY = [MISSING];
enum WPD_NETWORK_ASSOCIATION_PROPERTIES_V1 = GUID(0xe4c93c1f, 0xb203, 0x43f1, [0xa1, 0x0, 0x5a, 0x7, 0xd1, 0x1b, 0x2, 0x74]);
//enum WPD_NETWORK_ASSOCIATION_HOST_NETWORK_IDENTIFIERS = [MISSING];
//enum WPD_NETWORK_ASSOCIATION_X509V3SEQUENCE = [MISSING];
enum WPD_STILL_IMAGE_CAPTURE_OBJECT_PROPERTIES_V1 = GUID(0x58c571ec, 0x1bcb, 0x42a7, [0x8a, 0xc5, 0xbb, 0x29, 0x15, 0x73, 0xa2, 0x60]);
//enum WPD_STILL_IMAGE_CAPTURE_RESOLUTION = [MISSING];
//enum WPD_STILL_IMAGE_CAPTURE_FORMAT = [MISSING];
//enum WPD_STILL_IMAGE_COMPRESSION_SETTING = [MISSING];
//enum WPD_STILL_IMAGE_WHITE_BALANCE = [MISSING];
//enum WPD_STILL_IMAGE_RGB_GAIN = [MISSING];
//enum WPD_STILL_IMAGE_FNUMBER = [MISSING];
//enum WPD_STILL_IMAGE_FOCAL_LENGTH = [MISSING];
//enum WPD_STILL_IMAGE_FOCUS_DISTANCE = [MISSING];
//enum WPD_STILL_IMAGE_FOCUS_MODE = [MISSING];
//enum WPD_STILL_IMAGE_EXPOSURE_METERING_MODE = [MISSING];
//enum WPD_STILL_IMAGE_FLASH_MODE = [MISSING];
//enum WPD_STILL_IMAGE_EXPOSURE_TIME = [MISSING];
//enum WPD_STILL_IMAGE_EXPOSURE_PROGRAM_MODE = [MISSING];
//enum WPD_STILL_IMAGE_EXPOSURE_INDEX = [MISSING];
//enum WPD_STILL_IMAGE_EXPOSURE_BIAS_COMPENSATION = [MISSING];
//enum WPD_STILL_IMAGE_CAPTURE_DELAY = [MISSING];
//enum WPD_STILL_IMAGE_CAPTURE_MODE = [MISSING];
//enum WPD_STILL_IMAGE_CONTRAST = [MISSING];
//enum WPD_STILL_IMAGE_SHARPNESS = [MISSING];
//enum WPD_STILL_IMAGE_DIGITAL_ZOOM = [MISSING];
//enum WPD_STILL_IMAGE_EFFECT_MODE = [MISSING];
//enum WPD_STILL_IMAGE_BURST_NUMBER = [MISSING];
//enum WPD_STILL_IMAGE_BURST_INTERVAL = [MISSING];
//enum WPD_STILL_IMAGE_TIMELAPSE_NUMBER = [MISSING];
//enum WPD_STILL_IMAGE_TIMELAPSE_INTERVAL = [MISSING];
//enum WPD_STILL_IMAGE_FOCUS_METERING_MODE = [MISSING];
//enum WPD_STILL_IMAGE_UPLOAD_URL = [MISSING];
//enum WPD_STILL_IMAGE_ARTIST = [MISSING];
//enum WPD_STILL_IMAGE_CAMERA_MODEL = [MISSING];
//enum WPD_STILL_IMAGE_CAMERA_MANUFACTURER = [MISSING];
...
//enum WPD_RENDERING_INFORMATION_PROFILES = [MISSING];
//enum WPD_RENDERING_INFORMATION_PROFILE_ENTRY_TYPE = [MISSING];
//enum WPD_RENDERING_INFORMATION_PROFILE_ENTRY_CREATABLE_RESOURCES = [MISSING];
enum WPD_CLIENT_INFORMATION_PROPERTIES_V1 = GUID(0x204d9f0c, 0x2292, 0x4080, [0x9f, 0x42, 0x40, 0x66, 0x4e, 0x70, 0xf8, 0x59]);
//enum WPD_CLIENT_NAME = [MISSING];
//enum WPD_CLIENT_MAJOR_VERSION = [MISSING];
//enum WPD_CLIENT_MINOR_VERSION = [MISSING];
//enum WPD_CLIENT_REVISION = [MISSING];
//enum WPD_CLIENT_WMDRM_APPLICATION_PRIVATE_KEY = [MISSING];
//enum WPD_CLIENT_WMDRM_APPLICATION_CERTIFICATE = [MISSING];
//enum WPD_CLIENT_SECURITY_QUALITY_OF_SERVICE = [MISSING];
//enum WPD_CLIENT_DESIRED_ACCESS = [MISSING];
//enum WPD_CLIENT_SHARE_MODE = [MISSING];
//enum WPD_CLIENT_EVENT_COOKIE = [MISSING];
//enum WPD_CLIENT_MINIMUM_RESULTS_BUFFER_SIZE = [MISSING];
//enum WPD_CLIENT_MANUAL_CLOSE_ON_DISCONNECT = [MISSING];
enum WPD_PROPERTY_ATTRIBUTES_V1 = GUID(0xab7943d8, 0x6332, 0x445f, [0xa0, 0xd, 0x8d, 0x5e, 0xf1, 0xe9, 0x6f, 0x37]);
//enum WPD_PROPERTY_ATTRIBUTE_FORM = [MISSING];
//enum WPD_PROPERTY_ATTRIBUTE_CAN_READ = [MISSING];
//enum WPD_PROPERTY_ATTRIBUTE_CAN_WRITE = [MISSING];
//enum WPD_PROPERTY_ATTRIBUTE_CAN_DELETE = [MISSING];
//enum WPD_PROPERTY_ATTRIBUTE_DEFAULT_VALUE = [MISSING];
//enum WPD_PROPERTY_ATTRIBUTE_FAST_PROPERTY = [MISSING];
//enum WPD_PROPERTY_ATTRIBUTE_RANGE_MIN = [MISSING];
//enum WPD_PROPERTY_ATTRIBUTE_RANGE_MAX = [MISSING];
//enum WPD_PROPERTY_ATTRIBUTE_RANGE_STEP = [MISSING];
//enum WPD_PROPERTY_ATTRIBUTE_ENUMERATION_ELEMENTS = [MISSING];
//enum WPD_PROPERTY_ATTRIBUTE_REGULAR_EXPRESSION = [MISSING];
//enum WPD_PROPERTY_ATTRIBUTE_MAX_SIZE = [MISSING];
enum WPD_PROPERTY_ATTRIBUTES_V2 = GUID(0x5d9da160, 0x74ae, 0x43cc, [0x85, 0xa9, 0xfe, 0x55, 0x5a, 0x80, 0x79, 0x8e]);
//enum WPD_PROPERTY_ATTRIBUTE_NAME = [MISSING];
//enum WPD_PROPERTY_ATTRIBUTE_VARTYPE = [MISSING];
enum WPD_CLASS_EXTENSION_OPTIONS_V1 = GUID(0x6309ffef, 0xa87c, 0x4ca7, [0x84, 0x34, 0x79, 0x75, 0x76, 0xe4, 0xa, 0x96]);
//enum WPD_CLASS_EXTENSION_OPTIONS_SUPPORTED_CONTENT_TYPES = [MISSING];
//enum WPD_CLASS_EXTENSION_OPTIONS_DONT_REGISTER_WPD_DEVICE_INTERFACE = [MISSING];
//enum WPD_CLASS_EXTENSION_OPTIONS_REGISTER_WPD_PRIVATE_DEVICE_INTERFACE = [MISSING];
enum WPD_CLASS_EXTENSION_OPTIONS_V2 = GUID(0x3e3595da, 0x4d71, 0x49fe, [0xa0, 0xb4, 0xd4, 0x40, 0x6c, 0x3a, 0xe9, 0x3f]);
//enum WPD_CLASS_EXTENSION_OPTIONS_MULTITRANSPORT_MODE = [MISSING];
//enum WPD_CLASS_EXTENSION_OPTIONS_DEVICE_IDENTIFICATION_VALUES = [MISSING];
//enum WPD_CLASS_EXTENSION_OPTIONS_TRANSPORT_BANDWIDTH = [MISSING];
enum WPD_CLASS_EXTENSION_OPTIONS_V3 = GUID(0x65c160f8, 0x1367, 0x4ce2, [0x93, 0x9d, 0x83, 0x10, 0x83, 0x9f, 0xd, 0x30]);
//enum WPD_CLASS_EXTENSION_OPTIONS_SILENCE_AUTOPLAY = [MISSING];
enum WPD_RESOURCE_ATTRIBUTES_V1 = GUID(0x1eb6f604, 0x9278, 0x429f, [0x93, 0xcc, 0x5b, 0xb8, 0xc0, 0x66, 0x56, 0xb6]);
//enum WPD_RESOURCE_ATTRIBUTE_TOTAL_SIZE = [MISSING];
//enum WPD_RESOURCE_ATTRIBUTE_CAN_READ = [MISSING];
//enum WPD_RESOURCE_ATTRIBUTE_CAN_WRITE = [MISSING];
//enum WPD_RESOURCE_ATTRIBUTE_CAN_DELETE = [MISSING];
//enum WPD_RESOURCE_ATTRIBUTE_OPTIMAL_READ_BUFFER_SIZE = [MISSING];
//enum WPD_RESOURCE_ATTRIBUTE_OPTIMAL_WRITE_BUFFER_SIZE = [MISSING];
//enum WPD_RESOURCE_ATTRIBUTE_FORMAT = [MISSING];
//enum WPD_RESOURCE_ATTRIBUTE_RESOURCE_KEY = [MISSING];
enum WPD_DEVICE_PROPERTIES_V1 = GUID(0x26d4979a, 0xe643, 0x4626, [0x9e, 0x2b, 0x73, 0x6d, 0xc0, 0xc9, 0x2f, 0xdc]);
//enum WPD_DEVICE_SYNC_PARTNER = [MISSING];
//enum WPD_DEVICE_FIRMWARE_VERSION = [MISSING];
//enum WPD_DEVICE_POWER_LEVEL = [MISSING];
//enum WPD_DEVICE_POWER_SOURCE = [MISSING];
//enum WPD_DEVICE_PROTOCOL = [MISSING];
//enum WPD_DEVICE_MANUFACTURER = [MISSING];
//enum WPD_DEVICE_MODEL = [MISSING];
//enum WPD_DEVICE_SERIAL_NUMBER = [MISSING];
//enum WPD_DEVICE_SUPPORTS_NON_CONSUMABLE = [MISSING];
//enum WPD_DEVICE_DATETIME = [MISSING];
//enum WPD_DEVICE_FRIENDLY_NAME = [MISSING];
//enum WPD_DEVICE_SUPPORTED_DRM_SCHEMES = [MISSING];
//enum WPD_DEVICE_SUPPORTED_FORMATS_ARE_ORDERED = [MISSING];
//enum WPD_DEVICE_TYPE = [MISSING];
//enum WPD_DEVICE_NETWORK_IDENTIFIER = [MISSING];
enum WPD_DEVICE_PROPERTIES_V2 = GUID(0x463dd662, 0x7fc4, 0x4291, [0x91, 0x1c, 0x7f, 0x4c, 0x9c, 0xca, 0x97, 0x99]);
//enum WPD_DEVICE_FUNCTIONAL_UNIQUE_ID = [MISSING];
//enum WPD_DEVICE_MODEL_UNIQUE_ID = [MISSING];
//enum WPD_DEVICE_TRANSPORT = [MISSING];
//enum WPD_DEVICE_USE_DEVICE_STAGE = [MISSING];
enum WPD_DEVICE_PROPERTIES_V3 = GUID(0x6c2b878c, 0xc2ec, 0x490d, [0xb4, 0x25, 0xd7, 0xa7, 0x5e, 0x23, 0xe5, 0xed]);
//enum WPD_DEVICE_EDP_IDENTITY = [MISSING];
enum WPD_SERVICE_PROPERTIES_V1 = GUID(0x7510698a, 0xcb54, 0x481c, [0xb8, 0xdb, 0xd, 0x75, 0xc9, 0x3f, 0x1c, 0x6]);
//enum WPD_SERVICE_VERSION = [MISSING];
enum WPD_EVENT_PROPERTIES_V1 = GUID(0x15ab1953, 0xf817, 0x4fef, [0xa9, 0x21, 0x56, 0x76, 0xe8, 0x38, 0xf6, 0xe0]);
//enum WPD_EVENT_PARAMETER_PNP_DEVICE_ID = [MISSING];
//enum WPD_EVENT_PARAMETER_EVENT_ID = [MISSING];
//enum WPD_EVENT_PARAMETER_OPERATION_STATE = [MISSING];
//enum WPD_EVENT_PARAMETER_OPERATION_PROGRESS = [MISSING];
//enum WPD_EVENT_PARAMETER_OBJECT_PARENT_PERSISTENT_UNIQUE_ID = [MISSING];
//enum WPD_EVENT_PARAMETER_OBJECT_CREATION_COOKIE = [MISSING];
//enum WPD_EVENT_PARAMETER_CHILD_HIERARCHY_CHANGED = [MISSING];
enum WPD_EVENT_PROPERTIES_V2 = GUID(0x52807b8a, 0x4914, 0x4323, [0x9b, 0x9a, 0x74, 0xf6, 0x54, 0xb2, 0xb8, 0x46]);
//enum WPD_EVENT_PARAMETER_SERVICE_METHOD_CONTEXT = [MISSING];
enum WPD_EVENT_OPTIONS_V1 = GUID(0xb3d8dad7, 0xa361, 0x4b83, [0x8a, 0x48, 0x5b, 0x2, 0xce, 0x10, 0x71, 0x3b]);
//enum WPD_EVENT_OPTION_IS_BROADCAST_EVENT = [MISSING];
//enum WPD_EVENT_OPTION_IS_AUTOPLAY_EVENT = [MISSING];
enum WPD_EVENT_ATTRIBUTES_V1 = GUID(0x10c96578, 0x2e81, 0x4111, [0xad, 0xde, 0xe0, 0x8c, 0xa6, 0x13, 0x8f, 0x6d]);
//enum WPD_EVENT_ATTRIBUTE_NAME = [MISSING];
//enum WPD_EVENT_ATTRIBUTE_PARAMETERS = [MISSING];
//enum WPD_EVENT_ATTRIBUTE_OPTIONS = [MISSING];
enum WPD_API_OPTIONS_V1 = GUID(0x10e54a3e, 0x52d, 0x4777, [0xa1, 0x3c, 0xde, 0x76, 0x14, 0xbe, 0x2b, 0xc4]);
//enum WPD_API_OPTION_USE_CLEAR_DATA_STREAM = [MISSING];
//enum WPD_API_OPTION_IOCTL_ACCESS = [MISSING];
enum WPD_FORMAT_ATTRIBUTES_V1 = GUID(0xa0a02000, 0xbcaf, 0x4be8, [0xb3, 0xf5, 0x23, 0x3f, 0x23, 0x1c, 0xf5, 0x8f]);
//enum WPD_FORMAT_ATTRIBUTE_NAME = [MISSING];
//enum WPD_FORMAT_ATTRIBUTE_MIMETYPE = [MISSING];
enum WPD_METHOD_ATTRIBUTES_V1 = GUID(0xf17a5071, 0xf039, 0x44af, [0x8e, 0xfe, 0x43, 0x2c, 0xf3, 0x2e, 0x43, 0x2a]);
//enum WPD_METHOD_ATTRIBUTE_NAME = [MISSING];
//enum WPD_METHOD_ATTRIBUTE_ASSOCIATED_FORMAT = [MISSING];
//enum WPD_METHOD_ATTRIBUTE_ACCESS = [MISSING];
//enum WPD_METHOD_ATTRIBUTE_PARAMETERS = [MISSING];
enum WPD_PARAMETER_ATTRIBUTES_V1 = GUID(0xe6864dd7, 0xf325, 0x45ea, [0xa1, 0xd5, 0x97, 0xcf, 0x73, 0xb6, 0xca, 0x58]);
//enum WPD_PARAMETER_ATTRIBUTE_ORDER = [MISSING];
//enum WPD_PARAMETER_ATTRIBUTE_USAGE = [MISSING];
//enum WPD_PARAMETER_ATTRIBUTE_FORM = [MISSING];
//enum WPD_PARAMETER_ATTRIBUTE_DEFAULT_VALUE = [MISSING];
//enum WPD_PARAMETER_ATTRIBUTE_RANGE_MIN = [MISSING];
//enum WPD_PARAMETER_ATTRIBUTE_RANGE_MAX = [MISSING];
//enum WPD_PARAMETER_ATTRIBUTE_RANGE_STEP = [MISSING];
//enum WPD_PARAMETER_ATTRIBUTE_ENUMERATION_ELEMENTS = [MISSING];
//enum WPD_PARAMETER_ATTRIBUTE_REGULAR_EXPRESSION = [MISSING];
//enum WPD_PARAMETER_ATTRIBUTE_MAX_SIZE = [MISSING];
//enum WPD_PARAMETER_ATTRIBUTE_VARTYPE = [MISSING];
//enum WPD_PARAMETER_ATTRIBUTE_NAME = [MISSING];
enum WPD_CATEGORY_COMMON = GUID(0xf0422a9c, 0x5dc8, 0x4440, [0xb5, 0xbd, 0x5d, 0xf2, 0x88, 0x35, 0x65, 0x8a]);
//enum WPD_COMMAND_COMMON_RESET_DEVICE = [MISSING];
//enum WPD_COMMAND_COMMON_GET_OBJECT_IDS_FROM_PERSISTENT_UNIQUE_IDS = [MISSING];
//enum WPD_COMMAND_COMMON_SAVE_CLIENT_INFORMATION = [MISSING];
//enum WPD_PROPERTY_COMMON_COMMAND_CATEGORY = [MISSING];
//enum WPD_PROPERTY_COMMON_COMMAND_ID = [MISSING];
//enum WPD_PROPERTY_COMMON_HRESULT = [MISSING];
//enum WPD_PROPERTY_COMMON_DRIVER_ERROR_CODE = [MISSING];
//enum WPD_PROPERTY_COMMON_COMMAND_TARGET = [MISSING];
//enum WPD_PROPERTY_COMMON_PERSISTENT_UNIQUE_IDS = [MISSING];
//enum WPD_PROPERTY_COMMON_OBJECT_IDS = [MISSING];
//enum WPD_PROPERTY_COMMON_CLIENT_INFORMATION = [MISSING];
//enum WPD_PROPERTY_COMMON_CLIENT_INFORMATION_CONTEXT = [MISSING];
//enum WPD_PROPERTY_COMMON_ACTIVITY_ID = [MISSING];
//enum WPD_OPTION_VALID_OBJECT_IDS = [MISSING];
enum WPD_CATEGORY_OBJECT_ENUMERATION = GUID(0xb7474e91, 0xe7f8, 0x4ad9, [0xb4, 0x0, 0xad, 0x1a, 0x4b, 0x58, 0xee, 0xec]);
//enum WPD_COMMAND_OBJECT_ENUMERATION_START_FIND = [MISSING];
//enum WPD_COMMAND_OBJECT_ENUMERATION_FIND_NEXT = [MISSING];
//enum WPD_COMMAND_OBJECT_ENUMERATION_END_FIND = [MISSING];
//enum WPD_PROPERTY_OBJECT_ENUMERATION_PARENT_ID = [MISSING];
//enum WPD_PROPERTY_OBJECT_ENUMERATION_FILTER = [MISSING];
//enum WPD_PROPERTY_OBJECT_ENUMERATION_OBJECT_IDS = [MISSING];
//enum WPD_PROPERTY_OBJECT_ENUMERATION_CONTEXT = [MISSING];
//enum WPD_PROPERTY_OBJECT_ENUMERATION_NUM_OBJECTS_REQUESTED = [MISSING];
enum WPD_CATEGORY_OBJECT_PROPERTIES = GUID(0x9e5582e4, 0x814, 0x44e6, [0x98, 0x1a, 0xb2, 0x99, 0x8d, 0x58, 0x38, 0x4]);
//enum WPD_COMMAND_OBJECT_PROPERTIES_GET_SUPPORTED = [MISSING];
//enum WPD_COMMAND_OBJECT_PROPERTIES_GET_ATTRIBUTES = [MISSING];
//enum WPD_COMMAND_OBJECT_PROPERTIES_GET = [MISSING];
//enum WPD_COMMAND_OBJECT_PROPERTIES_SET = [MISSING];
//enum WPD_COMMAND_OBJECT_PROPERTIES_GET_ALL = [MISSING];
//enum WPD_COMMAND_OBJECT_PROPERTIES_DELETE = [MISSING];
//enum WPD_PROPERTY_OBJECT_PROPERTIES_OBJECT_ID = [MISSING];
//enum WPD_PROPERTY_OBJECT_PROPERTIES_PROPERTY_KEYS = [MISSING];
//enum WPD_PROPERTY_OBJECT_PROPERTIES_PROPERTY_ATTRIBUTES = [MISSING];
//enum WPD_PROPERTY_OBJECT_PROPERTIES_PROPERTY_VALUES = [MISSING];
//enum WPD_PROPERTY_OBJECT_PROPERTIES_PROPERTY_WRITE_RESULTS = [MISSING];
//enum WPD_PROPERTY_OBJECT_PROPERTIES_PROPERTY_DELETE_RESULTS = [MISSING];
enum WPD_CATEGORY_OBJECT_PROPERTIES_BULK = GUID(0x11c824dd, 0x4cd, 0x4e4e, [0x8c, 0x7b, 0xf6, 0xef, 0xb7, 0x94, 0xd8, 0x4e]);
//enum WPD_COMMAND_OBJECT_PROPERTIES_BULK_GET_VALUES_BY_OBJECT_LIST_START = [MISSING];
//enum WPD_COMMAND_OBJECT_PROPERTIES_BULK_GET_VALUES_BY_OBJECT_LIST_NEXT = [MISSING];
//enum WPD_COMMAND_OBJECT_PROPERTIES_BULK_GET_VALUES_BY_OBJECT_LIST_END = [MISSING];
//enum WPD_COMMAND_OBJECT_PROPERTIES_BULK_GET_VALUES_BY_OBJECT_FORMAT_START = [MISSING];
//enum WPD_COMMAND_OBJECT_PROPERTIES_BULK_GET_VALUES_BY_OBJECT_FORMAT_NEXT = [MISSING];
//enum WPD_COMMAND_OBJECT_PROPERTIES_BULK_GET_VALUES_BY_OBJECT_FORMAT_END = [MISSING];
//enum WPD_COMMAND_OBJECT_PROPERTIES_BULK_SET_VALUES_BY_OBJECT_LIST_START = [MISSING];
//enum WPD_COMMAND_OBJECT_PROPERTIES_BULK_SET_VALUES_BY_OBJECT_LIST_NEXT = [MISSING];
//enum WPD_COMMAND_OBJECT_PROPERTIES_BULK_SET_VALUES_BY_OBJECT_LIST_END = [MISSING];
//enum WPD_PROPERTY_OBJECT_PROPERTIES_BULK_OBJECT_IDS = [MISSING];
//enum WPD_PROPERTY_OBJECT_PROPERTIES_BULK_CONTEXT = [MISSING];
//enum WPD_PROPERTY_OBJECT_PROPERTIES_BULK_VALUES = [MISSING];
//enum WPD_PROPERTY_OBJECT_PROPERTIES_BULK_PROPERTY_KEYS = [MISSING];
//enum WPD_PROPERTY_OBJECT_PROPERTIES_BULK_DEPTH = [MISSING];
//enum WPD_PROPERTY_OBJECT_PROPERTIES_BULK_PARENT_OBJECT_ID = [MISSING];
//enum WPD_PROPERTY_OBJECT_PROPERTIES_BULK_OBJECT_FORMAT = [MISSING];
//enum WPD_PROPERTY_OBJECT_PROPERTIES_BULK_WRITE_RESULTS = [MISSING];
enum WPD_CATEGORY_OBJECT_RESOURCES = GUID(0xb3a2b22d, 0xa595, 0x4108, [0xbe, 0xa, 0xfc, 0x3c, 0x96, 0x5f, 0x3d, 0x4a]);
//enum WPD_COMMAND_OBJECT_RESOURCES_GET_SUPPORTED = [MISSING];
//enum WPD_COMMAND_OBJECT_RESOURCES_GET_ATTRIBUTES = [MISSING];
//enum WPD_COMMAND_OBJECT_RESOURCES_OPEN = [MISSING];
//enum WPD_COMMAND_OBJECT_RESOURCES_READ = [MISSING];
//enum WPD_COMMAND_OBJECT_RESOURCES_WRITE = [MISSING];
//enum WPD_COMMAND_OBJECT_RESOURCES_CLOSE = [MISSING];
//enum WPD_COMMAND_OBJECT_RESOURCES_DELETE = [MISSING];
//enum WPD_COMMAND_OBJECT_RESOURCES_CREATE_RESOURCE = [MISSING];
//enum WPD_COMMAND_OBJECT_RESOURCES_REVERT = [MISSING];
//enum WPD_COMMAND_OBJECT_RESOURCES_SEEK = [MISSING];
//enum WPD_COMMAND_OBJECT_RESOURCES_COMMIT = [MISSING];
//enum WPD_COMMAND_OBJECT_RESOURCES_SEEK_IN_UNITS = [MISSING];
//enum WPD_PROPERTY_OBJECT_RESOURCES_OBJECT_ID = [MISSING];
//enum WPD_PROPERTY_OBJECT_RESOURCES_ACCESS_MODE = [MISSING];
//enum WPD_PROPERTY_OBJECT_RESOURCES_RESOURCE_KEYS = [MISSING];
//enum WPD_PROPERTY_OBJECT_RESOURCES_RESOURCE_ATTRIBUTES = [MISSING];
//enum WPD_PROPERTY_OBJECT_RESOURCES_CONTEXT = [MISSING];
//enum WPD_PROPERTY_OBJECT_RESOURCES_NUM_BYTES_TO_READ = [MISSING];
//enum WPD_PROPERTY_OBJECT_RESOURCES_NUM_BYTES_READ = [MISSING];
//enum WPD_PROPERTY_OBJECT_RESOURCES_NUM_BYTES_TO_WRITE = [MISSING];
//enum WPD_PROPERTY_OBJECT_RESOURCES_NUM_BYTES_WRITTEN = [MISSING];
//enum WPD_PROPERTY_OBJECT_RESOURCES_DATA = [MISSING];
//enum WPD_PROPERTY_OBJECT_RESOURCES_OPTIMAL_TRANSFER_BUFFER_SIZE = [MISSING];
//enum WPD_PROPERTY_OBJECT_RESOURCES_SEEK_OFFSET = [MISSING];
//enum WPD_PROPERTY_OBJECT_RESOURCES_SEEK_ORIGIN_FLAG = [MISSING];
//enum WPD_PROPERTY_OBJECT_RESOURCES_POSITION_FROM_START = [MISSING];
//enum WPD_PROPERTY_OBJECT_RESOURCES_SUPPORTS_UNITS = [MISSING];
//enum WPD_PROPERTY_OBJECT_RESOURCES_STREAM_UNITS = [MISSING];
//enum WPD_OPTION_OBJECT_RESOURCES_SEEK_ON_READ_SUPPORTED = [MISSING];
//enum WPD_OPTION_OBJECT_RESOURCES_SEEK_ON_WRITE_SUPPORTED = [MISSING];
//enum WPD_OPTION_OBJECT_RESOURCES_NO_INPUT_BUFFER_ON_READ = [MISSING];
enum WPD_CATEGORY_OBJECT_MANAGEMENT = GUID(0xef1e43dd, 0xa9ed, 0x4341, [0x8b, 0xcc, 0x18, 0x61, 0x92, 0xae, 0xa0, 0x89]);
//enum WPD_COMMAND_OBJECT_MANAGEMENT_CREATE_OBJECT_WITH_PROPERTIES_ONLY = [MISSING];
//enum WPD_COMMAND_OBJECT_MANAGEMENT_CREATE_OBJECT_WITH_PROPERTIES_AND_DATA = [MISSING];
//enum WPD_COMMAND_OBJECT_MANAGEMENT_WRITE_OBJECT_DATA = [MISSING];
//enum WPD_COMMAND_OBJECT_MANAGEMENT_COMMIT_OBJECT = [MISSING];
//enum WPD_COMMAND_OBJECT_MANAGEMENT_REVERT_OBJECT = [MISSING];
//enum WPD_COMMAND_OBJECT_MANAGEMENT_DELETE_OBJECTS = [MISSING];
//enum WPD_COMMAND_OBJECT_MANAGEMENT_MOVE_OBJECTS = [MISSING];
//enum WPD_COMMAND_OBJECT_MANAGEMENT_COPY_OBJECTS = [MISSING];
//enum WPD_COMMAND_OBJECT_MANAGEMENT_UPDATE_OBJECT_WITH_PROPERTIES_AND_DATA = [MISSING];
//enum WPD_PROPERTY_OBJECT_MANAGEMENT_CREATION_PROPERTIES = [MISSING];
//enum WPD_PROPERTY_OBJECT_MANAGEMENT_CONTEXT = [MISSING];
//enum WPD_PROPERTY_OBJECT_MANAGEMENT_NUM_BYTES_TO_WRITE = [MISSING];
//enum WPD_PROPERTY_OBJECT_MANAGEMENT_NUM_BYTES_WRITTEN = [MISSING];
//enum WPD_PROPERTY_OBJECT_MANAGEMENT_DATA = [MISSING];
//enum WPD_PROPERTY_OBJECT_MANAGEMENT_OBJECT_ID = [MISSING];
//enum WPD_PROPERTY_OBJECT_MANAGEMENT_DELETE_OPTIONS = [MISSING];
//enum WPD_PROPERTY_OBJECT_MANAGEMENT_OPTIMAL_TRANSFER_BUFFER_SIZE = [MISSING];
//enum WPD_PROPERTY_OBJECT_MANAGEMENT_OBJECT_IDS = [MISSING];
//enum WPD_PROPERTY_OBJECT_MANAGEMENT_DELETE_RESULTS = [MISSING];
//enum WPD_PROPERTY_OBJECT_MANAGEMENT_DESTINATION_FOLDER_OBJECT_ID = [MISSING];
//enum WPD_PROPERTY_OBJECT_MANAGEMENT_MOVE_RESULTS = [MISSING];
//enum WPD_PROPERTY_OBJECT_MANAGEMENT_COPY_RESULTS = [MISSING];
//enum WPD_PROPERTY_OBJECT_MANAGEMENT_UPDATE_PROPERTIES = [MISSING];
//enum WPD_PROPERTY_OBJECT_MANAGEMENT_PROPERTY_KEYS = [MISSING];
//enum WPD_PROPERTY_OBJECT_MANAGEMENT_OBJECT_FORMAT = [MISSING];
//enum WPD_OPTION_OBJECT_MANAGEMENT_RECURSIVE_DELETE_SUPPORTED = [MISSING];
enum WPD_CATEGORY_CAPABILITIES = GUID(0xcabec78, 0x6b74, 0x41c6, [0x92, 0x16, 0x26, 0x39, 0xd1, 0xfc, 0xe3, 0x56]);
//enum WPD_COMMAND_CAPABILITIES_GET_SUPPORTED_COMMANDS = [MISSING];
//enum WPD_COMMAND_CAPABILITIES_GET_COMMAND_OPTIONS = [MISSING];
//enum WPD_COMMAND_CAPABILITIES_GET_SUPPORTED_FUNCTIONAL_CATEGORIES = [MISSING];
//enum WPD_COMMAND_CAPABILITIES_GET_FUNCTIONAL_OBJECTS = [MISSING];
//enum WPD_COMMAND_CAPABILITIES_GET_SUPPORTED_CONTENT_TYPES = [MISSING];
//enum WPD_COMMAND_CAPABILITIES_GET_SUPPORTED_FORMATS = [MISSING];
//enum WPD_COMMAND_CAPABILITIES_GET_SUPPORTED_FORMAT_PROPERTIES = [MISSING];
//enum WPD_COMMAND_CAPABILITIES_GET_FIXED_PROPERTY_ATTRIBUTES = [MISSING];
//enum WPD_COMMAND_CAPABILITIES_GET_SUPPORTED_EVENTS = [MISSING];
//enum WPD_COMMAND_CAPABILITIES_GET_EVENT_OPTIONS = [MISSING];
//enum WPD_PROPERTY_CAPABILITIES_SUPPORTED_COMMANDS = [MISSING];
//enum WPD_PROPERTY_CAPABILITIES_COMMAND = [MISSING];
//enum WPD_PROPERTY_CAPABILITIES_COMMAND_OPTIONS = [MISSING];
//enum WPD_PROPERTY_CAPABILITIES_FUNCTIONAL_CATEGORIES = [MISSING];
//enum WPD_PROPERTY_CAPABILITIES_FUNCTIONAL_CATEGORY = [MISSING];
//enum WPD_PROPERTY_CAPABILITIES_FUNCTIONAL_OBJECTS = [MISSING];
//enum WPD_PROPERTY_CAPABILITIES_CONTENT_TYPES = [MISSING];
//enum WPD_PROPERTY_CAPABILITIES_CONTENT_TYPE = [MISSING];
//enum WPD_PROPERTY_CAPABILITIES_FORMATS = [MISSING];
//enum WPD_PROPERTY_CAPABILITIES_FORMAT = [MISSING];
//enum WPD_PROPERTY_CAPABILITIES_PROPERTY_KEYS = [MISSING];
//enum WPD_PROPERTY_CAPABILITIES_PROPERTY_ATTRIBUTES = [MISSING];
//enum WPD_PROPERTY_CAPABILITIES_SUPPORTED_EVENTS = [MISSING];
//enum WPD_PROPERTY_CAPABILITIES_EVENT = [MISSING];
//enum WPD_PROPERTY_CAPABILITIES_EVENT_OPTIONS = [MISSING];
enum WPD_CATEGORY_STORAGE = GUID(0xd8f907a6, 0x34cc, 0x45fa, [0x97, 0xfb, 0xd0, 0x7, 0xfa, 0x47, 0xec, 0x94]);
//enum WPD_COMMAND_STORAGE_FORMAT = [MISSING];
//enum WPD_COMMAND_STORAGE_EJECT = [MISSING];
//enum WPD_PROPERTY_STORAGE_OBJECT_ID = [MISSING];
//enum WPD_PROPERTY_STORAGE_DESTINATION_OBJECT_ID = [MISSING];
enum WPD_CATEGORY_SMS = GUID(0xafc25d66, 0xfe0d, 0x4114, [0x90, 0x97, 0x97, 0xc, 0x93, 0xe9, 0x20, 0xd1]);
//enum WPD_COMMAND_SMS_SEND = [MISSING];
//enum WPD_PROPERTY_SMS_RECIPIENT = [MISSING];
//enum WPD_PROPERTY_SMS_MESSAGE_TYPE = [MISSING];
//enum WPD_PROPERTY_SMS_TEXT_MESSAGE = [MISSING];
//enum WPD_PROPERTY_SMS_BINARY_MESSAGE = [MISSING];
//enum WPD_OPTION_SMS_BINARY_MESSAGE_SUPPORTED = [MISSING];
enum WPD_CATEGORY_STILL_IMAGE_CAPTURE = GUID(0x4fcd6982, 0x22a2, 0x4b05, [0xa4, 0x8b, 0x62, 0xd3, 0x8b, 0xf2, 0x7b, 0x32]);
//enum WPD_COMMAND_STILL_IMAGE_CAPTURE_INITIATE = [MISSING];
enum WPD_CATEGORY_MEDIA_CAPTURE = GUID(0x59b433ba, 0xfe44, 0x4d8d, [0x80, 0x8c, 0x6b, 0xcb, 0x9b, 0xf, 0x15, 0xe8]);
//enum WPD_COMMAND_MEDIA_CAPTURE_START = [MISSING];
//enum WPD_COMMAND_MEDIA_CAPTURE_STOP = [MISSING];
//enum WPD_COMMAND_MEDIA_CAPTURE_PAUSE = [MISSING];
enum WPD_CATEGORY_DEVICE_HINTS = GUID(0xd5fb92b, 0xcb46, 0x4c4f, [0x83, 0x43, 0xb, 0xc3, 0xd3, 0xf1, 0x7c, 0x84]);
//enum WPD_COMMAND_DEVICE_HINTS_GET_CONTENT_LOCATION = [MISSING];
//enum WPD_PROPERTY_DEVICE_HINTS_CONTENT_TYPE = [MISSING];
//enum WPD_PROPERTY_DEVICE_HINTS_CONTENT_LOCATIONS = [MISSING];
enum WPD_CLASS_EXTENSION_V1 = GUID(0x33fb0d11, 0x64a3, 0x4fac, [0xb4, 0xc7, 0x3d, 0xfe, 0xaa, 0x99, 0xb0, 0x51]);
//enum WPD_COMMAND_CLASS_EXTENSION_WRITE_DEVICE_INFORMATION = [MISSING];
//enum WPD_PROPERTY_CLASS_EXTENSION_DEVICE_INFORMATION_VALUES = [MISSING];
//enum WPD_PROPERTY_CLASS_EXTENSION_DEVICE_INFORMATION_WRITE_RESULTS = [MISSING];
enum WPD_CLASS_EXTENSION_V2 = GUID(0x7f0779b5, 0xfa2b, 0x4766, [0x9c, 0xb2, 0xf7, 0x3b, 0xa3, 0xb, 0x67, 0x58]);
//enum WPD_COMMAND_CLASS_EXTENSION_REGISTER_SERVICE_INTERFACES = [MISSING];
//enum WPD_COMMAND_CLASS_EXTENSION_UNREGISTER_SERVICE_INTERFACES = [MISSING];
//enum WPD_PROPERTY_CLASS_EXTENSION_SERVICE_OBJECT_ID = [MISSING];
//enum WPD_PROPERTY_CLASS_EXTENSION_SERVICE_INTERFACES = [MISSING];
//enum WPD_PROPERTY_CLASS_EXTENSION_SERVICE_REGISTRATION_RESULTS = [MISSING];
enum WPD_CATEGORY_NETWORK_CONFIGURATION = GUID(0x78f9c6fc, 0x79b8, 0x473c, [0x90, 0x60, 0x6b, 0xd2, 0x3d, 0xd0, 0x72, 0xc4]);
//enum WPD_COMMAND_GENERATE_KEYPAIR = [MISSING];
//enum WPD_COMMAND_COMMIT_KEYPAIR = [MISSING];
//enum WPD_COMMAND_PROCESS_WIRELESS_PROFILE = [MISSING];
//enum WPD_PROPERTY_PUBLIC_KEY = [MISSING];
enum WPD_CATEGORY_SERVICE_COMMON = GUID(0x322f071d, 0x36ef, 0x477f, [0xb4, 0xb5, 0x6f, 0x52, 0xd7, 0x34, 0xba, 0xee]);
//enum WPD_COMMAND_SERVICE_COMMON_GET_SERVICE_OBJECT_ID = [MISSING];
//enum WPD_PROPERTY_SERVICE_OBJECT_ID = [MISSING];
enum WPD_CATEGORY_SERVICE_CAPABILITIES = GUID(0x24457e74, 0x2e9f, 0x44f9, [0x8c, 0x57, 0x1d, 0x1b, 0xcb, 0x17, 0xb, 0x89]);
//enum WPD_COMMAND_SERVICE_CAPABILITIES_GET_SUPPORTED_METHODS = [MISSING];
//enum WPD_COMMAND_SERVICE_CAPABILITIES_GET_SUPPORTED_METHODS_BY_FORMAT = [MISSING];
//enum WPD_COMMAND_SERVICE_CAPABILITIES_GET_METHOD_ATTRIBUTES = [MISSING];
//enum WPD_COMMAND_SERVICE_CAPABILITIES_GET_METHOD_PARAMETER_ATTRIBUTES = [MISSING];
//enum WPD_COMMAND_SERVICE_CAPABILITIES_GET_SUPPORTED_FORMATS = [MISSING];
//enum WPD_COMMAND_SERVICE_CAPABILITIES_GET_FORMAT_ATTRIBUTES = [MISSING];
//enum WPD_COMMAND_SERVICE_CAPABILITIES_GET_SUPPORTED_FORMAT_PROPERTIES = [MISSING];
//enum WPD_COMMAND_SERVICE_CAPABILITIES_GET_FORMAT_PROPERTY_ATTRIBUTES = [MISSING];
//enum WPD_COMMAND_SERVICE_CAPABILITIES_GET_SUPPORTED_EVENTS = [MISSING];
//enum WPD_COMMAND_SERVICE_CAPABILITIES_GET_EVENT_ATTRIBUTES = [MISSING];
//enum WPD_COMMAND_SERVICE_CAPABILITIES_GET_EVENT_PARAMETER_ATTRIBUTES = [MISSING];
//enum WPD_COMMAND_SERVICE_CAPABILITIES_GET_INHERITED_SERVICES = [MISSING];
//enum WPD_COMMAND_SERVICE_CAPABILITIES_GET_FORMAT_RENDERING_PROFILES = [MISSING];
//enum WPD_COMMAND_SERVICE_CAPABILITIES_GET_SUPPORTED_COMMANDS = [MISSING];
//enum WPD_COMMAND_SERVICE_CAPABILITIES_GET_COMMAND_OPTIONS = [MISSING];
//enum WPD_PROPERTY_SERVICE_CAPABILITIES_SUPPORTED_METHODS = [MISSING];
//enum WPD_PROPERTY_SERVICE_CAPABILITIES_FORMAT = [MISSING];
//enum WPD_PROPERTY_SERVICE_CAPABILITIES_METHOD = [MISSING];
//enum WPD_PROPERTY_SERVICE_CAPABILITIES_METHOD_ATTRIBUTES = [MISSING];
//enum WPD_PROPERTY_SERVICE_CAPABILITIES_PARAMETER = [MISSING];
//enum WPD_PROPERTY_SERVICE_CAPABILITIES_PARAMETER_ATTRIBUTES = [MISSING];
//enum WPD_PROPERTY_SERVICE_CAPABILITIES_FORMATS = [MISSING];
//enum WPD_PROPERTY_SERVICE_CAPABILITIES_FORMAT_ATTRIBUTES = [MISSING];
//enum WPD_PROPERTY_SERVICE_CAPABILITIES_PROPERTY_KEYS = [MISSING];
//enum WPD_PROPERTY_SERVICE_CAPABILITIES_PROPERTY_ATTRIBUTES = [MISSING];
//enum WPD_PROPERTY_SERVICE_CAPABILITIES_SUPPORTED_EVENTS = [MISSING];
//enum WPD_PROPERTY_SERVICE_CAPABILITIES_EVENT = [MISSING];
//enum WPD_PROPERTY_SERVICE_CAPABILITIES_EVENT_ATTRIBUTES = [MISSING];
//enum WPD_PROPERTY_SERVICE_CAPABILITIES_INHERITANCE_TYPE = [MISSING];
//enum WPD_PROPERTY_SERVICE_CAPABILITIES_INHERITED_SERVICES = [MISSING];
//enum WPD_PROPERTY_SERVICE_CAPABILITIES_RENDERING_PROFILES = [MISSING];
//enum WPD_PROPERTY_SERVICE_CAPABILITIES_SUPPORTED_COMMANDS = [MISSING];
//enum WPD_PROPERTY_SERVICE_CAPABILITIES_COMMAND = [MISSING];
//enum WPD_PROPERTY_SERVICE_CAPABILITIES_COMMAND_OPTIONS = [MISSING];
enum WPD_CATEGORY_SERVICE_METHODS = GUID(0x2d521ca8, 0xc1b0, 0x4268, [0xa3, 0x42, 0xcf, 0x19, 0x32, 0x15, 0x69, 0xbc]);
//enum WPD_COMMAND_SERVICE_METHODS_START_INVOKE = [MISSING];
//enum WPD_COMMAND_SERVICE_METHODS_CANCEL_INVOKE = [MISSING];
//enum WPD_COMMAND_SERVICE_METHODS_END_INVOKE = [MISSING];
//enum WPD_PROPERTY_SERVICE_METHOD = [MISSING];
//enum WPD_PROPERTY_SERVICE_METHOD_PARAMETER_VALUES = [MISSING];
//enum WPD_PROPERTY_SERVICE_METHOD_RESULT_VALUES = [MISSING];
//enum WPD_PROPERTY_SERVICE_METHOD_CONTEXT = [MISSING];
//enum WPD_PROPERTY_SERVICE_METHOD_HRESULT = [MISSING];
//enum WPD_RESOURCE_DEFAULT = [MISSING];
//enum WPD_RESOURCE_CONTACT_PHOTO = [MISSING];
//enum WPD_RESOURCE_THUMBNAIL = [MISSING];
//enum WPD_RESOURCE_ICON = [MISSING];
//enum WPD_RESOURCE_AUDIO_CLIP = [MISSING];
//enum WPD_RESOURCE_ALBUM_ART = [MISSING];
//enum WPD_RESOURCE_GENERIC = [MISSING];
//enum WPD_RESOURCE_VIDEO_CLIP = [MISSING];
//enum WPD_RESOURCE_BRANDING_ART = [MISSING];
...
//enum WPD_OBJECT_ID = [MISSING];
//enum WPD_OBJECT_PARENT_ID = [MISSING];
//enum WPD_OBJECT_NAME = [MISSING];
//enum WPD_OBJECT_PERSISTENT_UNIQUE_ID = [MISSING];
//enum WPD_OBJECT_FORMAT = [MISSING];
//enum WPD_OBJECT_ISHIDDEN = [MISSING];
//enum WPD_OBJECT_ISSYSTEM = [MISSING];
//enum WPD_OBJECT_SIZE = [MISSING];
//enum WPD_OBJECT_ORIGINAL_FILE_NAME = [MISSING];
//enum WPD_OBJECT_NON_CONSUMABLE = [MISSING];
//enum WPD_OBJECT_KEYWORDS = [MISSING];
//enum WPD_OBJECT_SYNC_ID = [MISSING];
//enum WPD_OBJECT_IS_DRM_PROTECTED = [MISSING];
//enum WPD_OBJECT_DATE_CREATED = [MISSING];
//enum WPD_OBJECT_DATE_MODIFIED = [MISSING];
//enum WPD_OBJECT_DATE_AUTHORED = [MISSING];
//enum WPD_OBJECT_BACK_REFERENCES = [MISSING];
//enum WPD_OBJECT_CAN_DELETE = [MISSING];
//enum WPD_OBJECT_LANGUAGE_LOCALE = [MISSING];
enum WPD_FOLDER_OBJECT_PROPERTIES_V1 = GUID(0x7e9a7abf, 0xe568, 0x4b34, [0xaa, 0x2f, 0x13, 0xbb, 0x12, 0xab, 0x17, 0x7d]);
//enum WPD_FOLDER_CONTENT_TYPES_ALLOWED = [MISSING];
enum WPD_IMAGE_OBJECT_PROPERTIES_V1 = GUID(0x63d64908, 0x9fa1, 0x479f, [0x85, 0xba, 0x99, 0x52, 0x21, 0x64, 0x47, 0xdb]);
//enum WPD_IMAGE_BITDEPTH = [MISSING];
//enum WPD_IMAGE_CROPPED_STATUS = [MISSING];
//enum WPD_IMAGE_COLOR_CORRECTED_STATUS = [MISSING];
//enum WPD_IMAGE_FNUMBER = [MISSING];
//enum WPD_IMAGE_EXPOSURE_TIME = [MISSING];
//enum WPD_IMAGE_EXPOSURE_INDEX = [MISSING];
//enum WPD_IMAGE_HORIZONTAL_RESOLUTION = [MISSING];
//enum WPD_IMAGE_VERTICAL_RESOLUTION = [MISSING];
...
//enum WPD_MEDIA_TOTAL_BITRATE = [MISSING];
//enum WPD_MEDIA_BITRATE_TYPE = [MISSING];
//enum WPD_MEDIA_COPYRIGHT = [MISSING];
//enum WPD_MEDIA_SUBSCRIPTION_CONTENT_ID = [MISSING];
//enum WPD_MEDIA_USE_COUNT = [MISSING];
//enum WPD_MEDIA_SKIP_COUNT = [MISSING];
//enum WPD_MEDIA_LAST_ACCESSED_TIME = [MISSING];
//enum WPD_MEDIA_PARENTAL_RATING = [MISSING];
//enum WPD_MEDIA_META_GENRE = [MISSING];
//enum WPD_MEDIA_COMPOSER = [MISSING];
//enum WPD_MEDIA_EFFECTIVE_RATING = [MISSING];
//enum WPD_MEDIA_SUB_TITLE = [MISSING];
//enum WPD_MEDIA_RELEASE_DATE = [MISSING];
//enum WPD_MEDIA_SAMPLE_RATE = [MISSING];
//enum WPD_MEDIA_STAR_RATING = [MISSING];
//enum WPD_MEDIA_USER_EFFECTIVE_RATING = [MISSING];
//enum WPD_MEDIA_TITLE = [MISSING];
//enum WPD_MEDIA_DURATION = [MISSING];
//enum WPD_MEDIA_BUY_NOW = [MISSING];
//enum WPD_MEDIA_ENCODING_PROFILE = [MISSING];
//enum WPD_MEDIA_WIDTH = [MISSING];
//enum WPD_MEDIA_HEIGHT = [MISSING];
//enum WPD_MEDIA_ARTIST = [MISSING];
//enum WPD_MEDIA_ALBUM_ARTIST = [MISSING];
//enum WPD_MEDIA_OWNER = [MISSING];
//enum WPD_MEDIA_MANAGING_EDITOR = [MISSING];
//enum WPD_MEDIA_WEBMASTER = [MISSING];
//enum WPD_MEDIA_SOURCE_URL = [MISSING];
//enum WPD_MEDIA_DESTINATION_URL = [MISSING];
//enum WPD_MEDIA_DESCRIPTION = [MISSING];
//enum WPD_MEDIA_GENRE = [MISSING];
//enum WPD_MEDIA_TIME_BOOKMARK = [MISSING];
//enum WPD_MEDIA_OBJECT_BOOKMARK = [MISSING];
//enum WPD_MEDIA_LAST_BUILD_DATE = [MISSING];
//enum WPD_MEDIA_BYTE_BOOKMARK = [MISSING];
//enum WPD_MEDIA_TIME_TO_LIVE = [MISSING];
//enum WPD_MEDIA_GUID = [MISSING];
//enum WPD_MEDIA_SUB_DESCRIPTION = [MISSING];
//enum WPD_MEDIA_AUDIO_ENCODING_PROFILE = [MISSING];
enum WPD_CONTACT_OBJECT_PROPERTIES_V1 = GUID(0xfbd4fdab, 0x987d, 0x4777, [0xb3, 0xf9, 0x72, 0x61, 0x85, 0xa9, 0x31, 0x2b]);
//enum WPD_CONTACT_DISPLAY_NAME = [MISSING];
//enum WPD_CONTACT_FIRST_NAME = [MISSING];
//enum WPD_CONTACT_MIDDLE_NAMES = [MISSING];
//enum WPD_CONTACT_LAST_NAME = [MISSING];
//enum WPD_CONTACT_PREFIX = [MISSING];
//enum WPD_CONTACT_SUFFIX = [MISSING];
//enum WPD_CONTACT_PHONETIC_FIRST_NAME = [MISSING];
//enum WPD_CONTACT_PHONETIC_LAST_NAME = [MISSING];
//enum WPD_CONTACT_PERSONAL_FULL_POSTAL_ADDRESS = [MISSING];
//enum WPD_CONTACT_PERSONAL_POSTAL_ADDRESS_LINE1 = [MISSING];
//enum WPD_CONTACT_PERSONAL_POSTAL_ADDRESS_LINE2 = [MISSING];
//enum WPD_CONTACT_PERSONAL_POSTAL_ADDRESS_CITY = [MISSING];
//enum WPD_CONTACT_PERSONAL_POSTAL_ADDRESS_REGION = [MISSING];
//enum WPD_CONTACT_PERSONAL_POSTAL_ADDRESS_POSTAL_CODE = [MISSING];
//enum WPD_CONTACT_PERSONAL_POSTAL_ADDRESS_COUNTRY = [MISSING];
//enum WPD_CONTACT_BUSINESS_FULL_POSTAL_ADDRESS = [MISSING];
//enum WPD_CONTACT_BUSINESS_POSTAL_ADDRESS_LINE1 = [MISSING];
//enum WPD_CONTACT_BUSINESS_POSTAL_ADDRESS_LINE2 = [MISSING];
//enum WPD_CONTACT_BUSINESS_POSTAL_ADDRESS_CITY = [MISSING];
//enum WPD_CONTACT_BUSINESS_POSTAL_ADDRESS_REGION = [MISSING];
//enum WPD_CONTACT_BUSINESS_POSTAL_ADDRESS_POSTAL_CODE = [MISSING];
//enum WPD_CONTACT_BUSINESS_POSTAL_ADDRESS_COUNTRY = [MISSING];
//enum WPD_CONTACT_OTHER_FULL_POSTAL_ADDRESS = [MISSING];
//enum WPD_CONTACT_OTHER_POSTAL_ADDRESS_LINE1 = [MISSING];
//enum WPD_CONTACT_OTHER_POSTAL_ADDRESS_LINE2 = [MISSING];
//enum WPD_CONTACT_OTHER_POSTAL_ADDRESS_CITY = [MISSING];
//enum WPD_CONTACT_OTHER_POSTAL_ADDRESS_REGION = [MISSING];
//enum WPD_CONTACT_OTHER_POSTAL_ADDRESS_POSTAL_CODE = [MISSING];
//enum WPD_CONTACT_OTHER_POSTAL_ADDRESS_POSTAL_COUNTRY = [MISSING];
//enum WPD_CONTACT_PRIMARY_EMAIL_ADDRESS = [MISSING];
//enum WPD_CONTACT_PERSONAL_EMAIL = [MISSING];
//enum WPD_CONTACT_PERSONAL_EMAIL2 = [MISSING];
//enum WPD_CONTACT_BUSINESS_EMAIL = [MISSING];
//enum WPD_CONTACT_BUSINESS_EMAIL2 = [MISSING];
//enum WPD_CONTACT_OTHER_EMAILS = [MISSING];
//enum WPD_CONTACT_PRIMARY_PHONE = [MISSING];
//enum WPD_CONTACT_PERSONAL_PHONE = [MISSING];
//enum WPD_CONTACT_PERSONAL_PHONE2 = [MISSING];
//enum WPD_CONTACT_BUSINESS_PHONE = [MISSING];
//enum WPD_CONTACT_BUSINESS_PHONE2 = [MISSING];
//enum WPD_CONTACT_MOBILE_PHONE = [MISSING];
//enum WPD_CONTACT_MOBILE_PHONE2 = [MISSING];
//enum WPD_CONTACT_PERSONAL_FAX = [MISSING];
//enum WPD_CONTACT_BUSINESS_FAX = [MISSING];
//enum WPD_CONTACT_PAGER = [MISSING];
//enum WPD_CONTACT_OTHER_PHONES = [MISSING];
//enum WPD_CONTACT_PRIMARY_WEB_ADDRESS = [MISSING];
//enum WPD_CONTACT_PERSONAL_WEB_ADDRESS = [MISSING];
//enum WPD_CONTACT_BUSINESS_WEB_ADDRESS = [MISSING];
//enum WPD_CONTACT_INSTANT_MESSENGER = [MISSING];
//enum WPD_CONTACT_INSTANT_MESSENGER2 = [MISSING];
//enum WPD_CONTACT_INSTANT_MESSENGER3 = [MISSING];
//enum WPD_CONTACT_COMPANY_NAME = [MISSING];
//enum WPD_CONTACT_PHONETIC_COMPANY_NAME = [MISSING];
//enum WPD_CONTACT_ROLE = [MISSING];
//enum WPD_CONTACT_BIRTHDATE = [MISSING];
//enum WPD_CONTACT_PRIMARY_FAX = [MISSING];
//enum WPD_CONTACT_SPOUSE = [MISSING];
//enum WPD_CONTACT_CHILDREN = [MISSING];
//enum WPD_CONTACT_ASSISTANT = [MISSING];
//enum WPD_CONTACT_ANNIVERSARY_DATE = [MISSING];
//enum WPD_CONTACT_RINGTONE = [MISSING];
enum WPD_MUSIC_OBJECT_PROPERTIES_V1 = GUID(0xb324f56a, 0xdc5d, 0x46e5, [0xb6, 0xdf, 0xd2, 0xea, 0x41, 0x48, 0x88, 0xc6]);
//enum WPD_MUSIC_ALBUM = [MISSING];
//enum WPD_MUSIC_TRACK = [MISSING];
//enum WPD_MUSIC_LYRICS = [MISSING];
//enum WPD_MUSIC_MOOD = [MISSING];
//enum WPD_AUDIO_BITRATE = [MISSING];
//enum WPD_AUDIO_CHANNEL_COUNT = [MISSING];
//enum WPD_AUDIO_FORMAT_CODE = [MISSING];
//enum WPD_AUDIO_BIT_DEPTH = [MISSING];
//enum WPD_AUDIO_BLOCK_ALIGNMENT = [MISSING];
enum WPD_VIDEO_OBJECT_PROPERTIES_V1 = GUID(0x346f2163, 0xf998, 0x4146, [0x8b, 0x1, 0xd1, 0x9b, 0x4c, 0x0, 0xde, 0x9a]);
//enum WPD_VIDEO_AUTHOR = [MISSING];
//enum WPD_VIDEO_RECORDEDTV_STATION_NAME = [MISSING];
//enum WPD_VIDEO_RECORDEDTV_CHANNEL_NUMBER = [MISSING];
//enum WPD_VIDEO_RECORDEDTV_REPEAT = [MISSING];
//enum WPD_VIDEO_BUFFER_SIZE = [MISSING];
//enum WPD_VIDEO_CREDITS = [MISSING];
//enum WPD_VIDEO_KEY_FRAME_DISTANCE = [MISSING];
//enum WPD_VIDEO_QUALITY_SETTING = [MISSING];
//enum WPD_VIDEO_SCAN_TYPE = [MISSING];
//enum WPD_VIDEO_BITRATE = [MISSING];
//enum WPD_VIDEO_FOURCC_CODE = [MISSING];
//enum WPD_VIDEO_FRAMERATE = [MISSING];
enum WPD_COMMON_INFORMATION_OBJECT_PROPERTIES_V1 = GUID(0xb28ae94b, 0x5a4, 0x4e8e, [0xbe, 0x1, 0x72, 0xcc, 0x7e, 0x9, 0x9d, 0x8f]);
//enum WPD_COMMON_INFORMATION_SUBJECT = [MISSING];
//enum WPD_COMMON_INFORMATION_BODY_TEXT = [MISSING];
//enum WPD_COMMON_INFORMATION_PRIORITY = [MISSING];
//enum WPD_COMMON_INFORMATION_START_DATETIME = [MISSING];
//enum WPD_COMMON_INFORMATION_END_DATETIME = [MISSING];
//enum WPD_COMMON_INFORMATION_NOTES = [MISSING];
...
//enum WPD_EMAIL_TO_LINE = [MISSING];
//enum WPD_EMAIL_CC_LINE = [MISSING];
//enum WPD_EMAIL_BCC_LINE = [MISSING];
//enum WPD_EMAIL_HAS_BEEN_READ = [MISSING];
//enum WPD_EMAIL_RECEIVED_TIME = [MISSING];
//enum WPD_EMAIL_HAS_ATTACHMENTS = [MISSING];
//enum WPD_EMAIL_SENDER_ADDRESS = [MISSING];
enum WPD_APPOINTMENT_OBJECT_PROPERTIES_V1 = GUID(0xf99efd03, 0x431d, 0x40d8, [0xa1, 0xc9, 0x4e, 0x22, 0xd, 0x9c, 0x88, 0xd3]);
//enum WPD_APPOINTMENT_LOCATION = [MISSING];
//enum WPD_APPOINTMENT_TYPE = [MISSING];
//enum WPD_APPOINTMENT_REQUIRED_ATTENDEES = [MISSING];
//enum WPD_APPOINTMENT_OPTIONAL_ATTENDEES = [MISSING];
//enum WPD_APPOINTMENT_ACCEPTED_ATTENDEES = [MISSING];
//enum WPD_APPOINTMENT_RESOURCES = [MISSING];
//enum WPD_APPOINTMENT_TENTATIVE_ATTENDEES = [MISSING];
//enum WPD_APPOINTMENT_DECLINED_ATTENDEES = [MISSING];
enum WPD_TASK_OBJECT_PROPERTIES_V1 = GUID(0xe354e95e, 0xd8a0, 0x4637, [0xa0, 0x3a, 0xc, 0xb2, 0x68, 0x38, 0xdb, 0xc7]);
//enum WPD_TASK_STATUS = [MISSING];
//enum WPD_TASK_PERCENT_COMPLETE = [MISSING];
//enum WPD_TASK_REMINDER_DATE = [MISSING];
//enum WPD_TASK_OWNER = [MISSING];
enum WPD_SMS_OBJECT_PROPERTIES_V1 = GUID(0x7e1074cc, 0x50ff, 0x4dd1, [0xa7, 0x42, 0x53, 0xbe, 0x6f, 0x9, 0x3a, 0xd]);
//enum WPD_SMS_PROVIDER = [MISSING];
//enum WPD_SMS_TIMEOUT = [MISSING];
//enum WPD_SMS_MAX_PAYLOAD = [MISSING];
//enum WPD_SMS_ENCODING = [MISSING];
enum WPD_SECTION_OBJECT_PROPERTIES_V1 = GUID(0x516afd2b, 0xc64e, 0x44f0, [0x98, 0xdc, 0xbe, 0xe1, 0xc8, 0x8f, 0x7d, 0x66]);
//enum WPD_SECTION_DATA_OFFSET = [MISSING];
//enum WPD_SECTION_DATA_LENGTH = [MISSING];
//enum WPD_SECTION_DATA_UNITS = [MISSING];
//enum WPD_SECTION_DATA_REFERENCED_OBJECT_RESOURCE = [MISSING];
...
//enum WPD_COMMAND_MTP_EXT_GET_SUPPORTED_VENDOR_OPCODES = [MISSING];
//enum WPD_COMMAND_MTP_EXT_EXECUTE_COMMAND_WITHOUT_DATA_PHASE = [MISSING];
//enum WPD_COMMAND_MTP_EXT_EXECUTE_COMMAND_WITH_DATA_TO_READ = [MISSING];
//enum WPD_COMMAND_MTP_EXT_EXECUTE_COMMAND_WITH_DATA_TO_WRITE = [MISSING];
//enum WPD_COMMAND_MTP_EXT_READ_DATA = [MISSING];
//enum WPD_COMMAND_MTP_EXT_WRITE_DATA = [MISSING];
//enum WPD_COMMAND_MTP_EXT_END_DATA_TRANSFER = [MISSING];
//enum WPD_COMMAND_MTP_EXT_GET_VENDOR_EXTENSION_DESCRIPTION = [MISSING];
//enum WPD_PROPERTY_MTP_EXT_OPERATION_CODE = [MISSING];
//enum WPD_PROPERTY_MTP_EXT_OPERATION_PARAMS = [MISSING];
//enum WPD_PROPERTY_MTP_EXT_RESPONSE_CODE = [MISSING];
//enum WPD_PROPERTY_MTP_EXT_RESPONSE_PARAMS = [MISSING];
//enum WPD_PROPERTY_MTP_EXT_VENDOR_OPERATION_CODES = [MISSING];
//enum WPD_PROPERTY_MTP_EXT_TRANSFER_CONTEXT = [MISSING];
//enum WPD_PROPERTY_MTP_EXT_TRANSFER_TOTAL_DATA_SIZE = [MISSING];
//enum WPD_PROPERTY_MTP_EXT_TRANSFER_NUM_BYTES_TO_READ = [MISSING];
//enum WPD_PROPERTY_MTP_EXT_TRANSFER_NUM_BYTES_READ = [MISSING];
//enum WPD_PROPERTY_MTP_EXT_TRANSFER_NUM_BYTES_TO_WRITE = [MISSING];
//enum WPD_PROPERTY_MTP_EXT_TRANSFER_NUM_BYTES_WRITTEN = [MISSING];
//enum WPD_PROPERTY_MTP_EXT_TRANSFER_DATA = [MISSING];
//enum WPD_PROPERTY_MTP_EXT_OPTIMAL_TRANSFER_BUFFER_SIZE = [MISSING];
//enum WPD_PROPERTY_MTP_EXT_VENDOR_EXTENSION_DESCRIPTION = [MISSING];
...
//enum WPD_PROPERTY_MTP_EXT_EVENT_PARAMS = [MISSING];
...
//enum WPDNSE_OBJECT_HAS_CONTACT_PHOTO = [MISSING];
//enum WPDNSE_OBJECT_HAS_THUMBNAIL = [MISSING];
//enum WPDNSE_OBJECT_HAS_ICON = [MISSING];
//enum WPDNSE_OBJECT_HAS_AUDIO_CLIP = [MISSING];
//enum WPDNSE_OBJECT_HAS_ALBUM_ART = [MISSING];
//enum WPDNSE_OBJECT_OPTIMAL_READ_BLOCK_SIZE = [MISSING];
