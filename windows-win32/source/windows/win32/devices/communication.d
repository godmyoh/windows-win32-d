...
BOOL GetDefaultCommConfigA(const(char)* lpszName, COMMCONFIG* lpCC, uint* lpdwSize);
BOOL GetDefaultCommConfigW(const(wchar)* lpszName, COMMCONFIG* lpCC, uint* lpdwSize);
BOOL SetDefaultCommConfigA(const(char)* lpszName, COMMCONFIG* lpCC, uint dwSize);
BOOL SetDefaultCommConfigW(const(wchar)* lpszName, COMMCONFIG* lpCC, uint dwSize);
