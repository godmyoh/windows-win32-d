...
NTSTATUS HidP_GetCaps(long, HIDP_CAPS*);
NTSTATUS HidP_GetLinkCollectionNodes(HIDP_LINK_COLLECTION_NODE*, uint*, long);
NTSTATUS HidP_GetSpecificButtonCaps(HIDP_REPORT_TYPE, ushort, ushort, ushort, HIDP_BUTTON_CAPS*, ushort*, long);
NTSTATUS HidP_GetButtonCaps(HIDP_REPORT_TYPE, HIDP_BUTTON_CAPS*, ushort*, long);
NTSTATUS HidP_GetSpecificValueCaps(HIDP_REPORT_TYPE, ushort, ushort, ushort, HIDP_VALUE_CAPS*, ushort*, long);
NTSTATUS HidP_GetValueCaps(HIDP_REPORT_TYPE, HIDP_VALUE_CAPS*, ushort*, long);
NTSTATUS HidP_GetExtendedAttributes(HIDP_REPORT_TYPE, ushort, long, HIDP_EXTENDED_ATTRIBUTES*, uint*);
NTSTATUS HidP_InitializeReportForID(HIDP_REPORT_TYPE, ubyte, long, PSTR, uint);
NTSTATUS HidP_SetData(HIDP_REPORT_TYPE, HIDP_DATA*, uint*, long, PSTR, uint);
NTSTATUS HidP_GetData(HIDP_REPORT_TYPE, HIDP_DATA*, uint*, long, PSTR, uint);
uint HidP_MaxDataListLength(HIDP_REPORT_TYPE, long);
NTSTATUS HidP_SetUsages(HIDP_REPORT_TYPE, ushort, ushort, ushort*, uint*, long, PSTR, uint);
NTSTATUS HidP_UnsetUsages(HIDP_REPORT_TYPE, ushort, ushort, ushort*, uint*, long, PSTR, uint);
NTSTATUS HidP_GetUsages(HIDP_REPORT_TYPE, ushort, ushort, ushort*, uint*, long, PSTR, uint);
NTSTATUS HidP_GetUsagesEx(HIDP_REPORT_TYPE, ushort, USAGE_AND_PAGE*, uint*, long, PSTR, uint);
uint HidP_MaxUsageListLength(HIDP_REPORT_TYPE, ushort, long);
NTSTATUS HidP_SetUsageValue(HIDP_REPORT_TYPE, ushort, ushort, ushort, uint, long, PSTR, uint);
NTSTATUS HidP_SetScaledUsageValue(HIDP_REPORT_TYPE, ushort, ushort, ushort, int, long, PSTR, uint);
NTSTATUS HidP_SetUsageValueArray(HIDP_REPORT_TYPE, ushort, ushort, ushort, PSTR, ushort, long, PSTR, uint);
NTSTATUS HidP_GetUsageValue(HIDP_REPORT_TYPE, ushort, ushort, ushort, uint*, long, PSTR, uint);
NTSTATUS HidP_GetScaledUsageValue(HIDP_REPORT_TYPE, ushort, ushort, ushort, int*, long, PSTR, uint);
NTSTATUS HidP_GetUsageValueArray(HIDP_REPORT_TYPE, ushort, ushort, ushort, PSTR, ushort, long, PSTR, uint);
NTSTATUS HidP_UsageListDifference(ushort*, ushort*, ushort*, ushort*, uint);
NTSTATUS HidP_GetButtonArray(HIDP_REPORT_TYPE, ushort, ushort, ushort, HIDP_BUTTON_ARRAY_DATA*, ushort*, long, PSTR, uint);
NTSTATUS HidP_SetButtonArray(HIDP_REPORT_TYPE, ushort, ushort, ushort, HIDP_BUTTON_ARRAY_DATA*, ushort, long, PSTR, uint);
...
BOOLEAN HidD_GetPreparsedData(HANDLE, long*);
BOOLEAN HidD_FreePreparsedData(long);
