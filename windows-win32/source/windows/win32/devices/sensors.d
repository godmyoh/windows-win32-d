...
enum SENSOR_EVENT_PARAMETER_EVENT_ID = PROPERTYKEY(GUID(1681157680, 34600, 19252, [189, 246, 79, 82, 68, 44, 92, 40]), 2);
enum SENSOR_EVENT_PARAMETER_STATE = PROPERTYKEY(GUID(1681157680, 34600, 19252, [189, 246, 79, 82, 68, 44, 92, 40]), 3);
...
enum SENSOR_PROPERTY_TYPE = PROPERTYKEY(GUID(2139325420, 54252, 18780, [168, 207, 184, 187, 232, 92, 41, 32]), 2);
enum SENSOR_PROPERTY_STATE = PROPERTYKEY(GUID(2139325420, 54252, 18780, [168, 207, 184, 187, 232, 92, 41, 32]), 3);
enum SENSOR_PROPERTY_PERSISTENT_UNIQUE_ID = PROPERTYKEY(GUID(2139325420, 54252, 18780, [168, 207, 184, 187, 232, 92, 41, 32]), 5);
enum SENSOR_PROPERTY_MANUFACTURER = PROPERTYKEY(GUID(2139325420, 54252, 18780, [168, 207, 184, 187, 232, 92, 41, 32]), 6);
enum SENSOR_PROPERTY_MODEL = PROPERTYKEY(GUID(2139325420, 54252, 18780, [168, 207, 184, 187, 232, 92, 41, 32]), 7);
enum SENSOR_PROPERTY_SERIAL_NUMBER = PROPERTYKEY(GUID(2139325420, 54252, 18780, [168, 207, 184, 187, 232, 92, 41, 32]), 8);
enum SENSOR_PROPERTY_FRIENDLY_NAME = PROPERTYKEY(GUID(2139325420, 54252, 18780, [168, 207, 184, 187, 232, 92, 41, 32]), 9);
enum SENSOR_PROPERTY_DESCRIPTION = PROPERTYKEY(GUID(2139325420, 54252, 18780, [168, 207, 184, 187, 232, 92, 41, 32]), 10);
enum SENSOR_PROPERTY_CONNECTION_TYPE = PROPERTYKEY(GUID(2139325420, 54252, 18780, [168, 207, 184, 187, 232, 92, 41, 32]), 11);
enum SENSOR_PROPERTY_MIN_REPORT_INTERVAL = PROPERTYKEY(GUID(2139325420, 54252, 18780, [168, 207, 184, 187, 232, 92, 41, 32]), 12);
enum SENSOR_PROPERTY_CURRENT_REPORT_INTERVAL = PROPERTYKEY(GUID(2139325420, 54252, 18780, [168, 207, 184, 187, 232, 92, 41, 32]), 13);
enum SENSOR_PROPERTY_CHANGE_SENSITIVITY = PROPERTYKEY(GUID(2139325420, 54252, 18780, [168, 207, 184, 187, 232, 92, 41, 32]), 14);
enum SENSOR_PROPERTY_DEVICE_PATH = PROPERTYKEY(GUID(2139325420, 54252, 18780, [168, 207, 184, 187, 232, 92, 41, 32]), 15);
enum SENSOR_PROPERTY_LIGHT_RESPONSE_CURVE = PROPERTYKEY(GUID(2139325420, 54252, 18780, [168, 207, 184, 187, 232, 92, 41, 32]), 16);
enum SENSOR_PROPERTY_ACCURACY = PROPERTYKEY(GUID(2139325420, 54252, 18780, [168, 207, 184, 187, 232, 92, 41, 32]), 17);
enum SENSOR_PROPERTY_RESOLUTION = PROPERTYKEY(GUID(2139325420, 54252, 18780, [168, 207, 184, 187, 232, 92, 41, 32]), 18);
enum SENSOR_PROPERTY_LOCATION_DESIRED_ACCURACY = PROPERTYKEY(GUID(2139325420, 54252, 18780, [168, 207, 184, 187, 232, 92, 41, 32]), 19);
enum SENSOR_PROPERTY_RANGE_MINIMUM = PROPERTYKEY(GUID(2139325420, 54252, 18780, [168, 207, 184, 187, 232, 92, 41, 32]), 20);
enum SENSOR_PROPERTY_RANGE_MAXIMUM = PROPERTYKEY(GUID(2139325420, 54252, 18780, [168, 207, 184, 187, 232, 92, 41, 32]), 21);
enum SENSOR_PROPERTY_HID_USAGE = PROPERTYKEY(GUID(2139325420, 54252, 18780, [168, 207, 184, 187, 232, 92, 41, 32]), 22);
enum SENSOR_PROPERTY_RADIO_STATE = PROPERTYKEY(GUID(2139325420, 54252, 18780, [168, 207, 184, 187, 232, 92, 41, 32]), 23);
enum SENSOR_PROPERTY_RADIO_STATE_PREVIOUS = PROPERTYKEY(GUID(2139325420, 54252, 18780, [168, 207, 184, 187, 232, 92, 41, 32]), 24);
...
enum SENSOR_DATA_TYPE_TIMESTAMP = PROPERTYKEY(GUID(3680374002, 53023, 19480, [180, 108, 216, 96, 17, 214, 33, 80]), 2);
enum SENSOR_DATA_TYPE_LOCATION_GUID = GUID(0x55c74d8, 0xca6f, 0x47d6, [0x95, 0xc6, 0x1e, 0xd3, 0x63, 0x7a, 0xf, 0xf4]);
enum SENSOR_DATA_TYPE_LATITUDE_DEGREES = PROPERTYKEY(GUID(89945304, 51823, 18390, [149, 198, 30, 211, 99, 122, 15, 244]), 2);
enum SENSOR_DATA_TYPE_LONGITUDE_DEGREES = PROPERTYKEY(GUID(89945304, 51823, 18390, [149, 198, 30, 211, 99, 122, 15, 244]), 3);
enum SENSOR_DATA_TYPE_ALTITUDE_SEALEVEL_METERS = PROPERTYKEY(GUID(89945304, 51823, 18390, [149, 198, 30, 211, 99, 122, 15, 244]), 4);
enum SENSOR_DATA_TYPE_ALTITUDE_ELLIPSOID_METERS = PROPERTYKEY(GUID(89945304, 51823, 18390, [149, 198, 30, 211, 99, 122, 15, 244]), 5);
enum SENSOR_DATA_TYPE_SPEED_KNOTS = PROPERTYKEY(GUID(89945304, 51823, 18390, [149, 198, 30, 211, 99, 122, 15, 244]), 6);
enum SENSOR_DATA_TYPE_TRUE_HEADING_DEGREES = PROPERTYKEY(GUID(89945304, 51823, 18390, [149, 198, 30, 211, 99, 122, 15, 244]), 7);
enum SENSOR_DATA_TYPE_MAGNETIC_HEADING_DEGREES = PROPERTYKEY(GUID(89945304, 51823, 18390, [149, 198, 30, 211, 99, 122, 15, 244]), 8);
enum SENSOR_DATA_TYPE_MAGNETIC_VARIATION = PROPERTYKEY(GUID(89945304, 51823, 18390, [149, 198, 30, 211, 99, 122, 15, 244]), 9);
enum SENSOR_DATA_TYPE_FIX_QUALITY = PROPERTYKEY(GUID(89945304, 51823, 18390, [149, 198, 30, 211, 99, 122, 15, 244]), 10);
enum SENSOR_DATA_TYPE_FIX_TYPE = PROPERTYKEY(GUID(89945304, 51823, 18390, [149, 198, 30, 211, 99, 122, 15, 244]), 11);
enum SENSOR_DATA_TYPE_POSITION_DILUTION_OF_PRECISION = PROPERTYKEY(GUID(89945304, 51823, 18390, [149, 198, 30, 211, 99, 122, 15, 244]), 12);
enum SENSOR_DATA_TYPE_HORIZONAL_DILUTION_OF_PRECISION = PROPERTYKEY(GUID(89945304, 51823, 18390, [149, 198, 30, 211, 99, 122, 15, 244]), 13);
enum SENSOR_DATA_TYPE_VERTICAL_DILUTION_OF_PRECISION = PROPERTYKEY(GUID(89945304, 51823, 18390, [149, 198, 30, 211, 99, 122, 15, 244]), 14);
enum SENSOR_DATA_TYPE_SATELLITES_USED_COUNT = PROPERTYKEY(GUID(89945304, 51823, 18390, [149, 198, 30, 211, 99, 122, 15, 244]), 15);
enum SENSOR_DATA_TYPE_SATELLITES_USED_PRNS = PROPERTYKEY(GUID(89945304, 51823, 18390, [149, 198, 30, 211, 99, 122, 15, 244]), 16);
enum SENSOR_DATA_TYPE_SATELLITES_IN_VIEW = PROPERTYKEY(GUID(89945304, 51823, 18390, [149, 198, 30, 211, 99, 122, 15, 244]), 17);
enum SENSOR_DATA_TYPE_SATELLITES_IN_VIEW_PRNS = PROPERTYKEY(GUID(89945304, 51823, 18390, [149, 198, 30, 211, 99, 122, 15, 244]), 18);
enum SENSOR_DATA_TYPE_SATELLITES_IN_VIEW_ELEVATION = PROPERTYKEY(GUID(89945304, 51823, 18390, [149, 198, 30, 211, 99, 122, 15, 244]), 19);
enum SENSOR_DATA_TYPE_SATELLITES_IN_VIEW_AZIMUTH = PROPERTYKEY(GUID(89945304, 51823, 18390, [149, 198, 30, 211, 99, 122, 15, 244]), 20);
enum SENSOR_DATA_TYPE_SATELLITES_IN_VIEW_STN_RATIO = PROPERTYKEY(GUID(89945304, 51823, 18390, [149, 198, 30, 211, 99, 122, 15, 244]), 21);
enum SENSOR_DATA_TYPE_ERROR_RADIUS_METERS = PROPERTYKEY(GUID(89945304, 51823, 18390, [149, 198, 30, 211, 99, 122, 15, 244]), 22);
enum SENSOR_DATA_TYPE_ADDRESS1 = PROPERTYKEY(GUID(89945304, 51823, 18390, [149, 198, 30, 211, 99, 122, 15, 244]), 23);
enum SENSOR_DATA_TYPE_ADDRESS2 = PROPERTYKEY(GUID(89945304, 51823, 18390, [149, 198, 30, 211, 99, 122, 15, 244]), 24);
enum SENSOR_DATA_TYPE_CITY = PROPERTYKEY(GUID(89945304, 51823, 18390, [149, 198, 30, 211, 99, 122, 15, 244]), 25);
enum SENSOR_DATA_TYPE_STATE_PROVINCE = PROPERTYKEY(GUID(89945304, 51823, 18390, [149, 198, 30, 211, 99, 122, 15, 244]), 26);
enum SENSOR_DATA_TYPE_POSTALCODE = PROPERTYKEY(GUID(89945304, 51823, 18390, [149, 198, 30, 211, 99, 122, 15, 244]), 27);
enum SENSOR_DATA_TYPE_COUNTRY_REGION = PROPERTYKEY(GUID(89945304, 51823, 18390, [149, 198, 30, 211, 99, 122, 15, 244]), 28);
enum SENSOR_DATA_TYPE_ALTITUDE_ELLIPSOID_ERROR_METERS = PROPERTYKEY(GUID(89945304, 51823, 18390, [149, 198, 30, 211, 99, 122, 15, 244]), 29);
enum SENSOR_DATA_TYPE_ALTITUDE_SEALEVEL_ERROR_METERS = PROPERTYKEY(GUID(89945304, 51823, 18390, [149, 198, 30, 211, 99, 122, 15, 244]), 30);
enum SENSOR_DATA_TYPE_GPS_SELECTION_MODE = PROPERTYKEY(GUID(89945304, 51823, 18390, [149, 198, 30, 211, 99, 122, 15, 244]), 31);
enum SENSOR_DATA_TYPE_GPS_OPERATION_MODE = PROPERTYKEY(GUID(89945304, 51823, 18390, [149, 198, 30, 211, 99, 122, 15, 244]), 32);
enum SENSOR_DATA_TYPE_GPS_STATUS = PROPERTYKEY(GUID(89945304, 51823, 18390, [149, 198, 30, 211, 99, 122, 15, 244]), 33);
enum SENSOR_DATA_TYPE_GEOIDAL_SEPARATION = PROPERTYKEY(GUID(89945304, 51823, 18390, [149, 198, 30, 211, 99, 122, 15, 244]), 34);
enum SENSOR_DATA_TYPE_DGPS_DATA_AGE = PROPERTYKEY(GUID(89945304, 51823, 18390, [149, 198, 30, 211, 99, 122, 15, 244]), 35);
enum SENSOR_DATA_TYPE_ALTITUDE_ANTENNA_SEALEVEL_METERS = PROPERTYKEY(GUID(89945304, 51823, 18390, [149, 198, 30, 211, 99, 122, 15, 244]), 36);
enum SENSOR_DATA_TYPE_DIFFERENTIAL_REFERENCE_STATION_ID = PROPERTYKEY(GUID(89945304, 51823, 18390, [149, 198, 30, 211, 99, 122, 15, 244]), 37);
enum SENSOR_DATA_TYPE_NMEA_SENTENCE = PROPERTYKEY(GUID(89945304, 51823, 18390, [149, 198, 30, 211, 99, 122, 15, 244]), 38);
enum SENSOR_DATA_TYPE_SATELLITES_IN_VIEW_ID = PROPERTYKEY(GUID(89945304, 51823, 18390, [149, 198, 30, 211, 99, 122, 15, 244]), 39);
enum SENSOR_DATA_TYPE_LOCATION_SOURCE = PROPERTYKEY(GUID(89945304, 51823, 18390, [149, 198, 30, 211, 99, 122, 15, 244]), 40);
enum SENSOR_DATA_TYPE_SATELLITES_USED_PRNS_AND_CONSTELLATIONS = PROPERTYKEY(GUID(89945304, 51823, 18390, [149, 198, 30, 211, 99, 122, 15, 244]), 41);
enum SENSOR_DATA_TYPE_ENVIRONMENTAL_GUID = GUID(0x8b0aa2f1, 0x2d57, 0x42ee, [0x8c, 0xc0, 0x4d, 0x27, 0x62, 0x2b, 0x46, 0xc4]);
enum SENSOR_DATA_TYPE_TEMPERATURE_CELSIUS = PROPERTYKEY(GUID(2332730097, 11607, 17134, [140, 192, 77, 39, 98, 43, 70, 196]), 2);
enum SENSOR_DATA_TYPE_RELATIVE_HUMIDITY_PERCENT = PROPERTYKEY(GUID(2332730097, 11607, 17134, [140, 192, 77, 39, 98, 43, 70, 196]), 3);
enum SENSOR_DATA_TYPE_ATMOSPHERIC_PRESSURE_BAR = PROPERTYKEY(GUID(2332730097, 11607, 17134, [140, 192, 77, 39, 98, 43, 70, 196]), 4);
enum SENSOR_DATA_TYPE_WIND_DIRECTION_DEGREES_ANTICLOCKWISE = PROPERTYKEY(GUID(2332730097, 11607, 17134, [140, 192, 77, 39, 98, 43, 70, 196]), 5);
enum SENSOR_DATA_TYPE_WIND_SPEED_METERS_PER_SECOND = PROPERTYKEY(GUID(2332730097, 11607, 17134, [140, 192, 77, 39, 98, 43, 70, 196]), 6);
enum SENSOR_DATA_TYPE_MOTION_GUID = GUID(0x3f8a69a2, 0x7c5, 0x4e48, [0xa9, 0x65, 0xcd, 0x79, 0x7a, 0xab, 0x56, 0xd5]);
enum SENSOR_DATA_TYPE_ACCELERATION_X_G = PROPERTYKEY(GUID(1066035618, 1989, 20040, [169, 101, 205, 121, 122, 171, 86, 213]), 2);
enum SENSOR_DATA_TYPE_ACCELERATION_Y_G = PROPERTYKEY(GUID(1066035618, 1989, 20040, [169, 101, 205, 121, 122, 171, 86, 213]), 3);
enum SENSOR_DATA_TYPE_ACCELERATION_Z_G = PROPERTYKEY(GUID(1066035618, 1989, 20040, [169, 101, 205, 121, 122, 171, 86, 213]), 4);
enum SENSOR_DATA_TYPE_ANGULAR_ACCELERATION_X_DEGREES_PER_SECOND_SQUARED = PROPERTYKEY(GUID(1066035618, 1989, 20040, [169, 101, 205, 121, 122, 171, 86, 213]), 5);
enum SENSOR_DATA_TYPE_ANGULAR_ACCELERATION_Y_DEGREES_PER_SECOND_SQUARED = PROPERTYKEY(GUID(1066035618, 1989, 20040, [169, 101, 205, 121, 122, 171, 86, 213]), 6);
enum SENSOR_DATA_TYPE_ANGULAR_ACCELERATION_Z_DEGREES_PER_SECOND_SQUARED = PROPERTYKEY(GUID(1066035618, 1989, 20040, [169, 101, 205, 121, 122, 171, 86, 213]), 7);
enum SENSOR_DATA_TYPE_SPEED_METERS_PER_SECOND = PROPERTYKEY(GUID(1066035618, 1989, 20040, [169, 101, 205, 121, 122, 171, 86, 213]), 8);
enum SENSOR_DATA_TYPE_MOTION_STATE = PROPERTYKEY(GUID(1066035618, 1989, 20040, [169, 101, 205, 121, 122, 171, 86, 213]), 9);
enum SENSOR_DATA_TYPE_ANGULAR_VELOCITY_X_DEGREES_PER_SECOND = PROPERTYKEY(GUID(1066035618, 1989, 20040, [169, 101, 205, 121, 122, 171, 86, 213]), 10);
enum SENSOR_DATA_TYPE_ANGULAR_VELOCITY_Y_DEGREES_PER_SECOND = PROPERTYKEY(GUID(1066035618, 1989, 20040, [169, 101, 205, 121, 122, 171, 86, 213]), 11);
enum SENSOR_DATA_TYPE_ANGULAR_VELOCITY_Z_DEGREES_PER_SECOND = PROPERTYKEY(GUID(1066035618, 1989, 20040, [169, 101, 205, 121, 122, 171, 86, 213]), 12);
enum SENSOR_DATA_TYPE_ORIENTATION_GUID = GUID(0x1637d8a2, 0x4248, 0x4275, [0x86, 0x5d, 0x55, 0x8d, 0xe8, 0x4a, 0xed, 0xfd]);
enum SENSOR_DATA_TYPE_TILT_X_DEGREES = PROPERTYKEY(GUID(372758690, 16968, 17013, [134, 93, 85, 141, 232, 74, 237, 253]), 2);
enum SENSOR_DATA_TYPE_TILT_Y_DEGREES = PROPERTYKEY(GUID(372758690, 16968, 17013, [134, 93, 85, 141, 232, 74, 237, 253]), 3);
enum SENSOR_DATA_TYPE_TILT_Z_DEGREES = PROPERTYKEY(GUID(372758690, 16968, 17013, [134, 93, 85, 141, 232, 74, 237, 253]), 4);
enum SENSOR_DATA_TYPE_MAGNETIC_HEADING_X_DEGREES = PROPERTYKEY(GUID(372758690, 16968, 17013, [134, 93, 85, 141, 232, 74, 237, 253]), 5);
enum SENSOR_DATA_TYPE_MAGNETIC_HEADING_Y_DEGREES = PROPERTYKEY(GUID(372758690, 16968, 17013, [134, 93, 85, 141, 232, 74, 237, 253]), 6);
enum SENSOR_DATA_TYPE_MAGNETIC_HEADING_Z_DEGREES = PROPERTYKEY(GUID(372758690, 16968, 17013, [134, 93, 85, 141, 232, 74, 237, 253]), 7);
enum SENSOR_DATA_TYPE_DISTANCE_X_METERS = PROPERTYKEY(GUID(372758690, 16968, 17013, [134, 93, 85, 141, 232, 74, 237, 253]), 8);
enum SENSOR_DATA_TYPE_DISTANCE_Y_METERS = PROPERTYKEY(GUID(372758690, 16968, 17013, [134, 93, 85, 141, 232, 74, 237, 253]), 9);
enum SENSOR_DATA_TYPE_DISTANCE_Z_METERS = PROPERTYKEY(GUID(372758690, 16968, 17013, [134, 93, 85, 141, 232, 74, 237, 253]), 10);
enum SENSOR_DATA_TYPE_MAGNETIC_HEADING_COMPENSATED_MAGNETIC_NORTH_DEGREES = PROPERTYKEY(GUID(372758690, 16968, 17013, [134, 93, 85, 141, 232, 74, 237, 253]), 11);
enum SENSOR_DATA_TYPE_MAGNETIC_HEADING_COMPENSATED_TRUE_NORTH_DEGREES = PROPERTYKEY(GUID(372758690, 16968, 17013, [134, 93, 85, 141, 232, 74, 237, 253]), 12);
enum SENSOR_DATA_TYPE_MAGNETIC_HEADING_MAGNETIC_NORTH_DEGREES = PROPERTYKEY(GUID(372758690, 16968, 17013, [134, 93, 85, 141, 232, 74, 237, 253]), 13);
enum SENSOR_DATA_TYPE_MAGNETIC_HEADING_TRUE_NORTH_DEGREES = PROPERTYKEY(GUID(372758690, 16968, 17013, [134, 93, 85, 141, 232, 74, 237, 253]), 14);
enum SENSOR_DATA_TYPE_QUADRANT_ANGLE_DEGREES = PROPERTYKEY(GUID(372758690, 16968, 17013, [134, 93, 85, 141, 232, 74, 237, 253]), 15);
enum SENSOR_DATA_TYPE_ROTATION_MATRIX = PROPERTYKEY(GUID(372758690, 16968, 17013, [134, 93, 85, 141, 232, 74, 237, 253]), 16);
enum SENSOR_DATA_TYPE_QUATERNION = PROPERTYKEY(GUID(372758690, 16968, 17013, [134, 93, 85, 141, 232, 74, 237, 253]), 17);
enum SENSOR_DATA_TYPE_SIMPLE_DEVICE_ORIENTATION = PROPERTYKEY(GUID(372758690, 16968, 17013, [134, 93, 85, 141, 232, 74, 237, 253]), 18);
enum SENSOR_DATA_TYPE_MAGNETIC_FIELD_STRENGTH_X_MILLIGAUSS = PROPERTYKEY(GUID(372758690, 16968, 17013, [134, 93, 85, 141, 232, 74, 237, 253]), 19);
enum SENSOR_DATA_TYPE_MAGNETIC_FIELD_STRENGTH_Y_MILLIGAUSS = PROPERTYKEY(GUID(372758690, 16968, 17013, [134, 93, 85, 141, 232, 74, 237, 253]), 20);
enum SENSOR_DATA_TYPE_MAGNETIC_FIELD_STRENGTH_Z_MILLIGAUSS = PROPERTYKEY(GUID(372758690, 16968, 17013, [134, 93, 85, 141, 232, 74, 237, 253]), 21);
enum SENSOR_DATA_TYPE_MAGNETOMETER_ACCURACY = PROPERTYKEY(GUID(372758690, 16968, 17013, [134, 93, 85, 141, 232, 74, 237, 253]), 22);
enum SENSOR_DATA_TYPE_GUID_MECHANICAL_GUID = GUID(0x38564a7c, 0xf2f2, 0x49bb, [0x9b, 0x2b, 0xba, 0x60, 0xf6, 0x6a, 0x58, 0xdf]);
enum SENSOR_DATA_TYPE_BOOLEAN_SWITCH_STATE = PROPERTYKEY(GUID(945179260, 62194, 18875, [155, 43, 186, 96, 246, 106, 88, 223]), 2);
enum SENSOR_DATA_TYPE_MULTIVALUE_SWITCH_STATE = PROPERTYKEY(GUID(945179260, 62194, 18875, [155, 43, 186, 96, 246, 106, 88, 223]), 3);
enum SENSOR_DATA_TYPE_FORCE_NEWTONS = PROPERTYKEY(GUID(945179260, 62194, 18875, [155, 43, 186, 96, 246, 106, 88, 223]), 4);
enum SENSOR_DATA_TYPE_ABSOLUTE_PRESSURE_PASCAL = PROPERTYKEY(GUID(945179260, 62194, 18875, [155, 43, 186, 96, 246, 106, 88, 223]), 5);
enum SENSOR_DATA_TYPE_GAUGE_PRESSURE_PASCAL = PROPERTYKEY(GUID(945179260, 62194, 18875, [155, 43, 186, 96, 246, 106, 88, 223]), 6);
enum SENSOR_DATA_TYPE_STRAIN = PROPERTYKEY(GUID(945179260, 62194, 18875, [155, 43, 186, 96, 246, 106, 88, 223]), 7);
enum SENSOR_DATA_TYPE_WEIGHT_KILOGRAMS = PROPERTYKEY(GUID(945179260, 62194, 18875, [155, 43, 186, 96, 246, 106, 88, 223]), 8);
enum SENSOR_DATA_TYPE_BOOLEAN_SWITCH_ARRAY_STATES = PROPERTYKEY(GUID(945179260, 62194, 18875, [155, 43, 186, 96, 246, 106, 88, 223]), 10);
enum SENSOR_DATA_TYPE_BIOMETRIC_GUID = GUID(0x2299288a, 0x6d9e, 0x4b0b, [0xb7, 0xec, 0x35, 0x28, 0xf8, 0x9e, 0x40, 0xaf]);
enum SENSOR_DATA_TYPE_HUMAN_PRESENCE = PROPERTYKEY(GUID(580462730, 28062, 19211, [183, 236, 53, 40, 248, 158, 64, 175]), 2);
enum SENSOR_DATA_TYPE_HUMAN_PROXIMITY_METERS = PROPERTYKEY(GUID(580462730, 28062, 19211, [183, 236, 53, 40, 248, 158, 64, 175]), 3);
enum SENSOR_DATA_TYPE_TOUCH_STATE = PROPERTYKEY(GUID(580462730, 28062, 19211, [183, 236, 53, 40, 248, 158, 64, 175]), 4);
enum SENSOR_DATA_TYPE_LIGHT_GUID = GUID(0xe4c77ce2, 0xdcb7, 0x46e9, [0x84, 0x39, 0x4f, 0xec, 0x54, 0x88, 0x33, 0xa6]);
enum SENSOR_DATA_TYPE_LIGHT_LEVEL_LUX = PROPERTYKEY(GUID(3838278882, 56503, 18153, [132, 57, 79, 236, 84, 136, 51, 166]), 2);
enum SENSOR_DATA_TYPE_LIGHT_TEMPERATURE_KELVIN = PROPERTYKEY(GUID(3838278882, 56503, 18153, [132, 57, 79, 236, 84, 136, 51, 166]), 3);
enum SENSOR_DATA_TYPE_LIGHT_CHROMACITY = PROPERTYKEY(GUID(3838278882, 56503, 18153, [132, 57, 79, 236, 84, 136, 51, 166]), 4);
enum SENSOR_DATA_TYPE_SCANNER_GUID = GUID(0xd7a59a3c, 0x3421, 0x44ab, [0x8d, 0x3a, 0x9d, 0xe8, 0xab, 0x6c, 0x4c, 0xae]);
enum SENSOR_DATA_TYPE_RFID_TAG_40_BIT = PROPERTYKEY(GUID(3617954364, 13345, 17579, [141, 58, 157, 232, 171, 108, 76, 174]), 2);
enum SENSOR_DATA_TYPE_ELECTRICAL_GUID = GUID(0xbbb246d1, 0xe242, 0x4780, [0xa2, 0xd3, 0xcd, 0xed, 0x84, 0xf3, 0x58, 0x42]);
enum SENSOR_DATA_TYPE_VOLTAGE_VOLTS = PROPERTYKEY(GUID(3149022929, 57922, 18304, [162, 211, 205, 237, 132, 243, 88, 66]), 2);
enum SENSOR_DATA_TYPE_CURRENT_AMPS = PROPERTYKEY(GUID(3149022929, 57922, 18304, [162, 211, 205, 237, 132, 243, 88, 66]), 3);
enum SENSOR_DATA_TYPE_CAPACITANCE_FARAD = PROPERTYKEY(GUID(3149022929, 57922, 18304, [162, 211, 205, 237, 132, 243, 88, 66]), 4);
enum SENSOR_DATA_TYPE_RESISTANCE_OHMS = PROPERTYKEY(GUID(3149022929, 57922, 18304, [162, 211, 205, 237, 132, 243, 88, 66]), 5);
enum SENSOR_DATA_TYPE_INDUCTANCE_HENRY = PROPERTYKEY(GUID(3149022929, 57922, 18304, [162, 211, 205, 237, 132, 243, 88, 66]), 6);
enum SENSOR_DATA_TYPE_ELECTRICAL_POWER_WATTS = PROPERTYKEY(GUID(3149022929, 57922, 18304, [162, 211, 205, 237, 132, 243, 88, 66]), 7);
enum SENSOR_DATA_TYPE_ELECTRICAL_PERCENT_OF_RANGE = PROPERTYKEY(GUID(3149022929, 57922, 18304, [162, 211, 205, 237, 132, 243, 88, 66]), 8);
enum SENSOR_DATA_TYPE_ELECTRICAL_FREQUENCY_HERTZ = PROPERTYKEY(GUID(3149022929, 57922, 18304, [162, 211, 205, 237, 132, 243, 88, 66]), 9);
enum SENSOR_DATA_TYPE_CUSTOM_GUID = GUID(0xb14c764f, 0x7cf, 0x41e8, [0x9d, 0x82, 0xeb, 0xe3, 0xd0, 0x77, 0x6a, 0x6f]);
enum SENSOR_DATA_TYPE_CUSTOM_USAGE = PROPERTYKEY(GUID(2974578255, 1999, 16872, [157, 130, 235, 227, 208, 119, 106, 111]), 5);
enum SENSOR_DATA_TYPE_CUSTOM_BOOLEAN_ARRAY = PROPERTYKEY(GUID(2974578255, 1999, 16872, [157, 130, 235, 227, 208, 119, 106, 111]), 6);
enum SENSOR_DATA_TYPE_CUSTOM_VALUE1 = PROPERTYKEY(GUID(2974578255, 1999, 16872, [157, 130, 235, 227, 208, 119, 106, 111]), 7);
enum SENSOR_DATA_TYPE_CUSTOM_VALUE2 = PROPERTYKEY(GUID(2974578255, 1999, 16872, [157, 130, 235, 227, 208, 119, 106, 111]), 8);
enum SENSOR_DATA_TYPE_CUSTOM_VALUE3 = PROPERTYKEY(GUID(2974578255, 1999, 16872, [157, 130, 235, 227, 208, 119, 106, 111]), 9);
enum SENSOR_DATA_TYPE_CUSTOM_VALUE4 = PROPERTYKEY(GUID(2974578255, 1999, 16872, [157, 130, 235, 227, 208, 119, 106, 111]), 10);
enum SENSOR_DATA_TYPE_CUSTOM_VALUE5 = PROPERTYKEY(GUID(2974578255, 1999, 16872, [157, 130, 235, 227, 208, 119, 106, 111]), 11);
enum SENSOR_DATA_TYPE_CUSTOM_VALUE6 = PROPERTYKEY(GUID(2974578255, 1999, 16872, [157, 130, 235, 227, 208, 119, 106, 111]), 12);
enum SENSOR_DATA_TYPE_CUSTOM_VALUE7 = PROPERTYKEY(GUID(2974578255, 1999, 16872, [157, 130, 235, 227, 208, 119, 106, 111]), 13);
enum SENSOR_DATA_TYPE_CUSTOM_VALUE8 = PROPERTYKEY(GUID(2974578255, 1999, 16872, [157, 130, 235, 227, 208, 119, 106, 111]), 14);
enum SENSOR_DATA_TYPE_CUSTOM_VALUE9 = PROPERTYKEY(GUID(2974578255, 1999, 16872, [157, 130, 235, 227, 208, 119, 106, 111]), 15);
enum SENSOR_DATA_TYPE_CUSTOM_VALUE10 = PROPERTYKEY(GUID(2974578255, 1999, 16872, [157, 130, 235, 227, 208, 119, 106, 111]), 16);
enum SENSOR_DATA_TYPE_CUSTOM_VALUE11 = PROPERTYKEY(GUID(2974578255, 1999, 16872, [157, 130, 235, 227, 208, 119, 106, 111]), 17);
enum SENSOR_DATA_TYPE_CUSTOM_VALUE12 = PROPERTYKEY(GUID(2974578255, 1999, 16872, [157, 130, 235, 227, 208, 119, 106, 111]), 18);
enum SENSOR_DATA_TYPE_CUSTOM_VALUE13 = PROPERTYKEY(GUID(2974578255, 1999, 16872, [157, 130, 235, 227, 208, 119, 106, 111]), 19);
enum SENSOR_DATA_TYPE_CUSTOM_VALUE14 = PROPERTYKEY(GUID(2974578255, 1999, 16872, [157, 130, 235, 227, 208, 119, 106, 111]), 20);
enum SENSOR_DATA_TYPE_CUSTOM_VALUE15 = PROPERTYKEY(GUID(2974578255, 1999, 16872, [157, 130, 235, 227, 208, 119, 106, 111]), 21);
enum SENSOR_DATA_TYPE_CUSTOM_VALUE16 = PROPERTYKEY(GUID(2974578255, 1999, 16872, [157, 130, 235, 227, 208, 119, 106, 111]), 22);
enum SENSOR_DATA_TYPE_CUSTOM_VALUE17 = PROPERTYKEY(GUID(2974578255, 1999, 16872, [157, 130, 235, 227, 208, 119, 106, 111]), 23);
enum SENSOR_DATA_TYPE_CUSTOM_VALUE18 = PROPERTYKEY(GUID(2974578255, 1999, 16872, [157, 130, 235, 227, 208, 119, 106, 111]), 24);
enum SENSOR_DATA_TYPE_CUSTOM_VALUE19 = PROPERTYKEY(GUID(2974578255, 1999, 16872, [157, 130, 235, 227, 208, 119, 106, 111]), 25);
enum SENSOR_DATA_TYPE_CUSTOM_VALUE20 = PROPERTYKEY(GUID(2974578255, 1999, 16872, [157, 130, 235, 227, 208, 119, 106, 111]), 26);
enum SENSOR_DATA_TYPE_CUSTOM_VALUE21 = PROPERTYKEY(GUID(2974578255, 1999, 16872, [157, 130, 235, 227, 208, 119, 106, 111]), 27);
enum SENSOR_DATA_TYPE_CUSTOM_VALUE22 = PROPERTYKEY(GUID(2974578255, 1999, 16872, [157, 130, 235, 227, 208, 119, 106, 111]), 28);
enum SENSOR_DATA_TYPE_CUSTOM_VALUE23 = PROPERTYKEY(GUID(2974578255, 1999, 16872, [157, 130, 235, 227, 208, 119, 106, 111]), 29);
enum SENSOR_DATA_TYPE_CUSTOM_VALUE24 = PROPERTYKEY(GUID(2974578255, 1999, 16872, [157, 130, 235, 227, 208, 119, 106, 111]), 30);
enum SENSOR_DATA_TYPE_CUSTOM_VALUE25 = PROPERTYKEY(GUID(2974578255, 1999, 16872, [157, 130, 235, 227, 208, 119, 106, 111]), 31);
enum SENSOR_DATA_TYPE_CUSTOM_VALUE26 = PROPERTYKEY(GUID(2974578255, 1999, 16872, [157, 130, 235, 227, 208, 119, 106, 111]), 32);
enum SENSOR_DATA_TYPE_CUSTOM_VALUE27 = PROPERTYKEY(GUID(2974578255, 1999, 16872, [157, 130, 235, 227, 208, 119, 106, 111]), 33);
enum SENSOR_DATA_TYPE_CUSTOM_VALUE28 = PROPERTYKEY(GUID(2974578255, 1999, 16872, [157, 130, 235, 227, 208, 119, 106, 111]), 34);
enum SENSOR_PROPERTY_TEST_GUID = GUID(0xe1e962f4, 0x6e65, 0x45f7, [0x9c, 0x36, 0xd4, 0x87, 0xb7, 0xb1, 0xbd, 0x34]);
enum SENSOR_PROPERTY_CLEAR_ASSISTANCE_DATA = PROPERTYKEY(GUID(3790168820, 28261, 17911, [156, 54, 212, 135, 183, 177, 189, 52]), 2);
enum SENSOR_PROPERTY_TURN_ON_OFF_NMEA = PROPERTYKEY(GUID(3790168820, 28261, 17911, [156, 54, 212, 135, 183, 177, 189, 52]), 3);
