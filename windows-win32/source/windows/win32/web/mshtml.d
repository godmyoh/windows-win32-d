...
import windows.win32.foundation : BOOL, BSTR, HGLOBAL, HRESULT, HWND, LRESULT, POINT, PWSTR, RECT, SIZE, VARIANT_BOOL;
import windows.win32.graphics.dxgi.common : DXGI_FORMAT;
import windows.win32.graphics.gdi : HDC, HRGN, LOGFONTW;
import windows.win32.system.com : IClassFactory, IDataObject, IDispatch, IEnumUnknown, IMoniker, IUnknown, SAFEARRAY;
import windows.win32.system.diagnostics.debug_.activescript : IActiveScriptError;
import windows.win32.system.ole : IDispatchEx, IDropTarget, IOleCommandTarget, IOleInPlaceActiveObject, IOleInPlaceFrame, IOleInPlaceUIWindow;
...
enum DISPID_IE10_ELEMENTMAX = 0x000107cf;
