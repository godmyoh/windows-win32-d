...
BOOL ImmIsIME(HKL);
BOOL ImmSimulateHotKey(HWND, uint);
...
int ImmGetCompositionStringA(HIMC, uint, void*, uint);
int ImmGetCompositionStringW(HIMC, uint, void*, uint);
...
BOOL ImmGetConversionStatus(HIMC, uint*, uint*);
BOOL ImmSetConversionStatus(HIMC, uint, uint);
...
LRESULT ImmEscapeA(HKL, HIMC, uint, void*);
LRESULT ImmEscapeW(HKL, HIMC, uint, void*);
...
enum IME_CHOTKEY_IME_NONIME_TOGGLE = 0x00000010;
enum IME_CHOTKEY_SHAPE_TOGGLE = 0x00000011;
enum IME_CHOTKEY_SYMBOL_TOGGLE = 0x00000012;
enum IME_JHOTKEY_CLOSE_OPEN = 0x00000030;
enum IME_KHOTKEY_SHAPE_TOGGLE = 0x00000050;
enum IME_KHOTKEY_HANJACONVERT = 0x00000051;
enum IME_KHOTKEY_ENGLISH = 0x00000052;
enum IME_THOTKEY_IME_NONIME_TOGGLE = 0x00000070;
enum IME_THOTKEY_SHAPE_TOGGLE = 0x00000071;
enum IME_THOTKEY_SYMBOL_TOGGLE = 0x00000072;
enum IME_HOTKEY_DSWITCH_FIRST = 0x00000100;
enum IME_HOTKEY_DSWITCH_LAST = 0x0000011f;
enum IME_HOTKEY_PRIVATE_FIRST = 0x00000200;
enum IME_ITHOTKEY_RESEND_RESULTSTR = 0x00000200;
enum IME_ITHOTKEY_PREVIOUS_COMPOSITION = 0x00000201;
enum IME_ITHOTKEY_UISTYLE_TOGGLE = 0x00000202;
enum IME_ITHOTKEY_RECONVERTSTRING = 0x00000203;
enum IME_HOTKEY_PRIVATE_LAST = 0x0000021f;
enum GCS_COMPREADSTR = 0x00000001;
enum GCS_COMPREADATTR = 0x00000002;
enum GCS_COMPREADCLAUSE = 0x00000004;
enum GCS_COMPSTR = 0x00000008;
enum GCS_COMPATTR = 0x00000010;
enum GCS_COMPCLAUSE = 0x00000020;
enum GCS_CURSORPOS = 0x00000080;
enum GCS_DELTASTART = 0x00000100;
enum GCS_RESULTREADSTR = 0x00000200;
enum GCS_RESULTREADCLAUSE = 0x00000400;
enum GCS_RESULTSTR = 0x00000800;
enum GCS_RESULTCLAUSE = 0x00001000;
...
enum IME_CMODE_SOFTKBD = 0x00000080;
enum IME_CMODE_NOCONVERSION = 0x00000100;
enum IME_CMODE_EUDC = 0x00000200;
enum IME_CMODE_SYMBOL = 0x00000400;
enum IME_CMODE_FIXED = 0x00000800;
enum IME_CMODE_RESERVED = 0xf0000000;
enum IME_SMODE_NONE = 0x00000000;
enum IME_SMODE_PLAURALCLAUSE = 0x00000001;
enum IME_SMODE_SINGLECONVERT = 0x00000002;
enum IME_SMODE_AUTOMATIC = 0x00000004;
enum IME_SMODE_PHRASEPREDICT = 0x00000008;
enum IME_SMODE_CONVERSATION = 0x00000010;
enum IME_SMODE_RESERVED = 0x0000f000;
...
enum IME_ESC_QUERY_SUPPORT = 0x00000003;
enum IME_ESC_RESERVED_FIRST = 0x00000004;
enum IME_ESC_RESERVED_LAST = 0x000007ff;
enum IME_ESC_PRIVATE_FIRST = 0x00000800;
enum IME_ESC_PRIVATE_LAST = 0x00000fff;
enum IME_ESC_SEQUENCE_TO_INTERNAL = 0x00001001;
enum IME_ESC_GET_EUDC_DICTIONARY = 0x00001003;
enum IME_ESC_SET_EUDC_DICTIONARY = 0x00001004;
enum IME_ESC_MAX_KEY = 0x00001005;
enum IME_ESC_IME_NAME = 0x00001006;
enum IME_ESC_SYNC_HOTKEY = 0x00001007;
enum IME_ESC_HANJA_MODE = 0x00001008;
enum IME_ESC_AUTOMATA = 0x00001009;
enum IME_ESC_PRIVATE_HOTKEY = 0x0000100a;
enum IME_ESC_GETHELPFILENAME = 0x0000100b;
...
enum IME_SYSINFO_WOW16 = 0x00000002;
