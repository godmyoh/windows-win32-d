...
alias INTERACTION_CONTEXT_OUTPUT_CALLBACK = void function(void* clientData, const(INTERACTION_CONTEXT_OUTPUT)* output);
alias INTERACTION_CONTEXT_OUTPUT_CALLBACK2 = void function(void* clientData, const(INTERACTION_CONTEXT_OUTPUT2)* output);
...
HRESULT RegisterOutputCallbackInteractionContext(HINTERACTIONCONTEXT interactionContext, INTERACTION_CONTEXT_OUTPUT_CALLBACK outputCallback, void* clientData);
HRESULT RegisterOutputCallbackInteractionContext2(HINTERACTIONCONTEXT interactionContext, INTERACTION_CONTEXT_OUTPUT_CALLBACK2 outputCallback, void* clientData);
HRESULT SetInteractionConfigurationInteractionContext(HINTERACTIONCONTEXT interactionContext, uint configurationCount, const(INTERACTION_CONTEXT_CONFIGURATION)* configuration);
HRESULT GetInteractionConfigurationInteractionContext(HINTERACTIONCONTEXT interactionContext, uint configurationCount, INTERACTION_CONTEXT_CONFIGURATION* configuration);
HRESULT SetPropertyInteractionContext(HINTERACTIONCONTEXT interactionContext, INTERACTION_CONTEXT_PROPERTY contextProperty, uint value);
HRESULT GetPropertyInteractionContext(HINTERACTIONCONTEXT interactionContext, INTERACTION_CONTEXT_PROPERTY contextProperty, uint* value);
HRESULT SetInertiaParameterInteractionContext(HINTERACTIONCONTEXT interactionContext, INERTIA_PARAMETER inertiaParameter, float value);
HRESULT GetInertiaParameterInteractionContext(HINTERACTIONCONTEXT interactionContext, INERTIA_PARAMETER inertiaParameter, float* value);
HRESULT SetCrossSlideParametersInteractionContext(HINTERACTIONCONTEXT interactionContext, uint parameterCount, CROSS_SLIDE_PARAMETER* crossSlideParameters);
HRESULT GetCrossSlideParameterInteractionContext(HINTERACTIONCONTEXT interactionContext, CROSS_SLIDE_THRESHOLD threshold, float* distance);
HRESULT SetTapParameterInteractionContext(HINTERACTIONCONTEXT interactionContext, TAP_PARAMETER parameter, float value);
HRESULT GetTapParameterInteractionContext(HINTERACTIONCONTEXT interactionContext, TAP_PARAMETER parameter, float* value);
HRESULT SetHoldParameterInteractionContext(HINTERACTIONCONTEXT interactionContext, HOLD_PARAMETER parameter, float value);
HRESULT GetHoldParameterInteractionContext(HINTERACTIONCONTEXT interactionContext, HOLD_PARAMETER parameter, float* value);
HRESULT SetTranslationParameterInteractionContext(HINTERACTIONCONTEXT interactionContext, TRANSLATION_PARAMETER parameter, float value);
HRESULT GetTranslationParameterInteractionContext(HINTERACTIONCONTEXT interactionContext, TRANSLATION_PARAMETER parameter, float* value);
HRESULT SetMouseWheelParameterInteractionContext(HINTERACTIONCONTEXT interactionContext, MOUSE_WHEEL_PARAMETER parameter, float value);
HRESULT GetMouseWheelParameterInteractionContext(HINTERACTIONCONTEXT interactionContext, MOUSE_WHEEL_PARAMETER parameter, float* value);
HRESULT ResetInteractionContext(HINTERACTIONCONTEXT interactionContext);
HRESULT GetStateInteractionContext(HINTERACTIONCONTEXT interactionContext, const(POINTER_INFO)* pointerInfo, INTERACTION_STATE* state);
...
HRESULT ProcessPointerFramesInteractionContext(HINTERACTIONCONTEXT interactionContext, uint entriesCount, uint pointerCount, const(POINTER_INFO)* pointerInfo);
HRESULT BufferPointerPacketsInteractionContext(HINTERACTIONCONTEXT interactionContext, uint entriesCount, const(POINTER_INFO)* pointerInfo);
