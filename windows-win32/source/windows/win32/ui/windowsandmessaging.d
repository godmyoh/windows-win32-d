...
BOOL UpdateLayeredWindow(HWND, HDC, POINT*, SIZE*, HDC, POINT*, COLORREF, BLENDFUNCTION*, UPDATE_LAYERED_WINDOW_FLAGS);
BOOL UpdateLayeredWindowIndirect(HWND, const(UPDATELAYEREDWINDOWINFO)*);
BOOL GetLayeredWindowAttributes(HWND, COLORREF*, ubyte*, LAYERED_WINDOW_ATTRIBUTES_FLAGS*);
BOOL SetLayeredWindowAttributes(HWND, COLORREF, ubyte, LAYERED_WINDOW_ATTRIBUTES_FLAGS);
