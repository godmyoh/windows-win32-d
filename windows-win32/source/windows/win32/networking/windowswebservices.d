...
HRESULT WsStartReaderCanonicalization(WS_XML_READER* reader, WS_WRITE_CALLBACK writeCallback, void* writeCallbackState, const(WS_XML_CANONICALIZATION_PROPERTY)* properties, uint propertyCount, WS_ERROR* error);
HRESULT WsEndReaderCanonicalization(WS_XML_READER* reader, WS_ERROR* error);
HRESULT WsStartWriterCanonicalization(WS_XML_WRITER* writer, WS_WRITE_CALLBACK writeCallback, void* writeCallbackState, const(WS_XML_CANONICALIZATION_PROPERTY)* properties, uint propertyCount, WS_ERROR* error);
HRESULT WsEndWriterCanonicalization(WS_XML_WRITER* writer, WS_ERROR* error);
HRESULT WsCreateXmlBuffer(WS_HEAP* heap, const(WS_XML_BUFFER_PROPERTY)* properties, uint propertyCount, WS_XML_BUFFER** buffer, WS_ERROR* error);
HRESULT WsRemoveNode(const(WS_XML_NODE_POSITION)* nodePosition, WS_ERROR* error);
HRESULT WsCreateReader(const(WS_XML_READER_PROPERTY)* properties, uint propertyCount, WS_XML_READER** reader, WS_ERROR* error);
HRESULT WsSetInput(WS_XML_READER* reader, const(WS_XML_READER_ENCODING)* encoding, const(WS_XML_READER_INPUT)* input, const(WS_XML_READER_PROPERTY)* properties, uint propertyCount, WS_ERROR* error);
HRESULT WsSetInputToBuffer(WS_XML_READER* reader, WS_XML_BUFFER* buffer, const(WS_XML_READER_PROPERTY)* properties, uint propertyCount, WS_ERROR* error);
void WsFreeReader(WS_XML_READER* reader);
HRESULT WsGetReaderProperty(WS_XML_READER* reader, WS_XML_READER_PROPERTY_ID id, void* value, uint valueSize, WS_ERROR* error);
...
HRESULT WsReadToStartElement(WS_XML_READER* reader, const(WS_XML_STRING)* localName, const(WS_XML_STRING)* ns, BOOL* found, WS_ERROR* error);
...
HRESULT WsReadCharsUtf8(WS_XML_READER* reader, ubyte* bytes, uint maxByteCount, uint* actualByteCount, WS_ERROR* error);
HRESULT WsReadBytes(WS_XML_READER* reader, void* bytes, uint maxByteCount, uint* actualByteCount, WS_ERROR* error);
HRESULT WsReadArray(WS_XML_READER* reader, const(WS_XML_STRING)* localName, const(WS_XML_STRING)* ns, WS_VALUE_TYPE valueType, void* array, uint arraySize, uint itemOffset, uint itemCount, uint* actualItemCount, WS_ERROR* error);
...
HRESULT WsCreateWriter(const(WS_XML_WRITER_PROPERTY)* properties, uint propertyCount, WS_XML_WRITER** writer, WS_ERROR* error);
void WsFreeWriter(WS_XML_WRITER* writer);
HRESULT WsSetOutput(WS_XML_WRITER* writer, const(WS_XML_WRITER_ENCODING)* encoding, const(WS_XML_WRITER_OUTPUT)* output, const(WS_XML_WRITER_PROPERTY)* properties, uint propertyCount, WS_ERROR* error);
HRESULT WsSetOutputToBuffer(WS_XML_WRITER* writer, WS_XML_BUFFER* buffer, const(WS_XML_WRITER_PROPERTY)* properties, uint propertyCount, WS_ERROR* error);
HRESULT WsGetWriterProperty(WS_XML_WRITER* writer, WS_XML_WRITER_PROPERTY_ID id, void* value, uint valueSize, WS_ERROR* error);
...
HRESULT WsWriteValue(WS_XML_WRITER* writer, WS_VALUE_TYPE valueType, const(void)* value, uint valueSize, WS_ERROR* error);
...
HRESULT WsWriteXmlBufferToBytes(WS_XML_WRITER* writer, WS_XML_BUFFER* xmlBuffer, const(WS_XML_WRITER_ENCODING)* encoding, const(WS_XML_WRITER_PROPERTY)* properties, uint propertyCount, WS_HEAP* heap, void** bytes, uint* byteCount, WS_ERROR* error);
HRESULT WsReadXmlBufferFromBytes(WS_XML_READER* reader, const(WS_XML_READER_ENCODING)* encoding, const(WS_XML_READER_PROPERTY)* properties, uint propertyCount, const(void)* bytes, uint byteCount, WS_HEAP* heap, WS_XML_BUFFER** xmlBuffer, WS_ERROR* error);
HRESULT WsWriteArray(WS_XML_WRITER* writer, const(WS_XML_STRING)* localName, const(WS_XML_STRING)* ns, WS_VALUE_TYPE valueType, const(void)* array, uint arraySize, uint itemOffset, uint itemCount, WS_ERROR* error);
...
HRESULT WsTrimXmlWhitespace(PWSTR chars, uint charCount, ushort** trimmedChars, uint* trimmedCount, WS_ERROR* error);
...
HRESULT WsCreateChannel(WS_CHANNEL_TYPE channelType, WS_CHANNEL_BINDING channelBinding, const(WS_CHANNEL_PROPERTY)* properties, uint propertyCount, const(WS_SECURITY_DESCRIPTION)* securityDescription, WS_CHANNEL** channel, WS_ERROR* error);
...
HRESULT WsSendMessage(WS_CHANNEL* channel, WS_MESSAGE* message, const(WS_MESSAGE_DESCRIPTION)* messageDescription, WS_WRITE_OPTION writeOption, const(void)* bodyValue, uint bodyValueSize, const(WS_ASYNC_CONTEXT)* asyncContext, WS_ERROR* error);
HRESULT WsReceiveMessage(WS_CHANNEL* channel, WS_MESSAGE* message, const(WS_MESSAGE_DESCRIPTION)** messageDescriptions, uint messageDescriptionCount, WS_RECEIVE_OPTION receiveOption, WS_READ_OPTION readBodyOption, WS_HEAP* heap, void* value, uint valueSize, uint* index, const(WS_ASYNC_CONTEXT)* asyncContext, WS_ERROR* error);
HRESULT WsRequestReply(WS_CHANNEL* channel, WS_MESSAGE* requestMessage, const(WS_MESSAGE_DESCRIPTION)* requestMessageDescription, WS_WRITE_OPTION writeOption, const(void)* requestBodyValue, uint requestBodyValueSize, WS_MESSAGE* replyMessage, const(WS_MESSAGE_DESCRIPTION)* replyMessageDescription, WS_READ_OPTION readOption, WS_HEAP* heap, void* value, uint valueSize, const(WS_ASYNC_CONTEXT)* asyncContext, WS_ERROR* error);
HRESULT WsSendReplyMessage(WS_CHANNEL* channel, WS_MESSAGE* replyMessage, const(WS_MESSAGE_DESCRIPTION)* replyMessageDescription, WS_WRITE_OPTION writeOption, const(void)* replyBodyValue, uint replyBodyValueSize, WS_MESSAGE* requestMessage, const(WS_ASYNC_CONTEXT)* asyncContext, WS_ERROR* error);
...
HRESULT WsGetChannelProperty(WS_CHANNEL* channel, WS_CHANNEL_PROPERTY_ID id, void* value, uint valueSize, WS_ERROR* error);
HRESULT WsSetChannelProperty(WS_CHANNEL* channel, WS_CHANNEL_PROPERTY_ID id, const(void)* value, uint valueSize, WS_ERROR* error);
...
HRESULT WsGetOperationContextProperty(const(WS_OPERATION_CONTEXT)* context, const(WS_OPERATION_CONTEXT_PROPERTY_ID) id, void* value, uint valueSize, WS_ERROR* error);
HRESULT WsGetDictionary(WS_ENCODING encoding, WS_XML_DICTIONARY** dictionary, WS_ERROR* error);
HRESULT WsReadEndpointAddressExtension(WS_XML_READER* reader, WS_ENDPOINT_ADDRESS* endpointAddress, WS_ENDPOINT_ADDRESS_EXTENSION_TYPE extensionType, WS_READ_OPTION readOption, WS_HEAP* heap, void* value, uint valueSize, WS_ERROR* error);
...
HRESULT WsSetFaultErrorDetail(WS_ERROR* error, const(WS_FAULT_DETAIL_DESCRIPTION)* faultDetailDescription, WS_WRITE_OPTION writeOption, const(void)* value, uint valueSize);
HRESULT WsGetFaultErrorDetail(WS_ERROR* error, const(WS_FAULT_DETAIL_DESCRIPTION)* faultDetailDescription, WS_READ_OPTION readOption, WS_HEAP* heap, void* value, uint valueSize);
HRESULT WsCreateHeap(ulong maxSize, ulong trimSize, const(WS_HEAP_PROPERTY)* properties, uint propertyCount, WS_HEAP** heap, WS_ERROR* error);
HRESULT WsAlloc(WS_HEAP* heap, ulong size, void** ptr, WS_ERROR* error);
...
HRESULT WsCreateListener(WS_CHANNEL_TYPE channelType, WS_CHANNEL_BINDING channelBinding, const(WS_LISTENER_PROPERTY)* properties, uint propertyCount, const(WS_SECURITY_DESCRIPTION)* securityDescription, WS_LISTENER** listener, WS_ERROR* error);
...
HRESULT WsGetListenerProperty(WS_LISTENER* listener, WS_LISTENER_PROPERTY_ID id, void* value, uint valueSize, WS_ERROR* error);
HRESULT WsSetListenerProperty(WS_LISTENER* listener, WS_LISTENER_PROPERTY_ID id, const(void)* value, uint valueSize, WS_ERROR* error);
HRESULT WsCreateChannelForListener(WS_LISTENER* listener, const(WS_CHANNEL_PROPERTY)* properties, uint propertyCount, WS_CHANNEL** channel, WS_ERROR* error);
HRESULT WsCreateMessage(WS_ENVELOPE_VERSION envelopeVersion, WS_ADDRESSING_VERSION addressingVersion, const(WS_MESSAGE_PROPERTY)* properties, uint propertyCount, WS_MESSAGE** message, WS_ERROR* error);
HRESULT WsCreateMessageForChannel(WS_CHANNEL* channel, const(WS_MESSAGE_PROPERTY)* properties, uint propertyCount, WS_MESSAGE** message, WS_ERROR* error);
...
HRESULT WsGetHeader(WS_MESSAGE* message, WS_HEADER_TYPE headerType, WS_TYPE valueType, WS_READ_OPTION readOption, WS_HEAP* heap, void* value, uint valueSize, WS_ERROR* error);
HRESULT WsGetCustomHeader(WS_MESSAGE* message, const(WS_ELEMENT_DESCRIPTION)* customHeaderDescription, WS_REPEATING_HEADER_OPTION repeatingOption, uint headerIndex, WS_READ_OPTION readOption, WS_HEAP* heap, void* value, uint valueSize, uint* headerAttributes, WS_ERROR* error);
HRESULT WsRemoveHeader(WS_MESSAGE* message, WS_HEADER_TYPE headerType, WS_ERROR* error);
HRESULT WsSetHeader(WS_MESSAGE* message, WS_HEADER_TYPE headerType, WS_TYPE valueType, WS_WRITE_OPTION writeOption, const(void)* value, uint valueSize, WS_ERROR* error);
...
HRESULT WsAddCustomHeader(WS_MESSAGE* message, const(WS_ELEMENT_DESCRIPTION)* headerDescription, WS_WRITE_OPTION writeOption, const(void)* value, uint valueSize, uint headerAttributes, WS_ERROR* error);
HRESULT WsAddMappedHeader(WS_MESSAGE* message, const(WS_XML_STRING)* headerName, WS_TYPE valueType, WS_WRITE_OPTION writeOption, const(void)* value, uint valueSize, WS_ERROR* error);
HRESULT WsRemoveMappedHeader(WS_MESSAGE* message, const(WS_XML_STRING)* headerName, WS_ERROR* error);
HRESULT WsGetMappedHeader(WS_MESSAGE* message, const(WS_XML_STRING)* headerName, WS_REPEATING_HEADER_OPTION repeatingOption, uint headerIndex, WS_TYPE valueType, WS_READ_OPTION readOption, WS_HEAP* heap, void* value, uint valueSize, WS_ERROR* error);
HRESULT WsWriteBody(WS_MESSAGE* message, const(WS_ELEMENT_DESCRIPTION)* bodyDescription, WS_WRITE_OPTION writeOption, const(void)* value, uint valueSize, WS_ERROR* error);
HRESULT WsReadBody(WS_MESSAGE* message, const(WS_ELEMENT_DESCRIPTION)* bodyDescription, WS_READ_OPTION readOption, WS_HEAP* heap, void* value, uint valueSize, WS_ERROR* error);
...
HRESULT WsGetMessageProperty(WS_MESSAGE* message, WS_MESSAGE_PROPERTY_ID id, void* value, uint valueSize, WS_ERROR* error);
HRESULT WsSetMessageProperty(WS_MESSAGE* message, WS_MESSAGE_PROPERTY_ID id, const(void)* value, uint valueSize, WS_ERROR* error);
...
HRESULT WsRequestSecurityToken(WS_CHANNEL* channel, const(WS_REQUEST_SECURITY_TOKEN_PROPERTY)* properties, uint propertyCount, WS_SECURITY_TOKEN** token, const(WS_ASYNC_CONTEXT)* asyncContext, WS_ERROR* error);
HRESULT WsGetSecurityTokenProperty(WS_SECURITY_TOKEN* securityToken, WS_SECURITY_TOKEN_PROPERTY_ID id, void* value, uint valueSize, WS_HEAP* heap, WS_ERROR* error);
HRESULT WsCreateXmlSecurityToken(WS_XML_BUFFER* tokenXml, WS_SECURITY_KEY_HANDLE* tokenKey, const(WS_XML_SECURITY_TOKEN_PROPERTY)* properties, uint propertyCount, WS_SECURITY_TOKEN** token, WS_ERROR* error);
...
HRESULT WsGetSecurityContextProperty(WS_SECURITY_CONTEXT* securityContext, WS_SECURITY_CONTEXT_PROPERTY_ID id, void* value, uint valueSize, WS_ERROR* error);
HRESULT WsReadElement(WS_XML_READER* reader, const(WS_ELEMENT_DESCRIPTION)* elementDescription, WS_READ_OPTION readOption, WS_HEAP* heap, void* value, uint valueSize, WS_ERROR* error);
HRESULT WsReadAttribute(WS_XML_READER* reader, const(WS_ATTRIBUTE_DESCRIPTION)* attributeDescription, WS_READ_OPTION readOption, WS_HEAP* heap, void* value, uint valueSize, WS_ERROR* error);
HRESULT WsReadType(WS_XML_READER* reader, WS_TYPE_MAPPING typeMapping, WS_TYPE type, const(void)* typeDescription, WS_READ_OPTION readOption, WS_HEAP* heap, void* value, uint valueSize, WS_ERROR* error);
HRESULT WsWriteElement(WS_XML_WRITER* writer, const(WS_ELEMENT_DESCRIPTION)* elementDescription, WS_WRITE_OPTION writeOption, const(void)* value, uint valueSize, WS_ERROR* error);
HRESULT WsWriteAttribute(WS_XML_WRITER* writer, const(WS_ATTRIBUTE_DESCRIPTION)* attributeDescription, WS_WRITE_OPTION writeOption, const(void)* value, uint valueSize, WS_ERROR* error);
HRESULT WsWriteType(WS_XML_WRITER* writer, WS_TYPE_MAPPING typeMapping, WS_TYPE type, const(void)* typeDescription, WS_WRITE_OPTION writeOption, const(void)* value, uint valueSize, WS_ERROR* error);
...
HRESULT WsGetServiceHostProperty(WS_SERVICE_HOST* serviceHost, const(WS_SERVICE_PROPERTY_ID) id, void* value, uint valueSize, WS_ERROR* error);
HRESULT WsCreateServiceHost(const(WS_SERVICE_ENDPOINT)** endpoints, const(ushort) endpointCount, const(WS_SERVICE_PROPERTY)* serviceProperties, uint servicePropertyCount, WS_SERVICE_HOST** serviceHost, WS_ERROR* error);
...
HRESULT WsGetServiceProxyProperty(WS_SERVICE_PROXY* serviceProxy, const(WS_PROXY_PROPERTY_ID) id, void* value, uint valueSize, WS_ERROR* error);
HRESULT WsCreateServiceProxy(const(WS_CHANNEL_TYPE) channelType, const(WS_CHANNEL_BINDING) channelBinding, const(WS_SECURITY_DESCRIPTION)* securityDescription, const(WS_PROXY_PROPERTY)* properties, const(uint) propertyCount, const(WS_CHANNEL_PROPERTY)* channelProperties, const(uint) channelPropertyCount, WS_SERVICE_PROXY** serviceProxy, WS_ERROR* error);
...
HRESULT WsCall(WS_SERVICE_PROXY* serviceProxy, const(WS_OPERATION_DESCRIPTION)* operation, const(void)** arguments, WS_HEAP* heap, const(WS_CALL_PROPERTY)* callProperties, const(uint) callPropertyCount, const(WS_ASYNC_CONTEXT)* asyncContext, WS_ERROR* error);
...
HRESULT WsCreateMetadata(const(WS_METADATA_PROPERTY)* properties, uint propertyCount, WS_METADATA** metadata, WS_ERROR* error);
...
HRESULT WsGetMetadataProperty(WS_METADATA* metadata, WS_METADATA_PROPERTY_ID id, void* value, uint valueSize, WS_ERROR* error);
...
HRESULT WsGetPolicyProperty(WS_POLICY* policy, WS_POLICY_PROPERTY_ID id, void* value, uint valueSize, WS_ERROR* error);
HRESULT WsGetPolicyAlternativeCount(WS_POLICY* policy, uint* count, WS_ERROR* error);
HRESULT WsCreateServiceProxyFromTemplate(WS_CHANNEL_TYPE channelType, const(WS_PROXY_PROPERTY)* properties, const(uint) propertyCount, WS_BINDING_TEMPLATE_TYPE templateType, void* templateValue, uint templateSize, const(void)* templateDescription, uint templateDescriptionSize, WS_SERVICE_PROXY** serviceProxy, WS_ERROR* error);
HRESULT WsCreateServiceEndpointFromTemplate(WS_CHANNEL_TYPE channelType, const(WS_SERVICE_ENDPOINT_PROPERTY)* properties, uint propertyCount, const(WS_STRING)* addressUrl, const(WS_SERVICE_CONTRACT)* contract, WS_SERVICE_SECURITY_CALLBACK authorizationCallback, WS_HEAP* heap, WS_BINDING_TEMPLATE_TYPE templateType, void* templateValue, uint templateSize, const(void)* templateDescription, uint templateDescriptionSize, WS_SERVICE_ENDPOINT** serviceEndpoint, WS_ERROR* error);
...
HRESULT WebAuthNGetPlatformCredentialList(WEBAUTHN_GET_CREDENTIALS_OPTIONS* pGetCredentialsOptions, WEBAUTHN_CREDENTIAL_DETAILS_LIST** ppCredentialDetailsList);
void WebAuthNFreePlatformCredentialList(WEBAUTHN_CREDENTIAL_DETAILS_LIST* pCredentialDetailsList);
HRESULT WebAuthNDeletePlatformCredential(uint cbCredentialId, const(ubyte)* pbCredentialId);
...
enum WEBAUTHN_API_VERSION_5 = 0x00000005;
enum WEBAUTHN_API_VERSION_6 = 0x00000006;
enum WEBAUTHN_API_VERSION_7 = 0x00000007;
enum WEBAUTHN_API_CURRENT_VERSION = 0x00000007;
...
enum WEBAUTHN_CTAP_TRANSPORT_HYBRID = 0x00000020;
enum WEBAUTHN_CTAP_TRANSPORT_FLAGS_MASK = 0x0000003f;
enum WEBAUTHN_CREDENTIAL_EX_CURRENT_VERSION = 0x00000001;
enum CTAPCBOR_HYBRID_STORAGE_LINKED_DATA_VERSION_1 = 0x00000001;
enum CTAPCBOR_HYBRID_STORAGE_LINKED_DATA_CURRENT_VERSION = 0x00000001;
enum WEBAUTHN_CREDENTIAL_DETAILS_VERSION_1 = 0x00000001;
enum WEBAUTHN_CREDENTIAL_DETAILS_VERSION_2 = 0x00000002;
enum WEBAUTHN_CREDENTIAL_DETAILS_CURRENT_VERSION = 0x00000002;
...
enum WEBAUTHN_AUTHENTICATOR_MAKE_CREDENTIAL_OPTIONS_VERSION_6 = 0x00000006;
enum WEBAUTHN_AUTHENTICATOR_MAKE_CREDENTIAL_OPTIONS_VERSION_7 = 0x00000007;
enum WEBAUTHN_AUTHENTICATOR_MAKE_CREDENTIAL_OPTIONS_CURRENT_VERSION = 0x00000007;
...
enum WEBAUTHN_AUTHENTICATOR_GET_ASSERTION_OPTIONS_VERSION_7 = 0x00000007;
enum WEBAUTHN_AUTHENTICATOR_GET_ASSERTION_OPTIONS_CURRENT_VERSION = 0x00000007;
...
enum WEBAUTHN_CREDENTIAL_ATTESTATION_VERSION_5 = 0x00000005;
enum WEBAUTHN_CREDENTIAL_ATTESTATION_VERSION_6 = 0x00000006;
enum WEBAUTHN_CREDENTIAL_ATTESTATION_CURRENT_VERSION = 0x00000006;
...
enum WEBAUTHN_ASSERTION_VERSION_4 = 0x00000004;
enum WEBAUTHN_ASSERTION_VERSION_5 = 0x00000005;
enum WEBAUTHN_ASSERTION_CURRENT_VERSION = 0x00000005;
...
alias WS_READ_CALLBACK = HRESULT function(void* callbackState, void* bytes, uint maxSize, uint* actualSize, const(WS_ASYNC_CONTEXT)* asyncContext, WS_ERROR* error);
alias WS_WRITE_CALLBACK = HRESULT function(void* callbackState, const(WS_BYTES)* buffers, uint count, const(WS_ASYNC_CONTEXT)* asyncContext, WS_ERROR* error);
alias WS_PUSH_BYTES_CALLBACK = HRESULT function(void* callbackState, WS_WRITE_CALLBACK writeCallback, void* writeCallbackState, const(WS_ASYNC_CONTEXT)* asyncContext, WS_ERROR* error);
alias WS_PULL_BYTES_CALLBACK = HRESULT function(void* callbackState, void* bytes, uint maxSize, uint* actualSize, const(WS_ASYNC_CONTEXT)* asyncContext, WS_ERROR* error);
alias WS_DYNAMIC_STRING_CALLBACK = HRESULT function(void* callbackState, const(WS_XML_STRING)* string, BOOL* found, uint* id, WS_ERROR* error);
alias WS_ASYNC_CALLBACK = void function(HRESULT errorCode, WS_CALLBACK_MODEL callbackModel, void* callbackState);
alias WS_ASYNC_FUNCTION = HRESULT function(HRESULT hr, WS_CALLBACK_MODEL callbackModel, void* callbackState, WS_ASYNC_OPERATION* next, const(WS_ASYNC_CONTEXT)* asyncContext, WS_ERROR* error);
alias WS_CREATE_CHANNEL_CALLBACK = HRESULT function(WS_CHANNEL_TYPE channelType, const(void)* channelParameters, uint channelParametersSize, void** channelInstance, WS_ERROR* error);
...
alias WS_OPEN_CHANNEL_CALLBACK = HRESULT function(void* channelInstance, const(WS_ENDPOINT_ADDRESS)* endpointAddress, const(WS_ASYNC_CONTEXT)* asyncContext, WS_ERROR* error);
alias WS_CLOSE_CHANNEL_CALLBACK = HRESULT function(void* channelInstance, const(WS_ASYNC_CONTEXT)* asyncContext, WS_ERROR* error);
alias WS_SET_CHANNEL_PROPERTY_CALLBACK = HRESULT function(void* channelInstance, WS_CHANNEL_PROPERTY_ID id, const(void)* value, uint valueSize, WS_ERROR* error);
alias WS_GET_CHANNEL_PROPERTY_CALLBACK = HRESULT function(void* channelInstance, WS_CHANNEL_PROPERTY_ID id, void* value, uint valueSize, WS_ERROR* error);
alias WS_READ_MESSAGE_START_CALLBACK = HRESULT function(void* channelInstance, WS_MESSAGE* message, const(WS_ASYNC_CONTEXT)* asyncContext, WS_ERROR* error);
alias WS_READ_MESSAGE_END_CALLBACK = HRESULT function(void* channelInstance, WS_MESSAGE* message, const(WS_ASYNC_CONTEXT)* asyncContext, WS_ERROR* error);
alias WS_WRITE_MESSAGE_START_CALLBACK = HRESULT function(void* channelInstance, WS_MESSAGE* message, const(WS_ASYNC_CONTEXT)* asyncContext, WS_ERROR* error);
alias WS_WRITE_MESSAGE_END_CALLBACK = HRESULT function(void* channelInstance, WS_MESSAGE* message, const(WS_ASYNC_CONTEXT)* asyncContext, WS_ERROR* error);
alias WS_ABANDON_MESSAGE_CALLBACK = HRESULT function(void* channelInstance, WS_MESSAGE* message, WS_ERROR* error);
alias WS_SHUTDOWN_SESSION_CHANNEL_CALLBACK = HRESULT function(void* channelInstance, const(WS_ASYNC_CONTEXT)* asyncContext, WS_ERROR* error);
alias WS_CREATE_ENCODER_CALLBACK = HRESULT function(void* createContext, WS_WRITE_CALLBACK writeCallback, void* writeContext, void** encoderContext, WS_ERROR* error);
alias WS_ENCODER_GET_CONTENT_TYPE_CALLBACK = HRESULT function(void* encoderContext, const(WS_STRING)* contentType, WS_STRING* newContentType, WS_STRING* contentEncoding, WS_ERROR* error);
alias WS_ENCODER_START_CALLBACK = HRESULT function(void* encoderContext, const(WS_ASYNC_CONTEXT)* asyncContext, WS_ERROR* error);
alias WS_ENCODER_ENCODE_CALLBACK = HRESULT function(void* encoderContext, const(WS_BYTES)* buffers, uint count, const(WS_ASYNC_CONTEXT)* asyncContext, WS_ERROR* error);
alias WS_ENCODER_END_CALLBACK = HRESULT function(void* encoderContext, const(WS_ASYNC_CONTEXT)* asyncContext, WS_ERROR* error);
alias WS_FREE_ENCODER_CALLBACK = void function(void* encoderContext);
alias WS_CREATE_DECODER_CALLBACK = HRESULT function(void* createContext, WS_READ_CALLBACK readCallback, void* readContext, void** decoderContext, WS_ERROR* error);
alias WS_DECODER_GET_CONTENT_TYPE_CALLBACK = HRESULT function(void* decoderContext, const(WS_STRING)* contentType, const(WS_STRING)* contentEncoding, WS_STRING* newContentType, WS_ERROR* error);
alias WS_DECODER_START_CALLBACK = HRESULT function(void* encoderContext, const(WS_ASYNC_CONTEXT)* asyncContext, WS_ERROR* error);
alias WS_DECODER_DECODE_CALLBACK = HRESULT function(void* encoderContext, void* buffer, uint maxLength, uint* length, const(WS_ASYNC_CONTEXT)* asyncContext, WS_ERROR* error);
alias WS_DECODER_END_CALLBACK = HRESULT function(void* encoderContext, const(WS_ASYNC_CONTEXT)* asyncContext, WS_ERROR* error);
alias WS_FREE_DECODER_CALLBACK = void function(void* decoderContext);
alias WS_HTTP_REDIRECT_CALLBACK = HRESULT function(void* state, const(WS_STRING)* originalUrl, const(WS_STRING)* newUrl);
alias WS_CREATE_LISTENER_CALLBACK = HRESULT function(WS_CHANNEL_TYPE channelType, const(void)* listenerParameters, uint listenerParametersSize, void** listenerInstance, WS_ERROR* error);
...
alias WS_OPEN_LISTENER_CALLBACK = HRESULT function(void* listenerInstance, const(WS_STRING)* url, const(WS_ASYNC_CONTEXT)* asyncContext, WS_ERROR* error);
alias WS_CLOSE_LISTENER_CALLBACK = HRESULT function(void* listenerInstance, const(WS_ASYNC_CONTEXT)* asyncContext, WS_ERROR* error);
alias WS_GET_LISTENER_PROPERTY_CALLBACK = HRESULT function(void* listenerInstance, WS_LISTENER_PROPERTY_ID id, void* value, uint valueSize, WS_ERROR* error);
alias WS_SET_LISTENER_PROPERTY_CALLBACK = HRESULT function(void* listenerInstance, WS_LISTENER_PROPERTY_ID id, const(void)* value, uint valueSize, WS_ERROR* error);
alias WS_ACCEPT_CHANNEL_CALLBACK = HRESULT function(void* listenerInstance, void* channelInstance, const(WS_ASYNC_CONTEXT)* asyncContext, WS_ERROR* error);
alias WS_ABORT_LISTENER_CALLBACK = HRESULT function(void* listenerInstance, WS_ERROR* error);
alias WS_CREATE_CHANNEL_FOR_LISTENER_CALLBACK = HRESULT function(void* listenerInstance, const(void)* channelParameters, uint channelParametersSize, void** channelInstance, WS_ERROR* error);
...
alias WS_GET_CERT_CALLBACK = HRESULT function(void* getCertCallbackState, const(WS_ENDPOINT_ADDRESS)* targetAddress, const(WS_STRING)* viaUri, const(CERT_CONTEXT)** cert, WS_ERROR* error);
alias WS_CERT_ISSUER_LIST_NOTIFICATION_CALLBACK = HRESULT function(void* certIssuerListNotificationCallbackState, const(SecPkgContext_IssuerListInfoEx)* issuerList, WS_ERROR* error);
alias WS_VALIDATE_PASSWORD_CALLBACK = HRESULT function(void* passwordValidatorCallbackState, const(WS_STRING)* username, const(WS_STRING)* password, const(WS_ASYNC_CONTEXT)* asyncContext, WS_ERROR* error);
alias WS_VALIDATE_SAML_CALLBACK = HRESULT function(void* samlValidatorCallbackState, WS_XML_BUFFER* samlAssertion, WS_ERROR* error);
alias WS_DURATION_COMPARISON_CALLBACK = HRESULT function(const(WS_DURATION)* duration1, const(WS_DURATION)* duration2, int* result, WS_ERROR* error);
alias WS_READ_TYPE_CALLBACK = HRESULT function(WS_XML_READER* reader, WS_TYPE_MAPPING typeMapping, const(void)* descriptionData, WS_HEAP* heap, void* value, uint valueSize, WS_ERROR* error);
alias WS_WRITE_TYPE_CALLBACK = HRESULT function(WS_XML_WRITER* writer, WS_TYPE_MAPPING typeMapping, const(void)* descriptionData, const(void)* value, uint valueSize, WS_ERROR* error);
alias WS_IS_DEFAULT_VALUE_CALLBACK = HRESULT function(const(void)* descriptionData, const(void)* value, const(void)* defaultValue, uint valueSize, BOOL* isDefault, WS_ERROR* error);
alias WS_SERVICE_MESSAGE_RECEIVE_CALLBACK = HRESULT function(const(WS_OPERATION_CONTEXT)* context, const(WS_ASYNC_CONTEXT)* asyncContext, WS_ERROR* error);
...
alias WS_SERVICE_STUB_CALLBACK = HRESULT function(const(WS_OPERATION_CONTEXT)* context, void* frame, const(void)* callback, const(WS_ASYNC_CONTEXT)* asyncContext, WS_ERROR* error);
alias WS_SERVICE_ACCEPT_CHANNEL_CALLBACK = HRESULT function(const(WS_OPERATION_CONTEXT)* context, void** channelState, const(WS_ASYNC_CONTEXT)* asyncContext, WS_ERROR* error);
alias WS_SERVICE_CLOSE_CHANNEL_CALLBACK = HRESULT function(const(WS_OPERATION_CONTEXT)* context, const(WS_ASYNC_CONTEXT)* asyncContext);
alias WS_SERVICE_SECURITY_CALLBACK = HRESULT function(const(WS_OPERATION_CONTEXT)* context, BOOL* authorized, WS_ERROR* error);
alias WS_PROXY_MESSAGE_CALLBACK = HRESULT function(WS_MESSAGE* message, WS_HEAP* heap, void* state, WS_ERROR* error);
...
struct CTAPCBOR_HYBRID_STORAGE_LINKED_DATA
{
    ...
    uint cbPublicKey;
    ubyte* pbPublicKey;
    const(wchar)* pwszAuthenticatorName;
