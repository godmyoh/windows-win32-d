...
void* HttpOpenRequestA(void*, const(char)*, const(char)*, const(char)*, const(char)*, PSTR*, uint, ulong);
void* HttpOpenRequestW(void*, const(wchar)*, const(wchar)*, const(wchar)*, const(wchar)*, PWSTR*, uint, ulong);
...
BOOL InternetAlgIdToStringA(uint, PSTR, uint*, uint);
BOOL InternetAlgIdToStringW(uint, PWSTR, uint*, uint);
...
BOOL HttpCheckDavComplianceA(const(char)*, const(char)*, int*, HWND, void*);
BOOL HttpCheckDavComplianceW(const(wchar)*, const(wchar)*, int*, HWND, void*);
...
uint UrlCacheCheckEntriesExist(PWSTR*, uint, BOOL*);
...
enum INTERNET_DEFAULT_FTP_PORT = 0x00000015;
enum INTERNET_DEFAULT_GOPHER_PORT = 0x00000046;
enum INTERNET_DEFAULT_SOCKS_PORT = 0x00000438;
...
enum INTERNET_LAST_OPTION = 0x000000bb;
...
enum INTERNET_LAST_OPTION_INTERNAL = 0x000000bf;
