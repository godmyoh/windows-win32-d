...
BOOL AddAccessAllowedAce(ACL*, uint, uint, PSID);
BOOL AddAccessAllowedAceEx(ACL*, uint, ACE_FLAGS, uint, PSID);
BOOL AddAccessAllowedObjectAce(ACL*, uint, ACE_FLAGS, uint, GUID*, GUID*, PSID);
BOOL AddAccessDeniedAce(ACL*, uint, uint, PSID);
BOOL AddAccessDeniedAceEx(ACL*, uint, ACE_FLAGS, uint, PSID);
BOOL AddAccessDeniedObjectAce(ACL*, uint, ACE_FLAGS, uint, GUID*, GUID*, PSID);
BOOL AddAce(ACL*, uint, uint, void*, uint);
BOOL AddAuditAccessAce(ACL*, uint, uint, PSID, BOOL, BOOL);
BOOL AddAuditAccessAceEx(ACL*, uint, ACE_FLAGS, uint, PSID, BOOL, BOOL);
BOOL AddAuditAccessObjectAce(ACL*, uint, ACE_FLAGS, uint, GUID*, GUID*, PSID, BOOL, BOOL);
BOOL AddMandatoryAce(ACL*, ACE_REVISION, ACE_FLAGS, uint, PSID);
BOOL AddResourceAttributeAce(ACL*, uint, ACE_FLAGS, uint, PSID, CLAIM_SECURITY_ATTRIBUTES_INFORMATION*, uint*);
BOOL AddScopedPolicyIDAce(ACL*, uint, ACE_FLAGS, uint, PSID);
...
BOOL InitializeAcl(ACL*, uint, uint);
...
BOOL AddConditionalAce(ACL*, uint, ACE_FLAGS, ubyte, uint, PSID, PWSTR, uint*);
