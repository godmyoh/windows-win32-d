...
NTSTATUS BCryptGetProperty(void*, const(wchar)*, ubyte*, uint, uint*, uint);
NTSTATUS BCryptSetProperty(void*, const(wchar)*, ubyte*, uint, uint);
...
NTSTATUS BCryptDestroySecret(void*);
...
NTSTATUS BCryptSecretAgreement(BCRYPT_KEY_HANDLE, BCRYPT_KEY_HANDLE, void**, uint);
NTSTATUS BCryptDeriveKey(void*, const(wchar)*, BCryptBufferDesc*, ubyte*, uint, uint*, uint);
NTSTATUS BCryptKeyDerivation(BCRYPT_KEY_HANDLE, BCryptBufferDesc*, ubyte*, uint, uint*, uint);
NTSTATUS BCryptCreateHash(BCRYPT_ALG_HANDLE, void**, ubyte*, uint, ubyte*, uint, uint);
NTSTATUS BCryptHashData(void*, ubyte*, uint, uint);
NTSTATUS BCryptFinishHash(void*, ubyte*, uint, uint);
NTSTATUS BCryptCreateMultiHash(BCRYPT_ALG_HANDLE, void**, uint, ubyte*, uint, ubyte*, uint, uint);
NTSTATUS BCryptProcessMultiOperations(void*, BCRYPT_MULTI_OPERATION_TYPE, void*, uint, uint);
NTSTATUS BCryptDuplicateHash(void*, void**, ubyte*, uint, uint);
NTSTATUS BCryptDestroyHash(void*);
...
NTSTATUS BCryptDeriveKeyCapi(void*, BCRYPT_ALG_HANDLE, ubyte*, uint, uint);
