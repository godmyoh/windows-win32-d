...
BOOL AccessCheck(PSECURITY_DESCRIPTOR, HANDLE, uint, GENERIC_MAPPING*, PRIVILEGE_SET*, uint*, uint*, BOOL*);
BOOL AccessCheckAndAuditAlarmW(const(wchar)*, void*, PWSTR, PWSTR, PSECURITY_DESCRIPTOR, uint, GENERIC_MAPPING*, BOOL, uint*, BOOL*, BOOL*);
BOOL AccessCheckByType(PSECURITY_DESCRIPTOR, PSID, HANDLE, uint, OBJECT_TYPE_LIST*, uint, GENERIC_MAPPING*, PRIVILEGE_SET*, uint*, uint*, BOOL*);
...
BOOL AccessCheckByTypeAndAuditAlarmW(const(wchar)*, void*, const(wchar)*, const(wchar)*, PSECURITY_DESCRIPTOR, PSID, uint, AUDIT_EVENT_TYPE, uint, OBJECT_TYPE_LIST*, uint, GENERIC_MAPPING*, BOOL, uint*, BOOL*, BOOL*);
BOOL AccessCheckByTypeResultListAndAuditAlarmW(const(wchar)*, void*, const(wchar)*, const(wchar)*, PSECURITY_DESCRIPTOR, PSID, uint, AUDIT_EVENT_TYPE, uint, OBJECT_TYPE_LIST*, uint, GENERIC_MAPPING*, BOOL, uint*, uint*, BOOL*);
BOOL AccessCheckByTypeResultListAndAuditAlarmByHandleW(const(wchar)*, void*, HANDLE, const(wchar)*, const(wchar)*, PSECURITY_DESCRIPTOR, PSID, uint, AUDIT_EVENT_TYPE, uint, OBJECT_TYPE_LIST*, uint, GENERIC_MAPPING*, BOOL, uint*, uint*, BOOL*);
...
BOOL GetPrivateObjectSecurity(PSECURITY_DESCRIPTOR, OBJECT_SECURITY_INFORMATION, PSECURITY_DESCRIPTOR, uint, uint*);
BOOL GetSecurityDescriptorControl(PSECURITY_DESCRIPTOR, ushort*, uint*);
BOOL GetSecurityDescriptorDacl(PSECURITY_DESCRIPTOR, BOOL*, ACL**, BOOL*);
...
BOOL GetSecurityDescriptorSacl(PSECURITY_DESCRIPTOR, BOOL*, ACL**, BOOL*);
...
BOOL ObjectOpenAuditAlarmW(const(wchar)*, void*, PWSTR, PWSTR, PSECURITY_DESCRIPTOR, HANDLE, uint, uint, PRIVILEGE_SET*, BOOL, BOOL, BOOL*);
...
void QuerySecurityAccessMask(OBJECT_SECURITY_INFORMATION, uint*);
BOOL RevertToSelf();
BOOL SetAclInformation(ACL*, void*, uint, ACL_INFORMATION_CLASS);
BOOL SetFileSecurityW(const(wchar)*, OBJECT_SECURITY_INFORMATION, PSECURITY_DESCRIPTOR);
BOOL SetKernelObjectSecurity(HANDLE, OBJECT_SECURITY_INFORMATION, PSECURITY_DESCRIPTOR);
BOOL SetPrivateObjectSecurity(OBJECT_SECURITY_INFORMATION, PSECURITY_DESCRIPTOR, PSECURITY_DESCRIPTOR*, GENERIC_MAPPING*, HANDLE);
BOOL SetPrivateObjectSecurityEx(OBJECT_SECURITY_INFORMATION, PSECURITY_DESCRIPTOR, PSECURITY_DESCRIPTOR*, SECURITY_AUTO_INHERIT_FLAGS, GENERIC_MAPPING*, HANDLE);
void SetSecurityAccessMask(OBJECT_SECURITY_INFORMATION, uint*);
...
BOOL AccessCheckAndAuditAlarmA(const(char)*, void*, PSTR, PSTR, PSECURITY_DESCRIPTOR, uint, GENERIC_MAPPING*, BOOL, uint*, BOOL*, BOOL*);
BOOL AccessCheckByTypeAndAuditAlarmA(const(char)*, void*, const(char)*, const(char)*, PSECURITY_DESCRIPTOR, PSID, uint, AUDIT_EVENT_TYPE, uint, OBJECT_TYPE_LIST*, uint, GENERIC_MAPPING*, BOOL, uint*, BOOL*, BOOL*);
BOOL AccessCheckByTypeResultListAndAuditAlarmA(const(char)*, void*, const(char)*, const(char)*, PSECURITY_DESCRIPTOR, PSID, uint, AUDIT_EVENT_TYPE, uint, OBJECT_TYPE_LIST*, uint, GENERIC_MAPPING*, BOOL, uint*, uint*, BOOL*);
BOOL AccessCheckByTypeResultListAndAuditAlarmByHandleA(const(char)*, void*, HANDLE, const(char)*, const(char)*, PSECURITY_DESCRIPTOR, PSID, uint, AUDIT_EVENT_TYPE, uint, OBJECT_TYPE_LIST*, uint, GENERIC_MAPPING*, BOOL, uint*, uint*, BOOL*);
BOOL ObjectOpenAuditAlarmA(const(char)*, void*, PSTR, PSTR, PSECURITY_DESCRIPTOR, HANDLE, uint, uint, PRIVILEGE_SET*, BOOL, BOOL, BOOL*);
...
BOOL SetFileSecurityA(const(char)*, OBJECT_SECURITY_INFORMATION, PSECURITY_DESCRIPTOR);
