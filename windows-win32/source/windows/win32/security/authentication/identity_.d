...
import windows.win32.system.windowsprogramming : OBJECT_ATTRIBUTES;
...
NTSTATUS SystemFunction041(void*, uint, uint);
...
alias PSAM_PASSWORD_FILTER_ROUTINE = BOOLEAN function(UNICODE_STRING*, UNICODE_STRING*, UNICODE_STRING*, BOOLEAN);
...
alias PLSA_ADD_CREDENTIAL = NTSTATUS function(LUID*, uint, STRING*, STRING*);
alias PLSA_GET_CREDENTIALS = NTSTATUS function(LUID*, uint, uint*, BOOLEAN, STRING*, uint*, STRING*);
alias PLSA_DELETE_CREDENTIAL = NTSTATUS function(LUID*, uint, STRING*);
...
alias PLSA_AP_INITIALIZE_PACKAGE = NTSTATUS function(uint, LSA_DISPATCH_TABLE*, STRING*, STRING*, STRING**);
alias PLSA_AP_LOGON_USER = NTSTATUS function(void**, SECURITY_LOGON_TYPE, void*, void*, uint, void**, uint*, LUID*, int*, LSA_TOKEN_INFORMATION_TYPE*, void**, UNICODE_STRING**, UNICODE_STRING**);
alias PLSA_AP_LOGON_USER_EX = NTSTATUS function(void**, SECURITY_LOGON_TYPE, void*, void*, uint, void**, uint*, LUID*, int*, LSA_TOKEN_INFORMATION_TYPE*, void**, UNICODE_STRING**, UNICODE_STRING**, UNICODE_STRING**);
...
alias PSAM_CREDENTIAL_UPDATE_NOTIFY_ROUTINE = NTSTATUS function(UNICODE_STRING*, void*, uint, uint, UNICODE_STRING*, UNICODE_STRING*, UNICODE_STRING*, UNICODE_STRING*, void**, uint*);
alias PSAM_CREDENTIAL_UPDATE_REGISTER_ROUTINE = BOOLEAN function(UNICODE_STRING*);
...
alias PLSA_REDIRECTED_LOGON_INIT = NTSTATUS function(HANDLE, const(UNICODE_STRING)*, uint, const(LUID)*);
...
alias PLSA_CREATE_TOKEN = NTSTATUS function(LUID*, TOKEN_SOURCE*, SECURITY_LOGON_TYPE, SECURITY_IMPERSONATION_LEVEL, LSA_TOKEN_INFORMATION_TYPE, void*, TOKEN_GROUPS*, UNICODE_STRING*, UNICODE_STRING*, UNICODE_STRING*, UNICODE_STRING*, HANDLE*, int*);
...
alias PLSA_CREATE_TOKEN_EX = NTSTATUS function(LUID*, TOKEN_SOURCE*, SECURITY_LOGON_TYPE, SECURITY_IMPERSONATION_LEVEL, LSA_TOKEN_INFORMATION_TYPE, void*, TOKEN_GROUPS*, UNICODE_STRING*, UNICODE_STRING*, void*, SECPKG_SESSIONINFO_TYPE, HANDLE*, int*);
alias PLSA_AUDIT_LOGON = void function(NTSTATUS, NTSTATUS, UNICODE_STRING*, UNICODE_STRING*, UNICODE_STRING*, PSID, SECURITY_LOGON_TYPE, TOKEN_SOURCE*, LUID*);
alias PLSA_CALL_PACKAGE = NTSTATUS function(UNICODE_STRING*, void*, uint, void**, uint*, int*);
alias PLSA_CALL_PACKAGEEX = NTSTATUS function(UNICODE_STRING*, void*, void*, uint, void**, uint*, int*);
alias PLSA_CALL_PACKAGE_PASSTHROUGH = NTSTATUS function(UNICODE_STRING*, void*, void*, uint, void**, uint*, int*);
...
alias PLSA_OPEN_SAM_USER = NTSTATUS function(UNICODE_STRING*, SECPKG_NAME_TYPE, UNICODE_STRING*, BOOLEAN, uint, void**);
...
alias PLSA_GET_AUTH_DATA_FOR_USER = NTSTATUS function(UNICODE_STRING*, SECPKG_NAME_TYPE, UNICODE_STRING*, ubyte**, uint*, UNICODE_STRING*);
alias PLSA_CONVERT_AUTH_DATA_TO_TOKEN = NTSTATUS function(void*, uint, SECURITY_IMPERSONATION_LEVEL, TOKEN_SOURCE*, SECURITY_LOGON_TYPE, UNICODE_STRING*, HANDLE*, LUID*, UNICODE_STRING*, int*);
alias PLSA_CRACK_SINGLE_NAME = NTSTATUS function(uint, BOOLEAN, UNICODE_STRING*, UNICODE_STRING*, uint, UNICODE_STRING*, UNICODE_STRING*, uint*);
alias PLSA_AUDIT_ACCOUNT_LOGON = NTSTATUS function(uint, BOOLEAN, UNICODE_STRING*, UNICODE_STRING*, UNICODE_STRING*, NTSTATUS);
...
alias PLSA_GET_SERVICE_ACCOUNT_PASSWORD = NTSTATUS function(UNICODE_STRING*, UNICODE_STRING*, CRED_FETCH, FILETIME*, UNICODE_STRING*, UNICODE_STRING*, FILETIME*);
alias PLSA_AUDIT_LOGON_EX = void function(NTSTATUS, NTSTATUS, UNICODE_STRING*, UNICODE_STRING*, UNICODE_STRING*, PSID, SECURITY_LOGON_TYPE, SECURITY_IMPERSONATION_LEVEL, TOKEN_SOURCE*, LUID*);
...
alias PLSA_AP_LOGON_USER_EX2 = NTSTATUS function(void**, SECURITY_LOGON_TYPE, void*, void*, uint, void**, uint*, LUID*, int*, LSA_TOKEN_INFORMATION_TYPE*, void**, UNICODE_STRING**, UNICODE_STRING**, UNICODE_STRING**, SECPKG_PRIMARY_CRED*, SECPKG_SUPPLEMENTAL_CRED_ARRAY**);
alias PLSA_AP_LOGON_USER_EX3 = NTSTATUS function(void**, SECURITY_LOGON_TYPE, void*, void*, uint, SECPKG_SURROGATE_LOGON*, void**, uint*, LUID*, int*, LSA_TOKEN_INFORMATION_TYPE*, void**, UNICODE_STRING**, UNICODE_STRING**, UNICODE_STRING**, SECPKG_PRIMARY_CRED*, SECPKG_SUPPLEMENTAL_CRED_ARRAY**);
...
alias SpChangeAccountPasswordFn = NTSTATUS function(UNICODE_STRING*, UNICODE_STRING*, UNICODE_STRING*, UNICODE_STRING*, BOOLEAN, SecBufferDesc*);
alias SpQueryMetaDataFn = NTSTATUS function(ulong, UNICODE_STRING*, uint, uint*, ubyte**, ulong*);
alias SpExchangeMetaDataFn = NTSTATUS function(ulong, UNICODE_STRING*, uint, uint, ubyte*, ulong*);
