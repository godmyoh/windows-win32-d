...
BOOL CredReadW(const(wchar)*, uint, uint, CREDENTIALW**);
BOOL CredReadA(const(char)*, uint, uint, CREDENTIALA**);
...
BOOL CredDeleteW(const(wchar)*, uint, uint);
BOOL CredDeleteA(const(char)*, uint, uint);
BOOL CredRenameW(const(wchar)*, const(wchar)*, uint, uint);
BOOL CredRenameA(const(char)*, const(char)*, uint, uint);
