...
BOOL AuthzInitializeContextFromToken(uint, HANDLE, AUTHZ_RESOURCE_MANAGER_HANDLE, LARGE_INTEGER*, LUID, void*, long*);
BOOL AuthzInitializeContextFromSid(uint, PSID, AUTHZ_RESOURCE_MANAGER_HANDLE, LARGE_INTEGER*, LUID, void*, long*);
BOOL AuthzInitializeContextFromAuthzContext(uint, AUTHZ_CLIENT_CONTEXT_HANDLE, LARGE_INTEGER*, LUID, void*, long*);
BOOL AuthzInitializeCompoundContext(AUTHZ_CLIENT_CONTEXT_HANDLE, AUTHZ_CLIENT_CONTEXT_HANDLE, long*);
BOOL AuthzAddSidsToContext(AUTHZ_CLIENT_CONTEXT_HANDLE, SID_AND_ATTRIBUTES*, uint, SID_AND_ATTRIBUTES*, uint, long*);
...
uint GetInheritanceSourceA(PSTR, SE_OBJECT_TYPE, uint, BOOL, GUID**, uint, ACL*, FN_OBJECT_MGR_FUNCTIONS*, GENERIC_MAPPING*, INHERITED_FROMA*);
uint GetInheritanceSourceW(PWSTR, SE_OBJECT_TYPE, uint, BOOL, GUID**, uint, ACL*, FN_OBJECT_MGR_FUNCTIONS*, GENERIC_MAPPING*, INHERITED_FROMW*);
uint FreeInheritedFromArray(INHERITED_FROMW*, ushort, FN_OBJECT_MGR_FUNCTIONS*);
